...
export default function Main() {
    return (
        <div className="">
            <div
                className="flex flex-col items-center min-h-screen w-screen justify-center bg-gray-100 pb-12 md:px-0 px-4 dark:bg-gray-900 dark:text-gray-100 p-4">
                <img src={logo}
                ...
                <p className="text-5xl font-bold mb-4 flex text-center">Rescate 1: Alumnos</p>
