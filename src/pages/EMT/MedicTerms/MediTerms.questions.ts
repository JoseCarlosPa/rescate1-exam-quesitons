...
export const medicTermsChallengingQuestions: Question[] = [
    {
        ...
        options: [
            ...
            {
                letter: "b",
                text: "Insuficiencia cardíaca significa la incapacidad del corazón para mantener un gasto cardíaco adecuado para las demandas metabólicas del cuerpo"
            },
    ...
    },
    {
        ...
        options: [
            {
                letter: "a",
                text: "Los términos como 'posible', 'probable' y 'sugestivo' deben evitarse completamente en reportes médicos"
            },
            {
                letter: "b",
                text: "Los calificadores de certeza ('posible', 'probable', 'compatible con') reflejan el nivel de confianza diagnóstica basado en hallazgos clínicos disponibles"
            },
    ...
    },
    {
        ...
        options: [
            ...
            {
                letter: "b",
                text: "El dolor origina en la región superior del abdomen (epigastrio) y se irradia hacia el cuadrante superior derecho (hipocondrio derecho), con signos que sugieren patología de la vesícula biliar"
            },
    ...
    },
    {
        ...
        options: [
            ...
            {
                letter: "b",
                text: "Estupor indica un estado de reducción marcada de la actividad mental con respuesta mínima al entorno, distinto de obnubilación (reducción leve) y coma (ausencia de respuesta)"
            },
    ...
    },
    {
        ...
        options: [
            {
                letter: "a",
                text: "Todos los términos simplemente indican que el paciente tiene dificultad para respirar"
            },
            {
                letter: "b",
                text: "Cada término describe un aspecto específico del compromiso respiratorio: frecuencia aumentada, signos de esfuerzo respiratorio, y obstrucción del flujo aéreo"
            },
    ...
    },
    {
        ...
        options: [
            ...
            {
                letter: "b",
                text: "Cada término aporta información específica sobre diferentes aspectos de la patología abdominal: distensión, contenido intestinal, motilidad y signos de irritación peritoneal"
            },
    ...
    },
    {
        ...
        options: [
            ...
            {
                letter: "b",
                text: "Comprensión de la fisiopatología de la insuficiencia cardíaca y sus manifestaciones específicas en diferentes sistemas orgánicos"
            },
    ...
    },
    {
        ...
        options: [
            {
                letter: "a",
                text: "Uso correcto de terminología neurológica específica que localiza la disfunción en el hemisferio cerebral izquierdo"
            },
    ...
    },
    {
        ...
        options: [
            {
                letter: "a",
                text: "Uso apropiado de terminología que integra conceptos de trauma, hematología y fisiología"
            },
