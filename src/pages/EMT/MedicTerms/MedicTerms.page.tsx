...
import Roots from "./components/Roots.component.tsx";
import Abbreviations from "./components/Abbreviations.component.tsx";
                ...
                <div
                    ...
                    <div className="w-full max-w-7xl">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-8 max-w-4xl mx-auto">
                            ...
                            <a href="https://docs.google.com/presentation/d/1ykcDTLmLgFtdRT-3egIu27n5mIpIXJQ-/edit?usp=sharing&ouid=107287742628985461156&rtpof=true&sd=true"
                               target="_blank"
                                ...
                                <div>
                                    ...
                                    <ul className="list-disc list-inside space-y-2 text-gray-700">
                                        <li><a href="https://www.ems1.com/ems-education/" target="_blank"
                                            ...
                                            - Educación y glosarios médicos</a></li>
