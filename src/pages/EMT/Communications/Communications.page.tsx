                        ...
                        <div className="max-w-5xl mx-auto bg-white rounded-lg shadow-sm p-6 mb-8">
                                ...
                                <div className="space-y-6">
                                    <div>
                                        <h2 className="text-2xl font-semibold mb-3 text-gray-800 border-b pb-2">Importancia
                                            de la comunicación</h2>
                                        <ul className="list-disc list-inside space-y-2 text-gray-700">
                                            <li>La comunicación efectiva es esencial para coordinar la atención,
                                                transmitir información precisa y brindar seguridad al paciente.
                                            </li>
                                            <li>Incluye comunicación verbal (palabras habladas) y no verbal (gestos,
                                                expresiones, postura).
                                            </li>
                                            <li>La escucha activa y el lenguaje corporal positivo generan confianza en
                                                el paciente.
                                            </li>
                                        </ul>
                                    </div>
                                    <div className="grid md:grid-cols-2 gap-6">
                                        <div>
                                            <h2 className="text-2xl font-semibold mb-3 text-gray-800 border-b pb-2">Herramientas
                                                de comunicación</h2>
                                            <ul className="list-disc list-inside space-y-2 text-gray-700">
                                                <li><strong>SAMPLE:</strong> Signos/Síntomas, Alergias, Medicamentos,
                                                    Pasado médico, Última ingesta, Eventos previos.
                                                </li>
                                                <li><strong>OPQRST:</strong> Inicio, Provocación, Calidad, Irradiación,
                                                    Severidad, Tiempo.
                                                </li>
                                                <li>Permiten obtener información estructurada y relevante durante la
                                                    evaluación inicial.
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <div className="grid md:grid-cols-2 gap-6">
                                        <div>
                                            <h2 className="text-2xl font-semibold mb-3 text-gray-800 border-b pb-2">Comunicación
                                                en radio y verbal</h2>
                                            <ul className="list-disc list-inside space-y-2 text-gray-700">
                                                <li>Antes de hablar, presionar el botón de transmisión y esperar un
                                                    segundo.
                                                </li>
                                                <li>Transmitir de forma clara, breve y pausada.</li>
                                                <li>Utilizar códigos de radio si están autorizados, para facilitar la
                                                    comunicación.
                                                </li>
                                                <li>Confirmar recepción de mensajes importantes repitiéndolos de
                                                    vuelta.
                                                </li>
                                                <li>Evitar opiniones personales, enfocarse en datos objetivos y
                                                    relevantes.
                                                </li>
                                            </ul>
                                        </div>
                                        <div>
                                            <h2 className="text-2xl font-semibold mb-3 text-gray-800 border-b pb-2">Reporte
                                                verbal al hospital</h2>
                                            <ul className="list-disc list-inside space-y-2 text-gray-700">
                                                <li>Al llegar al hospital, el TAMP debe entregar un reporte verbal breve
                                                    pero completo al personal de salud.
                                                </li>
                                                <li>Debe incluir: edad del paciente, quejas principales, signos vitales,
                                                    tratamientos realizados y respuesta a tratamientos.
                                                </li>
                                                <li>Utilizar la estructura SBAR (Situación, Breve historia, Evaluación,
                                                    Recomendación) para reportes claros.
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            {activeTab === 'doc' && (
                                <div className="space-y-6">
                                    <div className="grid md:grid-cols-2 gap-6">
                                        <div>
                                            <h2 className="text-2xl font-semibold mb-3 text-gray-800 border-b pb-2">Documentación
                                                (FRAP)</h2>
                                            <ul className="list-disc list-inside space-y-2 text-gray-700">
                                                <li>El Formato de Registro de Atención Prehospitalaria (FRAP) es el
                                                    documento oficial que detalla toda la atención brindada.
                                                </li>
                                                <li>Debe ser objetivo, claro, preciso, sin tachaduras ni enmiendas
                                                    indebidas.
                                                </li>
                                                <li>Errores deben corregirse con una línea simple, inicialar y añadir la
                                                    corrección.
                                                </li>
                                                <li>Todo rechazo de tratamiento debe ser documentado cuidadosamente,
                                                    incluyendo advertencia de riesgos y firma de testigos.
                                                </li>
                                            </ul>
                                        </div>
                                        <div>
                                            <h2 className="text-2xl font-semibold mb-3 text-gray-800 border-b pb-2">Buenas
                                                prácticas</h2>
                                            <ul className="list-disc list-inside space-y-2 text-gray-700">
                                                <li>Documentar todas las observaciones relevantes, tratamientos y
                                                    cambios en la condición del paciente.
                                                </li>
                                                <li>Conservar la confidencialidad del paciente en todo momento.</li>
                                                <li>Informar cualquier error o corrección de manera formal mediante
                                                    adendas oficiales.
                                                </li>
