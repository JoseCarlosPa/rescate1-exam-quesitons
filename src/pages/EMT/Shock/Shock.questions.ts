...
export const shockChallengeQuestions: Question[] = [
    {
        ...
        options: [
            ...
            { letter: "b", text: "Presenta shock compensado con activación simpática inicial; la progresión de signos indica hemorragia interna continua y riesgo inminente de descompensación" },
    ...
    },
    {
        ...
        options: [
            ...
            { letter: "b", text: "El shock séptico involucra vasodilatación masiva refractaria a fluidos; puede requerir vasopresores temprano, y la sobrecarga de fluidos puede causar edema pulmonar" },
    ...
    },
    {
        ...
        options: [
            ...
            { letter: "b", text: "Shock neurogénico por estimulación vagal (reflejo de Bezold-Jarisch); manejo incluye atropina, fluidos, y elevación de miembros inferiores" },
    ...
    },
    {
        ...
        options: [
            ...
            { letter: "b", text: "La anafilaxia causa shock distributivo multifásico; el edema laríngeo puede progresar independientemente de la mejora hemodinámica, requiriendo manejo agresivo de vía aérea" },
    ...
    },
    {
        ...
        options: [
            ...
            { letter: "b", text: "Shock obstructivo por embolia pulmonar masiva - la obstrucción del flujo pulmonar causa falla del ventrículo derecho y compromete llenado del ventrículo izquierdo" },
    ...
    },
    {
        ...
        options: [
            ...
            { letter: "b", text: "Aplicar reanimación controlada con hipotensión permisiva (PA sistólica 80-90 mmHg) para evitar dilución de factores de coagulación y re-sangrado por aumento de presión" },
    ...
    },
    {
        ...
        options: [
            ...
            { letter: "b", text: "Shock hipovolémico por diuresis osmótica masiva, pérdida de electrolitos, y deshidratación severa con compromiso de la contractilidad miocárdica por acidosis" },
    ...
    },
    {
        ...
        options: [
            ...
            { letter: "b", text: "Shock neurogénico por interrupción del control simpático: vasodilatación masiva distal, pérdida de cronotropismo, compromiso respiratorio por parálisis diafragmática" },
    ...
    },
    {
        ...
        options: [
            ...
            { letter: "b", text: "Síndrome de hipotensión supina por compresión aortocava; el útero grávido comprime vasos principales, agravando el shock hipovolémico. Requiere posición lateral izquierda y manejo agresivo de hemorragia" },
    ...
    },
    {
        ...
        options: [
            ...
            { letter: "b", text: "Los adultos mayores pueden tener respuesta cronotrópica limitada por: medicamentos (beta-bloqueadores), enfermedad cardíaca, envejecimiento del nódulo SA, requiriendo evaluación diferente del estado de shock" },
