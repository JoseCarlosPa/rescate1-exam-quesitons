...
import ShockTypes from "./components/ShockTypes.component.tsx";
                ...
                <div
                    ...
                    <div className="w-full max-w-7xl">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8 max-w-4xl mx-auto">
                            ...
                            <a href="https://docs.google.com/presentation/d/1_a50gY0TBs5zg-b1Z5ghVHFLyNy7Cetd/edit?usp=sharing&ouid=107287742628985461156&rtpof=true&sd=true"
                               target="_blank"
