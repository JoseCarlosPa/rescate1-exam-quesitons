                                ...
                                <div className="space-y-6">
                                    <div>
                                        ...
                                        <p className="text-gray-700 leading-relaxed">
                                            El cuerpo humano es una estructura compleja formada por células, tejidos,
                                            órganos y sistemas que trabajan en conjunto para mantener la vida y la
                                            homeostasis. Su estudio es fundamental para la atención prehospitalaria,
                                            permitiendo identificar alteraciones y actuar de forma rápida y eficaz.
                                        </p>
                                    </div>
                                    <div>
                                        ...
                                        <ul className="list-disc list-inside space-y-2 text-gray-700">
                                            ...
                                            <li><strong>Sistema:</strong> Conjunto de órganos que cumplen una función.
                                            </li>
                                        </ul>
                                    </div>
                                    <div>
                                        <h2 className="text-2xl font-semibold mb-3 text-gray-800 border-b pb-2">Planos y
                                            posiciones anatómicas</h2>
                                        <ul className="list-disc list-inside space-y-2 text-gray-700">
                                            <li><strong>Posición anatómica:</strong> Persona de pie, vista al frente,
                                                palmas hacia adelante.
                                            </li>
                                            <li><strong>Planos:</strong> Sagital (izq-der), frontal (ant-post),
                                                transversal (sup-inf).
                                            </li>
                                            <li><strong>Direcciones:</strong> Superior, inferior, medial, lateral,
                                ...
                                <div className="space-y-6">
                                    ...
                                    <ul className="space-y-4">
                                        <li>
                                            ...
                                            <p>Compuesto por el corazón, la sangre y los vasos sanguíneos. Su función
                                                principal es transportar oxígeno, nutrientes, hormonas y desechos a
                                                través del cuerpo.</p>
                                        </li>
                                        <li>
                                            <h3 className="text-lg font-bold">Sistema Respiratorio</h3>
                                            <p>Compuesto por los pulmones y las vías respiratorias. Su principal función
                                                es intercambiar oxígeno y dióxido de carbono entre el cuerpo y el
                                                aire.</p>
                                        </li>
                                        <li>
                                            <h3 className="text-lg font-bold">Sistema Nervioso</h3>
                                            <p>Incluye el cerebro, la médula espinal y los nervios. Controla y coordina
                                                las funciones del cuerpo, además de permitir la percepción sensorial y
                                                la respuesta a estímulos.</p>
                                        </li>
                                        <li>
                                            <h3 className="text-lg font-bold">Sistema Muscular</h3>
                                            <p>Comprende los músculos esqueléticos, lisos y cardíacos. Es responsable
                                                del movimiento y la estabilidad corporal.</p>
                                        </li>
                                        <li>
                                            <h3 className="text-lg font-bold">Sistema Esquelético</h3>
                                            <p>Está formado por huesos y articulaciones. Proporciona soporte, protección
                                                y movimiento al cuerpo.</p>
                                        </li>
                                        <li>
                                            <h3 className="text-lg font-bold">Sistema Digestivo</h3>
                                            <p>Incluye órganos como el estómago, los intestinos y el hígado. Su función
                                                es descomponer los alimentos y absorber los nutrientes necesarios para
                                                el cuerpo.</p>
                                        </li>
                                        <li>
                                            <h3 className="text-lg font-bold">Sistema Endocrino</h3>
                                            <p>Se compone de glándulas que producen hormonas. Regula procesos como el
                                                metabolismo, el crecimiento y la función reproductiva.</p>
                                        </li>
                                        <li>
                                            <h3 className="text-lg font-bold">Sistema Urinario</h3>
                                            <p>Incluye los riñones, la vejiga y los conductos urinarios. Su función es
                                                filtrar los desechos del cuerpo y mantener el equilibrio hídrico y
                                                electrolítico.</p>
                                        </li>
                                        <li>
                                            <h3 className="text-lg font-bold">Sistema Inmunológico</h3>
                                            <p>Protege al cuerpo contra infecciones y enfermedades a través de una red
                                                de células y órganos que identifican y destruyen patógenos.</p>
                                        </li>
                                        <li>
                                            <h3 className="text-lg font-bold">Sistema Tegumentario</h3>
                                            <p>Formado por la piel, cabello y uñas, protege al cuerpo de los agentes
                                                externos y regula la temperatura.</p>
                                        </li>
                                    </ul>
                                </div>
                            )}
                            {activeTab === 'anatomy' && (
                                <div className="space-y-6">
                                    <h2 className="text-2xl font-semibold mb-3 text-gray-800 border-b pb-2">Anatomía y
                                        fisiología básica</h2>
                                    <div className="grid md:grid-cols-2 gap-6">
                                        <div>
                                            <h3 className="font-medium text-lg mb-2 text-gray-800">Órganos vitales</h3>
                                            <ul className="list-disc list-inside space-y-2 text-gray-700">
                                                <li><strong>Cerebro:</strong> Controla funciones vitales y cognitivas.
                                                </li>
                                                ...
                                                <li><strong>Hígado:</strong> Metaboliza sustancias y almacena energía.
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <div>
                                        <h3 className="font-medium text-lg mb-2 text-gray-800">Funciones fisiológicas
                                            clave</h3>
                                        <ul className="list-disc list-inside space-y-2 text-gray-700">
                                            ...
                                            <li><strong>Regulación térmica:</strong> Control de la temperatura corporal.
                                            </li>
                                        </ul>
                                    </div>
                                    <div>
                                        <h3 className="font-medium text-lg mb-2 text-gray-800">Valores fisiológicos
                                            normales</h3>
                                        <div className="overflow-x-auto">
                                            <table className="min-w-full bg-white">
                                                ...
                                                <tbody>
                                                <tr>
                                                    <td className="py-2 px-4 border font-medium">Frecuencia cardiaca
                                                    </td>
                                                ...
                                                <tr>
                                                    <td className="py-2 px-4 border font-medium">Frecuencia
                                                        respiratoria
                                                    </td>
                                                ...
                                                <tr>
                                                    <td className="py-2 px-4 border font-medium">Presión arterial
                                                        sistólica
                                                    </td>
                            ...
                            {activeTab === 'practice' && (
                                <div className="space-y-6">
                                    <h2 className="text-2xl font-semibold mb-3 text-gray-800 border-b pb-2">Casos
                                        prácticos y ejercicios</h2>
                                    <div className="p-5 bg-gray-50 rounded-lg shadow-sm mb-4">
                                        <h3 className="text-xl font-semibold mb-2 text-orange-600">Ejercicio 1:
                                            Identifica el sistema</h3>
                                        <p className="italic text-gray-600 mb-4">
                                            Un paciente presenta dificultad para respirar y cianosis. ¿Qué sistema está
                                    ...
                                    <div className="p-5 bg-gray-50 rounded-lg shadow-sm mb-4">
                                        <h3 className="text-xl font-semibold mb-2 text-blue-600">Ejercicio 2: Relaciona
                                            órganos y función</h3>
                                        <p className="italic text-gray-600 mb-4">
                                    ...
                                    <div className="p-5 bg-gray-50 rounded-lg shadow-sm">
                                        <h3 className="text-xl font-semibold mb-2 text-green-600">Ejercicio 3: Valores
                                            normales</h3>
                                        <p className="italic text-gray-600 mb-4">
