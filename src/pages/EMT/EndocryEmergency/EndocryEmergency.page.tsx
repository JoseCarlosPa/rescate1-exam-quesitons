                ...
                <div
                    ...
                    <div className="w-full max-w-7xl">
                        ...
                        <header className="mb-8 text-center">
                            ...
                            <h1 className="text-5xl font-bold mb-2 text-center">Emergencias Endocrinas y
                                Hematológicas</h1>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8 max-w-4xl mx-auto">
                            ...
                            <a href="https://docs.google.com/presentation/d/1150yJxE2I222jzKbbD3otxE9b2p4Nte9/edit?usp=sharing&ouid=107287742628985461156&rtpof=true&sd=true"
                               target="_blank"
                        ...
                        <section className="max-w-5xl mx-auto p-6 bg-white rounded-lg shadow-sm">
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <ul className="list-disc list-inside space-y-2 text-gray-700">
                                        <li><a href="https://www.ems1.com/endocrine-emergencies/" target="_blank"
                                               rel="noopener noreferrer" className="text-blue-600 hover:underline">EMS1
                                            - Artículos sobre emergencias endocrinas</a></li>
