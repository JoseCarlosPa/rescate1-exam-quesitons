...
import {FaExclamationTriangle, FaEye, FaFirstAid, FaSkull, FaWineBottle} from "react-icons/fa";
import {FiEye} from "react-icons/fi";
import {GiDeathNote, GiMedicines, GiPoisonBottle} from "react-icons/gi";
                ...
                <div
                    ...
                    <div className="w-full max-w-7xl">
                        ...
                        <header className="mb-8 text-center">
                            ...
                            <p className="text-sm italic mb-4">Basado en AAOS 11ª Edición - Alumnos Rescate 1</p>
                            <div className="flex justify-center">
                                <NavLink
                                    to={AllRoutes.EMT}
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8 max-w-4xl mx-auto">
                            ...
                            <a href="https://docs.google.com/presentation/d/1WILPMgpy9fdJ283eWaqkLxRHd8pslSbX/edit?usp=sharing&ouid=107287742628985461156&rtpof=true&sd=true"
                               target="_blank"
                                ...
                                <div className="space-y-8">
                                    ...
                                    <div
                                        ...
                                        <p className="text-gray-800 leading-relaxed text-lg">
                                            Las intoxicaciones constituyen una <strong>emergencia médica</strong> que
                                            requiere
                                            evaluación y manejo inmediato. El tiempo es crítico para prevenir daño
                                            permanente o muerte.
                                        </p>
                                    ...
                                    <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
                                        <div className="flex items-center mb-4">
                                            ...
                                            <h3 className="text-xl font-bold text-yellow-800">Principios
                                                Fundamentales</h3>
                                        </div>
                                        <blockquote className="text-lg italic text-center text-gray-700 mb-4">
                                            "Sola dosis facit venenum" - "Solo la dosis hace el veneno"
                                            <footer className="text-sm text-gray-500 mt-2">- Paracelso
                                                (1493-1541)</footer>
                                        </blockquote>
                                        <div className="grid md:grid-cols-2 gap-6">
                                            <div>
                                                <h4 className="font-semibold text-yellow-800 mb-2">Factores que
                                                    determinan la toxicidad:</h4>
                                            ...
                                            <div>
                                                <h4 className="font-semibold text-yellow-800 mb-2">Fases de la
                                                    intoxicación:</h4>
                                                <ul className="list-disc list-inside space-y-1 text-gray-700">
                                    ...
                                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                                        <div className="flex items-center mb-4">
                                            ...
                                            <h3 className="text-xl font-bold text-blue-800">Evaluación Inicial -
                                                Protocolo HAZMAT</h3>
                                        </div>
                                        <div className="grid md:grid-cols-2 gap-6">
                                            <div>
                                ...
                                <div className="space-y-8">
                                    <div>
                                        ...
                                        <p className="text-gray-700 leading-relaxed mb-6">
                                            Los toxidromes son constelaciones de signos y síntomas que permiten
                                            identificar
                                        ...
                                        <div className="grid gap-6">
                                            ...
                                            <div className="bg-purple-50 border border-purple-200 rounded-lg p-6">
                                                <h3 className="text-xl font-bold text-purple-700 mb-4">🔵 Toxidrome
                                                    Opiáceo</h3>
                                                <div className="grid md:grid-cols-3 gap-4">
                                                    <div>
                                                        <h4 className="font-semibold text-purple-800 mb-2">Tríada
                                                            Clásica:</h4>
                                                        <ul className="list-disc list-inside space-y-1 text-gray-700">
                                                            <li>Coma/estupor</li>
                                                    ...
                                                    <div>
                                                        <h4 className="font-semibold text-purple-800 mb-2">Otros
                                                            signos:</h4>
                                                        <ul className="list-disc list-inside space-y-1 text-gray-700">
                                                            <li>Bradipnea</li>
                                                            <li>Hipotensión</li>
                                            ...
                                            <div className="bg-red-50 border border-red-200 rounded-lg p-6">
                                                <h3 className="text-xl font-bold text-red-700 mb-4">🔴 Toxidrome
                                                    Simpaticomimético</h3>
                                                <div className="grid md:grid-cols-3 gap-4">
                                                    <div>
                                            ...
                                            <div className="bg-orange-50 border border-orange-200 rounded-lg p-6">
                                                <h3 className="text-xl font-bold text-orange-700 mb-4">🟠 Toxidrome
                                                    Anticolinérgico</h3>
                                                <div className="grid md:grid-cols-3 gap-4">
                                                    <div>
                                                        ...
                                                        <div className="bg-orange-100 p-3 rounded">
                                                            ...
                                                            <p className="text-sm font-medium">"Caliente como un
                                                                horno"</p>
                                            ...
                                            <div className="bg-green-50 border border-green-200 rounded-lg p-6">
                                                <h3 className="text-xl font-bold text-green-700 mb-4">🟢 Toxidrome
                                                    Colinérgico</h3>
                                                <div className="grid md:grid-cols-3 gap-4">
                                                    <div>
                                                        <h4 className="font-semibold text-green-800 mb-2">Mnemotecnia
                                                            SLUDGE:</h4>
                                                        <ul className="list-disc list-inside space-y-1 text-gray-700">
                                            ...
                                            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                                                <h3 className="text-xl font-bold text-blue-700 mb-4">🔵 Toxidrome
                                                    Sedante-Hipnótico</h3>
                                                <div className="grid md:grid-cols-3 gap-4">
                                                    <div>
                            ...
                            {activeTab === 'management' && (
                                <div className="space-y-8">
                                    <div>
                                        ...
                                        {/* Algoritmo de manejo */}
                                        <div
                                            className="bg-gradient-to-r from-blue-50 to-green-50 border border-blue-200 rounded-lg p-6 mb-6">
                                            <h3 className="text-xl font-bold text-blue-700 mb-4">🔄 Algoritmo de
                                                Manejo</h3>
                                            <div className="grid md:grid-cols-5 gap-4">
                                                <div className="bg-white p-4 rounded-lg shadow-sm text-center">
                                                    <div
                                                        className="w-8 h-8 bg-red-500 text-white rounded-full flex items-center justify-center mx-auto mb-2 font-bold">1
                                                    </div>
                                                ...
                                                <div className="bg-white p-4 rounded-lg shadow-sm text-center">
                                                    <div
                                                        className="w-8 h-8 bg-blue-500 text-white rounded-full flex items-center justify-center mx-auto mb-2 font-bold">2
                                                    </div>
                                                ...
                                                <div className="bg-white p-4 rounded-lg shadow-sm text-center">
                                                    <div
                                                        className="w-8 h-8 bg-yellow-500 text-white rounded-full flex items-center justify-center mx-auto mb-2 font-bold">3
                                                    </div>
                                                ...
                                                <div className="bg-white p-4 rounded-lg shadow-sm text-center">
                                                    <div
                                                        className="w-8 h-8 bg-purple-500 text-white rounded-full flex items-center justify-center mx-auto mb-2 font-bold">4
                                                    </div>
                                                ...
                                                <div className="bg-white p-4 rounded-lg shadow-sm text-center">
                                                    <div
                                                        className="w-8 h-8 bg-green-500 text-white rounded-full flex items-center justify-center mx-auto mb-2 font-bold">5
                                                    </div>
                                        ...
                                        <div>
                                            <h3 className="text-xl font-semibold mb-4">Descontaminación por Vía de
                                                Exposición</h3>
                                            <div className="grid lg:grid-cols-2 gap-6">
                                                <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                                                    <h4 className="font-bold text-blue-700 mb-3">💧 Vía Digestiva
                                                        (Ingestión)</h4>
                                                    <div className="space-y-3">
                                                        <div className="bg-green-100 p-3 rounded">
                                                            <h5 className="font-semibold text-green-800">✅ Carbón
                                                                Activado</h5>
                                                    ...
                                                    <div className="space-y-3">
                                                        ...
                                                        <div className="bg-yellow-100 p-3 rounded">
                                                            <p className="text-sm text-yellow-800">
                                                                <strong>Precaución:</strong> No usar agua en contacto
                                                                con metales reactivos (sodio, potasio)
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="bg-green-50 border border-green-200 rounded-lg p-6">
                                                    ...
                                                    <div className="space-y-3">
                                                        <div>
                                                            <h5 className="font-semibold text-green-800">Irrigación
                                                                ocular:</h5>
                                                            <ol className="list-decimal list-inside text-sm text-gray-700 space-y-1">
                                                        ...
                                                        <div className="bg-red-100 p-3 rounded">
                                                            <p className="text-sm text-red-800">
                                                                <strong>Urgente:</strong> Ácidos y álcalis requieren
                                                                irrigación inmediata y prolongada
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="bg-orange-50 border border-orange-200 rounded-lg p-6">
                                                    <h4 className="font-bold text-orange-700 mb-3">🫁 Vía
                                                        Respiratoria</h4>
                                                    <div className="space-y-3">
                                                        <div>
                                                        ...
                                                        <div className="bg-blue-100 p-3 rounded">
                                                            <p className="text-sm text-blue-800">
                                                                <strong>Especial:</strong> CO requiere O₂ hiperbárico si
                                                                disponible
                                                            </p>
                                                        </div>
                                                    </div>
                                        ...
                                        <div className="bg-gray-50 border border-gray-200 rounded-lg p-6">
                                            <h3 className="text-xl font-bold text-gray-800 mb-4">🩺 Medidas de Soporte
                                                Vital</h3>
                                ...
                                <div className="space-y-8">
                                    <div>
                                        ...
                                        <div className="grid gap-6">
                                            {/* Naloxona */}
                                            <div className="bg-purple-50 border border-purple-200 rounded-lg p-6">
                                                <h3 className="text-xl font-bold text-purple-700 mb-4">💜 Naloxona
                                                    (Narcan®)</h3>
                                                <div className="grid md:grid-cols-3 gap-4">
                                                    <div>
                                            ...
                                            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                                                <h3 className="text-xl font-bold text-blue-700 mb-4">🏥 Antídotos
                                                    Hospitalarios Importantes</h3>
                                    ...
                                    <div>
                                        ...
                                        <div className="grid gap-6">
                                            <div className="p-5 bg-red-50 rounded-lg shadow-sm border border-red-200">
                                                <h3 className="text-xl font-semibold mb-2 text-red-600">🚨 Caso 1:
                                                    Intoxicación por Fentanilo</h3>
                                                <p className="italic text-gray-600 mb-4">
                                                    Hombre de 32 años encontrado inconsciente en baño público. Presente
                                                    jeringa, miosis marcada,
                                            ...
                                            <div
                                                className="p-5 bg-green-50 rounded-lg shadow-sm border border-green-200">
                                                <h3 className="text-xl font-semibold mb-2 text-green-600">🌿 Caso 2:
                                                    Intoxicación por Organofosforados</h3>
                                                <p className="italic text-gray-600 mb-4">
                                                    Agricultor de 45 años tras fumigación sin EPP. Presenta salivación
                                                    excesiva,
                                            ...
                                            <div className="p-5 bg-blue-50 rounded-lg shadow-sm border border-blue-200">
                                                <h3 className="text-xl font-semibold mb-2 text-blue-600">🔥 Caso 3:
                                                    Intoxicación por Monóxido de Carbono</h3>
                                                <p className="italic text-gray-600 mb-4">
                        ...
                        <section className="max-w-5xl mx-auto p-6 bg-white rounded-lg shadow-sm">
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <ul className="list-disc list-inside space-y-2 text-gray-700">
                                        <li><a href="https://www.poison.org/" target="_blank" rel="noopener noreferrer"
                                               className="text-blue-600 hover:underline">Poison Control - Centro de
                                            información toxicológica</a></li>
                                        <li><a href="https://www.cdc.gov/niosh/topics/toxicology/" target="_blank"
                                               rel="noopener noreferrer" className="text-blue-600 hover:underline">CDC -
                                            Temas de toxicología ocupacional</a></li>
                                        <li><a href="https://www.ncbi.nlm.nih.gov/books/NBK537034/" target="_blank"
                                               rel="noopener noreferrer" className="text-blue-600 hover:underline">StatPearls
                                            - Toxicología de emergencia</a></li>
                                        <li><a href="https://www.ems1.com/toxicology/" target="_blank"
                                               rel="noopener noreferrer" className="text-blue-600 hover:underline">EMS1
                                            - Artículos de toxicología prehospitalaria</a></li>
                                    </ul>
                                </div>
                                <div>
