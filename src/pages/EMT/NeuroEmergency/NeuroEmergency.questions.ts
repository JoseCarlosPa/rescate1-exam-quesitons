...
export const neurologicasQuestions: Question[] = [
    ...
    },
    {
        ...
        "options": [
            ...
            {
                "letter": "d",
                "text": "Una convulsión que dura más de 5 minutos o convulsiones repetidas sin recuperación de la conciencia"
            }
        ],
        "correctAnswer": "d",
    ...
    },
    {
        ...
        "options": [
            ...
            {
                "letter": "c",
                "text": "Identificar rápidamente los signos y síntomas y transportar a un centro adecuado."
            },
...
export const neurologicalQuestionsChallenge: Question[] = [
    ...
    },
    {
        ...
        options: [
            ...
            {
                letter: "c",
                text: "Tranquilizar a los padres, enfriamiento gradual, y evaluación médica para determinar causa de la fiebre"
            },
    ...
    },
    {
        ...
        options: [
            ...
            {
                letter: "b",
                text: "Posición en decúbito lateral izquierdo, oxígeno, y transporte urgente a centro obstétrico"
            },
