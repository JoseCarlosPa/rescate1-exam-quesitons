...
export const lifeSpecQuestions: Question[] = [
    {
        ...
        "options": [
            {
                "letter": "a",
                "text": "La frecuencia cardíaca en reposo tiende a ser significativamente más baja que en adultos jóvenes."
            },
            {"letter": "b", "text": "La presión arterial sistólica puede ser más alta debido a la rigidez arterial."},
            {
                "letter": "c",
                "text": "La frecuencia respiratoria suele ser más rápida y superficial que en otras etapas."
            },
    ...
    },
    {
        ...
        "options": [
            ...
            {
                "letter": "b",
                "text": "Podrían provocar somnolencia, mareos o hipotensión ortostática, contribuyendo a la caída."
            },
            {
                "letter": "c",
                "text": "Es probable que mejoren su coordinación, haciendo que la caída sea menos probable."
            },
            {
                "letter": "d",
                "text": "No hay relación significativa entre los medicamentos y el riesgo de caída en adultos mayores."
            }
        ],
        "correctAnswer": "b",
    ...
    },
    {
        ...
        "options": [
            {
                "letter": "a",
                "text": "Aumento significativo de la autoestima y autoeficacia en la mayoría de los casos."
            },
            {
                "letter": "b",
                "text": "Sentimientos de aislamiento social y soledad debido a la pérdida de seres queridos o roles sociales."
            },
    ...
    },
    {
        ...
        "options": [
            {
                "letter": "a",
                "text": "Debido a una disminución en la esperanza de vida, lo que genera más necesidades de cuidado."
            },
            {"letter": "b", "text": "A un aumento de las tasas de natalidad que desplaza el apoyo familiar."},
            {
                "letter": "c",
                "text": "Principalmente al envejecimiento de la población y el aumento de la esperanza de vida, junto con cambios en la estructura familiar."
            },
            {
                "letter": "d",
                "text": "Por una menor incidencia de enfermedades crónicas, liberando recursos para atención extendida."
            }
        ],
        "correctAnswer": "c",
    ...
    },
    {
        ...
        "options": [
            {
                "letter": "a",
                "text": "Asumir que el paciente tiene dificultades cognitivas y simplificar excesivamente el lenguaje."
            },
            {"letter": "b", "text": "Hablar en voz alta y rápidamente para asegurarse de que escuchen."},
            {
                "letter": "c",
                "text": "Colocarse directamente enfrente del paciente y ser paciente, ya que la visión periférica y el tiempo de respuesta pueden reducirse."
            },
    ...
    },
    {
        ...
        "options": [
            ...
            {
                "letter": "b",
                "text": "Independencia de los padres y búsqueda de la identidad personal, a menudo con presión del grupo de pares."
            },
    ...
    },
    {
        ...
        "options": [
            ...
            {
                "letter": "c",
                "text": "Deterioro gradual de la capacidad visual y auditiva, y en mujeres, la menopausia."
            },
    ...
    },
    {
        ...
        "options": [
            {
                "letter": "a",
                "text": "Desarrollo de la autonomía e inicio de la exploración de su independencia de los padres."
            },
    ...
    },
    {
        ...
        "options": [
            ...
            {
                "letter": "b",
                "text": "Los lactantes tienen un sistema respiratorio muy robusto y toleran bien la obstrucción."
            },
            {
                "letter": "c",
                "text": "Mantener al lactante abrigado para prevenir la hipotermia debido a su limitada capacidad de termorregulación."
            },
...
export const lifeSpecChallengingQuestions: Question[] = [
    {
        ...
        options: [
            ...
            {
                letter: "b",
                text: "La deshidratación severa en neonatos puede presentarse con hipotermia en lugar de fiebre, y la ausencia de diuresis indica compromiso renal significativo"
            },
    ...
    },
    {
        ...
        options: [
            ...
            {
                letter: "b",
                text: "La vía aérea pediátrica es más pequeña y cualquier edema causa obstrucción desproporcionada; la agitación puede precipitar obstrucción completa"
            },
    ...
    },
    {
        ...
        options: [
            ...
            {
                letter: "b",
                text: "Los niños tienen mecanismos compensatorios cardiovasculares superiores que mantienen presión arterial normal hasta perder 25-30% del volumen sanguíneo, pero pueden descompensarse abruptamente"
            },
    ...
    },
    {
        ...
        options: [
            ...
            {
                letter: "b",
                text: "El desarrollo cognitivo adolescente incluye pensamiento de invencibilidad y toma de riesgos, requiriendo educación específica sobre consecuencias de ayuno extremo"
            },
    ...
    },
    {
        ...
        options: [
            ...
            {
                letter: "b",
                text: "Los cambios cardiovasculares del embarazo (aumento de volumen sanguíneo 40-50%) pueden enmascarar el shock materno inicial, pero el flujo uteroplacentario se compromete tempranamente"
            },
    ...
    },
    {
        ...
        options: [
            ...
            {
                letter: "b",
                text: "Los adultos mayores anticoagulados tienen riesgo significativamente aumentado de hemorragia intracraneal, y la presentación puede ser sutil inicialmente"
            },
    ...
    },
    {
        ...
        options: [
            ...
            {
                letter: "b",
                text: "Los adultos mayores frecuentemente presentan infartos con síntomas atípicos (equivalentes anginosos) debido a neuropatía diabética, medicamentos, y cambios en percepción del dolor"
            },
    ...
    },
    {
        ...
        options: [
            ...
            {
                letter: "b",
                text: "Los adultos mayores vulnerables requieren evaluación de negligencia/abuso, reporte a autoridades apropiadas, y coordinación con servicios sociales además del tratamiento médico"
            },
    ...
    },
    {
        ...
        options: [
            ...
            {
                letter: "b",
                text: "El acceso intraóseo es la alternativa de elección en niños cuando falla el acceso IV, proporcionando vía equivalente al acceso venoso central para reanimación"
            },
    ...
    },
    {
        ...
        options: [
            ...
            {
                letter: "b",
                text: "Los cambios fisiológicos del envejecimiento (disminución de función renal/hepática, aumento de grasa corporal, disminución de albúmina) alteran la farmacocinética, prolongando efectos y aumentando toxicidad"
            },
