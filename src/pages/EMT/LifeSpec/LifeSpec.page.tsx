                    ...
                    <div className="w-full max-w-7xl">
                        ...
                        {showQuickQuiz && (
                            <div className="bg-white p-6 rounded-lg shadow-md mb-8 max-w-4xl mx-auto">
                                <h3 className="text-xl font-bold mb-4 text-gray-800">Quiz Rápido - Desarrollo y
                                    esperanza de vida</h3>
                                <button
                                ...
                                <div className="space-y-6">
                                    <div>
                                        ...
                                        <ul className="list-disc list-inside space-y-2">
                                            <li><strong>Neonatos (0-1 mes):</strong> Alta dependencia, reflejos
                                                primitivos, respiración nasal.
                                            </li>
                                            <li><strong>Lactantes (1 mes - 1 año):</strong> Desarrollo rápido de
                                                habilidades motoras y sensoriales.
                                            </li>
                                            <li><strong>Niños pequeños (1-3 años):</strong> Desarrollo del lenguaje y
                                                autonomía inicial.
                                            </li>
                                            <li><strong>Niños en edad preescolar (3-6 años):</strong> Crecimiento
                                                emocional y social significativo.
                                            </li>
                                            <li><strong>Niños escolares (6-12 años):</strong> Mayor coordinación,
                                                socialización y razonamiento lógico.
                                            </li>
                                            <li><strong>Adolescentes (12-18 años):</strong> Pubertad, identidad personal
                                                y pensamiento abstracto.
                                            </li>
                                            <li><strong>Adultos jóvenes (19-40 años):</strong> Máxima condición física,
                                                formación de familia y carrera.
                                            </li>
                                            <li><strong>Adultos de mediana edad (41-60 años):</strong> Disminución
                                                gradual de capacidades físicas.
                                            </li>
                                            <li><strong>Adultos mayores (mayor 60 años):</strong> Disminución marcada de
                                                la función fisiológica, importancia del apoyo social.
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-6">
                                    <div>
                                        <h2 className="text-2xl font-semibold mb-3 text-gray-800 border-b pb-2">Constantes
                                            fisiológicas y esperanza de vida</h2>
                                        <div className="overflow-x-auto mb-4">
                                            <table className="min-w-full bg-white">
                                                ...
                                                <tr>
                                                    <td className="py-2 px-4 border">Adulto de edad media(41 a 60
                                                        años)
                                                    </td>
                                                    <td className="py-2 px-4 border">60-100</td>
                                                    <td className="py-2 px-4 border">12-20</td>
                                        ...
                                        <ul className="list-disc list-inside space-y-2">
                                            <li>La frecuencia respiratoria y cardiaca disminuye progresivamente con la
                                                edad.
                                            </li>
                                            <li>La presión arterial tiende a aumentar a medida que la persona
                                                envejece.
                                            </li>
                                            <li>El sistema inmunológico madura en la infancia y declina en la vejez.
                                            </li>
                                ...
                                <div className="space-y-6">
                                    <div>
                                        <h2 className="text-2xl font-semibold mb-3 text-gray-800 border-b pb-2">Consideraciones
                                            en Atención Prehospitalaria</h2>
                                        <ul className="list-disc list-inside space-y-2">
                                            <li>En neonatos y lactantes, la vía aérea es más pequeña y flexible: se
                                                requiere un manejo delicado.
                                            </li>
                                            <li>En niños, la cabeza es proporcionalmente más grande, aumentando el
                                                riesgo de trauma craneal.
                                            </li>
                                            <li>En adultos mayores, considerar comorbilidades, fragilidad ósea y
                                                comunicación clara.
                                            </li>
                                            <li>La evaluación y el tratamiento deben adaptarse a la etapa de desarrollo
                                                y condición fisiológica.
                                            </li>
                                            <li>La comunicación con familiares y cuidadores es clave en pediatría y
                                                geriatría.
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="p-5 bg-gray-50 rounded-lg shadow-sm mb-4">
                                        <h3 className="text-xl font-semibold mb-2 text-orange-600">Ejercicio 1:
                                            Identifica la etapa</h3>
                                        <p className="italic text-gray-600 mb-4">
                                            Un paciente de 2 años acude por fiebre y dificultad respiratoria. ¿A qué
                                            etapa del desarrollo pertenece y qué consideraciones especiales debes tener?
                                        </p>
                                        <div>
                                            <h4 className="font-medium mb-2">Respuesta:</h4>
                                            <ul className="list-disc list-inside space-y-1 text-gray-700">
                                                <li>Niño pequeño (1-3 años)</li>
                                                <li>Vía aérea pequeña, riesgo de deshidratación, comunicación limitada
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div className="p-5 bg-gray-50 rounded-lg shadow-sm mb-4">
                                        <h3 className="text-xl font-semibold mb-2 text-blue-600">Ejercicio 2: Valores
                                            normales</h3>
                                        <p className="italic text-gray-600 mb-4">
                                    ...
                                    <div className="p-5 bg-gray-50 rounded-lg shadow-sm">
                                        <h3 className="text-xl font-semibold mb-2 text-green-600">Ejercicio 3: Adulto
                                            mayor</h3>
                                        <p className="italic text-gray-600 mb-4">
                                            Un adulto mayor con antecedentes de hipertensión y diabetes sufre una caída
                                            en casa. ¿Qué factores debes considerar en la atención prehospitalaria?
                                        </p>
                                        <div>
                                            <h4 className="font-medium mb-2">Respuesta:</h4>
                                            <ul className="list-disc list-inside space-y-1 text-gray-700">
                                ...
                                <div>
                                    ...
                                    <ul className="list-disc list-inside space-y-2 text-gray-700">
                                        <li><a href="https://www.ems1.com/ems-education/" target="_blank"
                                            ...
                                            - Educación y desarrollo humano</a></li>
                                        <li><a href="https://www.jems.com/ems-insider/ems-education/" target="_blank"
                                               rel="noopener noreferrer" className="text-blue-600 hover:underline">JEMS
                                            - Educación y pediatría</a></li>
