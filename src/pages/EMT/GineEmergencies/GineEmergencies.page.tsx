...
import {MdQuiz, MdOutlineTimer, MdWarning, MdCheckCircle} from "react-icons/md";
import {BsBookHalf, BsLightbulb, BsShield, BsExclamationTriangle} from "react-icons/bs";
import {PiChalkboardTeacher} from "react-icons/pi";
import {AiOutlineWoman} from "react-icons/ai";
import {FaExclamationTriangle, FaFirstAid, FaHeartbeat, FaUserMd, FaEye, FaStethoscope} from "react-icons/fa";
import {FiAlertTriangle, FiUser, FiEye, FiHeart, FiActivity} from "react-icons/fi";
                    ...
                    <div className="max-w-5xl mx-auto bg-white rounded-lg shadow-sm p-6 mb-8">
                        {activeTab === 'overview' && (
                            <div className="space-y-8">
                                {/* Alerta de Prioridad */}
                        <div className="bg-gradient-to-r from-red-50 to-pink-50 border-l-4 border-red-500 p-6 rounded-lg mb-8 max-w-5xl mx-auto">
                            ...
                            <p className="text-gray-800 leading-relaxed text-lg">
                                ...
                                La primera pregunta siempre debe ser: <span className="text-red-600 font-bold">"¿Cuándo fue su última menstruación?"</span>
                            </p>
                        </div>
                                ...
                                <div className="bg-gradient-to-r from-red-50 to-pink-50 border-l-4 border-red-500 p-6 rounded-lg">
                                    <div className="flex items-center mb-4">
                                        <FaExclamationTriangle className="w-8 h-8 text-red-500 mr-3"/>
                                        <h2 className="text-2xl font-bold text-red-700">¡Emergencias Potencialmente Mortales!</h2>
                                    </div>
                                    <p className="text-gray-800 leading-relaxed text-lg mb-4">
                                        Las emergencias ginecológicas pueden ser <strong>silenciosas pero mortales</strong>.
                                        El <span className="text-red-600 font-bold">embarazo ectópico roto</span> puede causar 
                                ...
                                <div>
                                    ...
                                    <div className="grid md:grid-cols-3 gap-6">
                                        <div className="bg-gradient-to-b from-red-50 to-red-100 p-6 rounded-lg border border-red-200">
                                            ...
                                            <p className="text-center text-red-600 font-semibold mb-3">Potencialmente mortal</p>
                                        ...
                                        <div className="bg-gradient-to-b from-orange-50 to-orange-100 p-6 rounded-lg border border-orange-200">
                                            ...
                                            <p className="text-center text-orange-600 font-semibold mb-3">Requiere atención inmediata</p>
                                            <ul className="space-y-2 text-gray-700">
                                                <li className="flex items-start">
                                        ...
                                        <div className="bg-gradient-to-b from-yellow-50 to-yellow-100 p-6 rounded-lg border border-yellow-200">
                                            ...
                                            <p className="text-center text-yellow-600 font-semibold mb-3">Evaluación temprana</p>
                                            <ul className="space-y-2 text-gray-700">
                                                <li className="flex items-start">
                                ...
                                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
                                    <div className="flex items-center mb-4">
                                        ...
                                        <h3 className="text-xl font-bold text-yellow-800">Signos de Alarma - Reconocimiento Inmediato</h3>
                                    </div>
                                    <div className="grid md:grid-cols-2 gap-6">
                                        <div>
                                            ...
                                            <ul className="list-disc list-inside space-y-1 text-gray-700">
                                                <li><strong>Tríada de Embarazo Ectópico:</strong> Dolor + amenorrea + sangrado</li>
                                                <li><strong>Dolor en hombro:</strong> Irritación diafragmática por hemoperitoneo</li>
                                                <li><strong>Signo de Cullen:</strong> Equimosis periumbilical</li>
                                                <li><strong>Abdomen en tabla:</strong> Irritación peritoneal</li>
                                                <li><strong>Masa pélvica palpable:</strong> Hematoma o masa ovárica</li>
                                            </ul>
                                        </div>
                                        <div>
                                            <h4 className="font-semibold text-yellow-800 mb-2 flex items-center">
                                            ...
                                            <ul className="list-disc list-inside space-y-1 text-gray-700">
                                                <li><strong>Hipotensión ortostática:</strong> Pérdida de volumen</li>
                                                ...
                                                <li><strong>Alteración del estado mental:</strong> Shock o sepsis</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="grid md:grid-cols-2 gap-6">
                                        <div className="space-y-3">
                                            <div className="flex items-start">
                                                <span className="bg-blue-600 text-white rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mr-3 mt-1">P</span>
                                                <div>
                                                    <p className="font-semibold">Pain (Dolor)</p>
                                                    <p className="text-sm text-gray-600">Localización, intensidad, irradiación</p>
                                                </div>
                                            </div>
                                            <div className="flex items-start">
                                                <span className="bg-blue-600 text-white rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mr-3 mt-1">R</span>
                                                <div>
                                                    <p className="font-semibold">Reproductive history (Historia reproductiva)</p>
                                                    <p className="text-sm text-gray-600">Embarazos, partos, abortos</p>
                                                </div>
                                            </div>
                                            <div className="flex items-start">
                                                <span className="bg-blue-600 text-white rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mr-3 mt-1">E</span>
                                                <div>
                                                    <p className="font-semibold">Emergency symptoms (Síntomas de emergencia)</p>
                                                    <p className="text-sm text-gray-600">Sangrado, dolor severo, shock</p>
                                                </div>
                                            </div>
                                            <div className="flex items-start">
                                                <span className="bg-blue-600 text-white rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mr-3 mt-1">G</span>
                                                <div>
                                                    <p className="font-semibold">Gynecological history (Historia ginecológica)</p>
                                                    <p className="text-sm text-gray-600">Cirugías, infecciones previas</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="space-y-3">
                                            <div className="flex items-start">
                                                <span className="bg-blue-600 text-white rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mr-3 mt-1">N</span>
                                                <div>
                                                    <p className="font-semibold">Nausea/vomiting (Náuseas/vómitos)</p>
                                                    <p className="text-sm text-gray-600">Asociados con embarazo o dolor</p>
                                                </div>
                                            </div>
                                            <div className="flex items-start">
                                                <span className="bg-blue-600 text-white rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mr-3 mt-1">A</span>
                                                <div>
                                                    <p className="font-semibold">Amenorrhea (Amenorrea)</p>
                                                    <p className="text-sm text-gray-600">FUM - Fecha de última menstruación</p>
                                                </div>
                                            </div>
                                            <div className="flex items-start">
                                                <span className="bg-blue-600 text-white rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mr-3 mt-1">N</span>
                                                <div>
                                                    <p className="font-semibold">Neurological status (Estado neurológico)</p>
                                                    <p className="text-sm text-gray-600">Nivel de conciencia, confusión</p>
                                                </div>
                                            </div>
                                            <div className="flex items-start">
                                                <span className="bg-blue-600 text-white rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mr-3 mt-1">T</span>
                                                <div>
                                                    <p className="font-semibold">Temperature (Temperatura)</p>
                                                    <p className="text-sm text-gray-600">Fiebre indica proceso infeccioso</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div className="space-y-8">
                                ...
                                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border-l-4 border-blue-500 p-6 rounded-lg">
                                    <div className="flex items-center mb-4">
                                        ...
                                        <h2 className="text-2xl font-bold text-blue-700">Anatomía Reproductiva Femenina</h2>
                                    </div>
                                    <div className="grid md:grid-cols-2 gap-6">
                                        <div>
                                            <h3 className="font-semibold text-lg mb-3 text-blue-800">Órganos Internos</h3>
                                            <div className="space-y-4">
                                                ...
                                                <div className="bg-white p-4 rounded-lg shadow-sm">
                                                    <h4 className="font-semibold text-gray-800 mb-2">Trompas de Falopio</h4>
                                                    <ul className="text-sm text-gray-600 space-y-1">
                                        ...
                                        <div>
                                            ...
                                            <div className="bg-white p-4 rounded-lg shadow-sm mb-4">
                                                <h4 className="font-semibold text-gray-800 mb-2 text-red-600">⚠️ Importancia Clínica</h4>
                                                <p className="text-sm text-gray-600 mb-2">
                                                    La <strong>rica vascularización</strong> del área pélvica explica por qué las 
                                                    emergencias ginecológicas pueden causar hemorragias masivas rápidamente.
                                                </p>
                                                <ul className="text-sm text-gray-600 space-y-1">
                                        ...
                                        <div className="space-y-4">
                                            <div className="bg-blue-50 p-4 rounded-lg">
                                                <h3 className="font-bold text-blue-700 mb-2 flex items-center">
                                                    <span className="bg-blue-600 text-white rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mr-2">S</span>
                                                    Síntomas
                                                </h3>
                                            ...
                                            <div className="bg-green-50 p-4 rounded-lg">
                                                <h3 className="font-bold text-green-700 mb-2 flex items-center">
                                                    <span className="bg-green-600 text-white rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mr-2">A</span>
                                                    Alergias
                                                </h3>
                                                <ul className="text-sm text-gray-700 space-y-1">
                                            ...
                                            <div className="bg-yellow-50 p-4 rounded-lg">
                                                <h3 className="font-bold text-yellow-700 mb-2 flex items-center">
                                                    <span className="bg-yellow-600 text-white rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mr-2">M</span>
                                                    Medicamentos
                                                </h3>
                                                <ul className="text-sm text-gray-700 space-y-1">
                                        ...
                                        <div className="space-y-4">
                                            <div className="bg-purple-50 p-4 rounded-lg">
                                                <h3 className="font-bold text-purple-700 mb-2 flex items-center">
                                                    <span className="bg-purple-600 text-white rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mr-2">P</span>
                                                    Patologías Pasadas
                                                </h3>
                                                <ul className="text-sm text-gray-700 space-y-1">
                                            ...
                                            <div className="bg-red-50 p-4 rounded-lg">
                                                <h3 className="font-bold text-red-700 mb-2 flex items-center">
                                                    <span className="bg-red-600 text-white rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mr-2">L</span>
                                                    Última Ingesta
                                                </h3>
                                                <ul className="text-sm text-gray-700 space-y-1">
                                            ...
                                            <div className="bg-orange-50 p-4 rounded-lg">
                                                <h3 className="font-bold text-orange-700 mb-2 flex items-center">
                                                    <span className="bg-orange-600 text-white rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mr-2">E</span>
                                                    Eventos
                                                </h3>
                                                <ul className="text-sm text-gray-700 space-y-1">
                                ...
                                <div className="bg-pink-50 border border-pink-200 rounded-lg p-6">
                                    <div className="flex items-center mb-4">
                                        ...
                                        <h3 className="text-xl font-bold text-pink-800">Historia Ginecológica Específica</h3>
                                    </div>
                                    <div className="grid md:grid-cols-2 gap-6">
                                        <div>
                                            <h4 className="font-semibold text-pink-800 mb-3">Preguntas Esenciales (G-PPAL)</h4>
                                        ...
                                        <div>
                                            <h4 className="font-semibold text-pink-800 mb-3">Información Adicional</h4>
                                    ...
                                    <div className="grid md:grid-cols-2 gap-6">
                                        <div className="space-y-4">
                                            ...
                                            <div className="bg-gradient-to-r from-green-50 to-green-100 p-4 rounded-lg border">
                                                <h3 className="font-bold text-green-700 mb-2">2. Evaluación General</h3>
                                                <ul className="text-sm text-gray-700 space-y-1">
                                            ...
                                            <div className="bg-gradient-to-r from-yellow-50 to-yellow-100 p-4 rounded-lg border">
                                                <h3 className="font-bold text-yellow-700 mb-2">3. Examen Abdominal</h3>
                                                <ul className="text-sm text-gray-700 space-y-1">
                                        ...
                                        <div className="space-y-4">
                                            <div className="bg-red-50 p-4 rounded-lg border border-red-200">
                                                ...
                                                <ul className="text-sm text-gray-700 space-y-1">
                                                    ...
                                                    <li>• <strong>Hipotensión ortostática:</strong> ↓&gt;20 mmHg</li>
                                                    <li>• <strong>Alteración mental:</strong> Confusión, agitación</li>
                                                </ul>
                                            </div>
                                            <div className="bg-purple-50 p-4 rounded-lg border border-purple-200">
                                                <h3 className="font-bold text-purple-700 mb-2">Signos Específicos</h3>
                                                <ul className="text-sm text-gray-700 space-y-1">
                                                    <li>• <strong>Signo de Cullen:</strong> Equimosis periumbilical</li>
                                                    <li>• <strong>Signo de Turner:</strong> Equimosis en flancos</li>
                                                    <li>• <strong>Dolor en hombro:</strong> Irritación diafragmática</li>
                                                    <li>• <strong>Masa palpable:</strong> Hematoma, quiste</li>
                                                    <li>• <strong>Abdomen en tabla:</strong> Irritación peritoneal</li>
                                                </ul>
                                            </div>
                                            <div className="bg-orange-50 p-4 rounded-lg border border-orange-200">
                                                <h3 className="font-bold text-orange-700 mb-2">Evaluación del Sangrado</h3>
                                                <ul className="text-sm text-gray-700 space-y-1">
                                ...
                                <div className="bg-gray-50 border border-gray-200 rounded-lg p-6">
                                    <div className="flex items-center mb-4">
                                        ...
                                        <h3 className="text-xl font-bold text-gray-800">Algoritmo de Evaluación Rápida</h3>
                                    </div>
                            ...
                            <div className="space-y-8">
                                ...
                                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border-l-4 border-blue-500 p-6 rounded-lg">
                                    <div className="flex items-center mb-4">
                                        ...
                                        <h2 className="text-2xl font-bold text-blue-700">Protocolo ABC - Enfoque Ginecológico</h2>
                                    </div>
                                    <div className="grid md:grid-cols-3 gap-6">
                                    ...
                                    <div className="grid md:grid-cols-2 gap-6">
                                        <div className="bg-green-50 p-4 rounded-lg border border-green-200">
                                            ...
                                            <ol className="list-decimal list-inside space-y-2 text-gray-700">
                                                <li><strong>Usar toallas sanitarias externas</strong> para absorber sangre</li>
                                                <li><strong>Contar y documentar</strong> número de toallas usadas</li>
                                                <li><strong>Guardar toallas usadas</strong> para evaluación médica</li>
                                                <li><strong>Elevar miembros inferiores</strong> si signos de shock</li>
                                                <li><strong>Establecer acceso IV</strong> (14-16G) si hemorragia severa</li>
                                                <li><strong>Administrar cristaloides</strong> (NS o LR) según protocolo</li>
                                        ...
                                        <div className="bg-red-50 p-4 rounded-lg border border-red-200">
                                            ...
                                            <ul className="list-disc list-inside space-y-2 text-gray-700">
                                                <li><strong className="text-red-600">NUNCA empacar la vagina</strong> con gasas, tampones o cualquier material</li>
                                                <li><strong className="text-red-600">NO realizar examen pélvico</strong> interno en campo</li>
                                                <li><strong className="text-red-600">NO insertar objetos</strong> en la vagina</li>
                                                <li><strong className="text-red-600">NO aplicar presión directa</strong> sobre genitales externos</li>
                                                <li><strong className="text-red-600">NO asumir normalidad</strong> del sangrado</li>
                                                <li><strong className="text-red-600">NO administrar medicamentos</strong> orales si puede requerir cirugía</li>
                                                <li><strong className="text-red-600">NO permitir baño</strong> o ducha antes de evaluación</li>
                                                <li><strong className="text-red-600">NO hacer comentarios</strong> inapropiados o juicios</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="space-y-6">
                                        <div className="bg-gradient-to-r from-red-50 to-pink-50 p-6 rounded-lg border border-red-200">
                                            ...
                                            <div className="grid md:grid-cols-2 gap-4">
                                                ...
                                                <div>
                                                    <h4 className="font-semibold text-red-600 mb-2">Manejo Inmediato:</h4>
                                                    <ol className="text-sm text-gray-700 space-y-1">
                                                        <li>1. <strong>Prioridad 1:</strong> Potencialmente mortal</li>
                                                        <li>2. <strong>Dos accesos IV</strong> grandes (14-16G)</li>
                                                        <li>3. <strong>Cristaloides en bolo</strong> 500-1000ml</li>
                                                        <li>4. <strong>Posición anti-shock</strong> (Trendelenburg)</li>
                                            ...
                                            <div className="grid md:grid-cols-2 gap-4">
                                                ...
                                                <div>
                                                    ...
                                                    <ol className="text-sm text-gray-700 space-y-1">
                                                        ...
                                                        <li>4. <strong>Manejo del dolor</strong> según protocolo</li>
                                                        <li>5. <strong>Monitorizar sepsis</strong> (FC, PA, temp)</li>
                                        ...
                                        <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-6 rounded-lg border border-blue-200">
                                            ...
                                            <div className="grid md:grid-cols-2 gap-4">
                                                ...
                                                <div>
                                                    <h4 className="font-semibold text-blue-600 mb-2">Manejo Urgente:</h4>
                                                    <ol className="text-sm text-gray-700 space-y-1">
                                                        <li>1. <strong>Emergencia quirúrgica</strong> - tiempo crucial</li>
                                        ...
                                        <div className="bg-gradient-to-r from-purple-50 to-pink-50 p-6 rounded-lg border border-purple-200">
                                            ...
                                            <div className="grid md:grid-cols-2 gap-4">
                                                <div>
                                                    <h4 className="font-semibold text-purple-600 mb-2">Consideraciones Especiales:</h4>
                                                    <ul className="text-sm text-gray-700 space-y-1">
                                                ...
                                                <div>
                                                    <h4 className="font-semibold text-purple-600 mb-2">Protocolo Sensible:</h4>
                                                    <ol className="text-sm text-gray-700 space-y-1">
                                                        <li>1. <strong>Prioridad médica</strong> sobre evidencia</li>
                                                        <li>2. <strong>Ser empático</strong> y no juzgar</li>
                                                        <li>3. <strong>Preservar evidencia:</strong> no bañar/cambiar ropa</li>
                                                        <li>4. <strong>Tratar lesiones</strong> amenazantes</li>
                                                        <li>5. <strong>Acompañante</strong> femenino si disponible</li>
                                                        <li>6. <strong>Documentar objetivamente</strong></li>
                                                        <li>7. <strong>Servicios de apoyo</strong> (trabajo social)</li>
                                                    </ol>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
                                    <div className="flex items-center mb-4">
                                        <FiAlertTriangle className="w-6 h-6 text-yellow-600 mr-2"/>
                                        <h3 className="text-xl font-bold text-yellow-800">Criterios de Transporte</h3>
                                    </div>
                                    <div className="grid md:grid-cols-3 gap-6">
                                        <div className="bg-red-100 p-4 rounded-lg">
                                            <h4 className="font-bold text-red-700 mb-2 text-center">🚨 TRANSPORTE INMEDIATO</h4>
                                            <ul className="text-sm text-gray-700 space-y-1">
                                        ...
                                        <div className="bg-orange-100 p-4 rounded-lg">
                                            <h4 className="font-bold text-orange-700 mb-2 text-center">⚠️ TRANSPORTE URGENTE</h4>
                                            <ul className="text-sm text-gray-700 space-y-1">
                                        ...
                                        <div className="bg-yellow-100 p-4 rounded-lg">
                                            <h4 className="font-bold text-yellow-700 mb-2 text-center">📋 TRANSPORTE PRIORITARIO</h4>
                                            <ul className="text-sm text-gray-700 space-y-1">
                                ...
                                <div className="bg-green-50 border border-green-200 rounded-lg p-6">
                                    <div className="flex items-center mb-4">
                                        ...
                                        <h3 className="text-xl font-bold text-green-800">Consideraciones Especiales</h3>
                                    </div>
                                    <div className="grid md:grid-cols-2 gap-6">
                                        <div>
                                            <h4 className="font-semibold text-green-800 mb-2">Privacidad y Dignidad</h4>
                                            <ul className="list-disc list-inside space-y-1 text-gray-700">
                                        ...
                                        <div>
                                            <h4 className="font-semibold text-green-800 mb-2">Documentación Clínica</h4>
                                            <ul className="list-disc list-inside space-y-1 text-gray-700">
                            ...
                            <div className="space-y-8">
                                <div className="bg-gradient-to-r from-blue-50 to-purple-50 border-l-4 border-blue-500 p-6 rounded-lg">
                                    <div className="flex items-center mb-4">
                                        ...
                                        <h2 className="text-2xl font-bold text-blue-700">Casos Clínicos - Escenarios Reales</h2>
                                    </div>
                                    <p className="text-gray-700 leading-relaxed">
                                        Practica con casos reales de emergencias ginecológicas. Cada caso incluye presentación clínica, 
                                        proceso de evaluación y manejo step-by-step basado en protocolos actuales.
                                    </p>
                                </div>

                                <div className="grid gap-8">
                                    <div className="bg-gradient-to-r from-red-50 to-pink-50 rounded-lg shadow-lg p-6 border border-red-200">
                                        <div className="flex items-center mb-4">
                                            <span className="bg-red-500 text-white rounded-full w-8 h-8 flex items-center justify-center text-lg font-bold mr-3">1</span>
                                            <h3 className="text-xl font-semibold text-red-700">Embarazo Ectópico Roto - Código Rojo</h3>
                                        </div>
                                        
                                        <div className="bg-white p-4 rounded-lg shadow-sm mb-4">
                                            <h4 className="font-semibold text-gray-800 mb-2">📋 Presentación del Caso</h4>
                                            <p className="text-gray-700 mb-3">
                                                <strong>Paciente:</strong> Mujer de 26 años, G2P1, llama al 911 por dolor abdominal severo y súbito.
                                                Al llegar, la encuentran en el piso del baño, pálida, sudorosa, con dolor intenso en fosa ilíaca derecha.
                                            </p>
                                        ...
                                        <div className="bg-white p-4 rounded-lg shadow-sm mb-4">
                                            <h4 className="font-semibold text-gray-800 mb-2">🔍 Hallazgos Clínicos Clave</h4>
                                            <div className="grid md:grid-cols-2 gap-4 text-sm">
                                                <div>
                                        ...
                                        <div className="bg-red-100 p-4 rounded-lg">
                                            <h4 className="font-semibold text-red-700 mb-2">🚨 Manejo de Emergencia</h4>
                                            <ol className="list-decimal list-inside space-y-1 text-gray-700">
                                                <li><strong>Reconocimiento inmediato:</strong> Embarazo ectópico roto con shock</li>
                                                <li><strong>Posición anti-shock:</strong> Trendelenburg modificado</li>
                                                <li><strong>Dos accesos IV:</strong> 14G, cristaloides en bolo 1000ml</li>
                                                ...
                                                <li><strong>Comunicación:</strong> Preaviso inmediato al hospital</li>
                                                <li><strong>Transporte:</strong> Código rojo a centro con cirugía</li>
                                            </ol>
                                        </div>
                                    </div>

                                    <div className="bg-gradient-to-r from-orange-50 to-yellow-50 rounded-lg shadow-lg p-6 border border-orange-200">
                                        <div className="flex items-center mb-4">
                                            ...
                                            <h3 className="text-xl font-semibold text-orange-700">Enfermedad Pélvica Inflamatoria Severa</h3>
                                        </div>
                                        
                                        <div className="bg-white p-4 rounded-lg shadow-sm mb-4">
                                            <h4 className="font-semibold text-gray-800 mb-2">📋 Presentación del Caso</h4>
                                            <p className="text-gray-700 mb-3">
                                                <strong>Paciente:</strong> Mujer de 22 años, sexualmente activa, con dolor pélvico de 4 días de evolución que ha empeorado progresivamente.
                                        ...
                                        <div className="bg-white p-4 rounded-lg shadow-sm mb-4">
                                            <h4 className="font-semibold text-gray-800 mb-2">⚠️ Evaluación de Riesgo</h4>
                                            <div className="grid md:grid-cols-2 gap-4 text-sm">
                                                <div>
                                                    <p className="font-medium text-orange-600">Factores de Riesgo:</p>
                                                    <ul className="list-disc list-inside space-y-1 text-gray-600">
                                        ...
                                        <div className="bg-orange-100 p-4 rounded-lg">
                                            ...
                                            <ol className="list-decimal list-inside space-y-1 text-gray-700">
                                                <li><strong>Posición cómoda:</strong> Semi-fowler para aliviar dolor</li>
                                                <li><strong>Acceso IV:</strong> 18G para hidratación y medicamentos</li>
                                                <li><strong>Control de temperatura:</strong> Medidas físicas + antitérmicos</li>
                                                <li><strong>Manejo del dolor:</strong> Analgésicos según protocolo</li>
                                                <li><strong>Monitorización:</strong> Signos vitales cada 15 minutos</li>
                                                <li><strong>Hidratación:</strong> Cristaloides para mantener perfusión</li>
                                                <li><strong>Transporte:</strong> A centro con capacidad de manejo de sepsis</li>
                                            </ol>
                                        </div>
                                    </div>
                                    ...
                                    <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg shadow-lg p-6 border border-blue-200">
                                        <div className="flex items-center mb-4">
                                            <span className="bg-blue-500 text-white rounded-full w-8 h-8 flex items-center justify-center text-lg font-bold mr-3">3</span>
                                            <h3 className="text-xl font-semibold text-blue-700">Torsión Ovárica - Emergencia Quirúrgica</h3>
                                        </div>
                                        
                                        <div className="bg-white p-4 rounded-lg shadow-sm mb-4">
                                            <h4 className="font-semibold text-gray-800 mb-2">📋 Presentación del Caso</h4>
                                            <p className="text-gray-700 mb-3">
                                                <strong>Paciente:</strong> Adolescente de 16 años, atleta, presenta dolor abdominal súbito e intenso en fosa ilíaca derecha 
                                        ...
                                        <div className="bg-white p-4 rounded-lg shadow-sm mb-4">
                                            <h4 className="font-semibold text-gray-800 mb-2">⏰ Factor Tiempo - Crítico</h4>
                                            <div className="grid md:grid-cols-2 gap-4 text-sm">
                                                <div>
                                                    <p className="font-medium text-blue-600">Signos Diagnósticos:</p>
                                                    <ul className="list-disc list-inside space-y-1 text-gray-600">
                                        ...
                                        <div className="bg-blue-100 p-4 rounded-lg">
                                            ...
                                            <ol className="list-decimal list-inside space-y-1 text-gray-700">
                                                <li><strong>Reconocimiento:</strong> Emergencia quirúrgica tiempo-dependiente</li>
                                                <li><strong>Control del dolor:</strong> Analgésicos potentes (morfina/fentanilo)</li>
                                                <li><strong>Antieméticos:</strong> Ondansetrón para náuseas</li>
                                                <li><strong>Acceso IV:</strong> Para medicamentos y fluidos</li>
                                                <li><strong>Posición:</strong> De comodidad (generalmente lateral)</li>
                                                <li><strong>Comunicación:</strong> Preaviso urgente - sospecha torsión</li>
                                                <li><strong>Transporte:</strong> Código amarillo a centro quirúrgico</li>
                                            </ol>
                                        </div>
                                    </div>
                                    ...
                                    <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg shadow-lg p-6 border border-purple-200">
                                        <div className="flex items-center mb-4">
                                            <span className="bg-purple-500 text-white rounded-full w-8 h-8 flex items-center justify-center text-lg font-bold mr-3">4</span>
                                            <h3 className="text-xl font-semibold text-purple-700">Hemorragia Uterina Disfuncional</h3>
                                        </div>
                                        
                                        <div className="bg-white p-4 rounded-lg shadow-sm mb-4">
                                            <h4 className="font-semibold text-gray-800 mb-2">📋 Presentación del Caso</h4>
                                            <p className="text-gray-700 mb-3">
                                                <strong>Paciente:</strong> Mujer de 35 años con sangrado vaginal abundante de 12 días de duración. 
                                                Refiere debilidad, mareos y ha empapado &gt;2 toallas por hora en las últimas 6 horas.
                                            </p>
                                            <div className="grid md:grid-cols-2 gap-4 text-sm">
                                                <div>
                                                    <p><strong>Historia:</strong></p>
                                        ...
                                        <div className="bg-white p-4 rounded-lg shadow-sm mb-4">
                                            <h4 className="font-semibold text-gray-800 mb-2">📊 Evaluación de Pérdida Sanguínea</h4>
                                            <div className="grid md:grid-cols-2 gap-4 text-sm">
                                                <div>
                                        ...
                                        <div className="bg-purple-100 p-4 rounded-lg">
                                            <h4 className="font-semibold text-purple-700 mb-2">🩸 Manejo de Hemorragia</h4>
                                            <ol className="list-decimal list-inside space-y-1 text-gray-700">
                                                <li><strong>Cuantificación:</strong> Contar y pesar toallas usadas</li>
                                                <li><strong>Posición:</strong> Semi-fowler, elevar piernas si shock</li>
                                                <li><strong>Acceso IV:</strong> 16G para reposición de volumen</li>
                                                <li><strong>Cristaloides:</strong> Infusión según pérdida estimada</li>
                                                <li><strong>Monitorización:</strong> Signos vitales cada 10 minutos</li>
                                    ...
                                    <div className="bg-gradient-to-r from-gray-50 to-indigo-50 rounded-lg shadow-lg p-6 border border-gray-200">
                                        <div className="flex items-center mb-4">
                                            <span className="bg-gray-500 text-white rounded-full w-8 h-8 flex items-center justify-center text-lg font-bold mr-3">5</span>
                                            <h3 className="text-xl font-semibold text-gray-700">Agresión Sexual - Manejo Integral</h3>
                                        </div>
                                        
                                        <div className="bg-white p-4 rounded-lg shadow-sm mb-4">
                                            <h4 className="font-semibold text-gray-800 mb-2">📋 Presentación del Caso</h4>
                                            <p className="text-gray-700 mb-3">
                                                <strong>Situación:</strong> Mujer de 28 años encontrada por amigas en estado de shock emocional, 
                                                con ropa desgarrada y evidencia de trauma físico. Refiere haber sido agredida sexualmente.
                                            </p>
                                            <div className="bg-yellow-50 p-3 rounded border border-yellow-200">
                                                <p className="text-sm text-yellow-800">
                                                    <strong>Nota:</strong> Este caso requiere manejo especializado con consideraciones médicas, 
                                        ...
                                        <div className="bg-white p-4 rounded-lg shadow-sm mb-4">
                                            <h4 className="font-semibold text-gray-800 mb-2">🤝 Enfoque Multidisciplinario</h4>
                                            <div className="grid md:grid-cols-2 gap-4 text-sm">
                                                <div>
                                                    <p className="font-medium text-indigo-600">Prioridades Médicas:</p>
                                                    <ul className="list-disc list-inside space-y-1 text-gray-600">
                                                ...
                                                <div>
                                                    <p className="font-medium text-indigo-600">Consideraciones Legales:</p>
                                                    <ul className="list-disc list-inside space-y-1 text-gray-600">
                                                        <li>Preservación de evidencia</li>
                                        ...
                                        <div className="bg-indigo-100 p-4 rounded-lg">
                                            <h4 className="font-semibold text-indigo-700 mb-2">🏥 Protocolo Especializado</h4>
                                            <ol className="list-decimal list-inside space-y-1 text-gray-700">
                                                <li><strong>Prioridad médica:</strong> Estabilizar antes que preservar evidencia</li>
                                                <li><strong>Comunicación:</strong> Empática, no juzgar, profesional</li>
                                                <li><strong>Privacidad:</strong> Ambiente seguro y confidencial</li>
                                                <li><strong>Preservación:</strong> No cambiar ropa, no bañar, no lavar</li>
                                                <li><strong>Documentación:</strong> Objetiva, con citas textuales</li>
                                                <li><strong>Servicios:</strong> Activar trabajo social y policía</li>
                                ...
                                <div className="bg-gray-50 border border-gray-200 rounded-lg p-6">
                                    <div className="flex items-center mb-4">
                                        ...
                                        <h3 className="text-xl font-bold text-gray-800">Guía de Decisiones Rápidas</h3>
                                    </div>
                                        ...
                                        <table className="min-w-full bg-white border border-gray-200 rounded-lg">
                                            <thead>
                                                <tr className="bg-gray-100">
                                                    ...
                                                    <th className="py-3 px-4 border-b text-left font-semibold">Sospecha Diagnóstica</th>
                                                    <th className="py-3 px-4 border-b text-left font-semibold">Prioridad</th>
                                                    <th className="py-3 px-4 border-b text-left font-semibold">Acción Inmediata</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr className="hover:bg-gray-50">
                                                    <td className="py-3 px-4 border-b">Dolor súbito + amenorrea + shock</td>
                                                    <td className="py-3 px-4 border-b">Embarazo ectópico roto</td>
                                                    <td className="py-3 px-4 border-b">
                                                        <span className="bg-red-100 text-red-800 px-2 py-1 rounded text-xs">CRÍTICA</span>
                                                    </td>
                                                    <td className="py-3 px-4 border-b">2 IV + cristaloides + transporte inmediato</td>
                                                </tr>
                                                <tr className="hover:bg-gray-50">
                                                    <td className="py-3 px-4 border-b">Dolor pélvico + fiebre + flujo</td>
                                                    <td className="py-3 px-4 border-b">EPI</td>
                                                    <td className="py-3 px-4 border-b">
                                                        <span className="bg-orange-100 text-orange-800 px-2 py-1 rounded text-xs">URGENTE</span>
                                                    </td>
                                                    <td className="py-3 px-4 border-b">IV + analgesia + antibióticos</td>
                                                </tr>
                                                <tr className="hover:bg-gray-50">
                                                    <td className="py-3 px-4 border-b">Dolor unilateral súbito + náuseas</td>
                                                    <td className="py-3 px-4 border-b">Torsión ovárica</td>
                                                    <td className="py-3 px-4 border-b">
                                                        <span className="bg-blue-100 text-blue-800 px-2 py-1 rounded text-xs">QUIRÚRGICA</span>
                                                    </td>
                                                    <td className="py-3 px-4 border-b">Analgesia + antieméticos + transporte rápido</td>
                                                </tr>
                                                <tr className="hover:bg-gray-50">
                                                    <td className="py-3 px-4 border-b">Sangrado abundante + anemia</td>
                                                    <td className="py-3 px-4 border-b">Hemorragia uterina</td>
                                                    <td className="py-3 px-4 border-b">
                                                        <span className="bg-purple-100 text-purple-800 px-2 py-1 rounded text-xs">MODERADA</span>
                                                    </td>
                                                    <td className="py-3 px-4 border-b">Cuantificar + IV + reposición volumen</td>
                                                </tr>
                                                <tr className="hover:bg-gray-50">
                                                    <td className="py-3 px-4 border-b">Trauma + shock emocional</td>
                                                    <td className="py-3 px-4 border-b">Agresión sexual</td>
                                                    <td className="py-3 px-4 border-b">
                                                        <span className="bg-gray-100 text-gray-800 px-2 py-1 rounded text-xs">ESPECIAL</span>
                                                    </td>
                                                    <td className="py-3 px-4 border-b">Preservar evidencia + apoyo + protocolo</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
