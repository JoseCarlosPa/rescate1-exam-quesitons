...
import {MdCheckCircle, MdHealthAndSafety, MdOutlineTimer, MdQuiz, MdWarning} from "react-icons/md";
import {BsBookHalf, BsEye, BsHeart, BsLightbulb, BsShield} from "react-icons/bs";
import {PiChalkboardTeacher, PiStethoscope} from "react-icons/pi";
import {FaExclamationTriangle, FaFirstAid, FaThermometerHalf, FaUserMd} from "react-icons/fa";
                ...
                <div
                    ...
                    <div className="w-full max-w-7xl">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-8 max-w-4xl mx-auto">
                            ...
                            <a href="https://drive.google.com/file/d/100JgEU2s_DwwMyHll7S0k9p_yLWmrjAn/view?usp=drive_link"
                        ...
                        <section className="max-w-5xl mx-auto p-6 bg-white rounded-lg shadow-sm">
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <ul className="list-disc list-inside space-y-2 text-gray-700">
                                        <li><a href="https://www.ems1.com/ems-products/assessment/" target="_blank"
                                               rel="noopener noreferrer" className="text-blue-600 hover:underline">EMS1
                                            - Artículos sobre valoración médica</a></li>
