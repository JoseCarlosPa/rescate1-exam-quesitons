...
import {FaExclamationTriangle, FaBrain, FaFirstAid} from "react-icons/fa";
                    ...
                    <div className="w-full max-w-7xl">
                        ...
                        <div className="bg-gradient-to-r from-red-50 to-orange-50 border-l-4 border-red-500 p-6 rounded-lg mb-8 max-w-5xl mx-auto">
                            ...
                            <p className="text-gray-800 leading-relaxed text-lg mb-4">
                                Las lesiones de cabeza y columna vertebral pueden causar <strong>discapacidad permanente o muerte</strong>.
                                El manejo adecuado prehospitalario es crucial para prevenir lesiones secundarias.
                            </p>
                            <div className="grid md:grid-cols-3 gap-4">
                                ...
                                <div className="bg-white p-4 rounded shadow-sm text-center">
                                    ...
                                    <div>
                                        ...
                                        <div className="grid md:grid-cols-3 gap-6">
                                            <div className="bg-gradient-to-b from-red-50 to-red-100 p-6 rounded-lg border">
                                                <h3 className="text-xl font-bold text-red-700 mb-3 text-center">A - AIRWAY</h3>
                                            ...
                                            <div className="bg-gradient-to-b from-blue-50 to-blue-100 p-6 rounded-lg border">
                                                <h3 className="text-xl font-bold text-blue-700 mb-3 text-center">B - BREATHING</h3>
                                                <ul className="space-y-2 text-gray-700">
                                                    <li className="flex items-start">
                                    ...
                                    <div>
                                        <h2 className="text-2xl font-semibold mb-3 text-gray-800 border-b pb-2">Mecanismos de lesión de alto riesgo</h2>
                                        <div className="grid md:grid-cols-2 gap-6">
                                            <div className="bg-orange-50 p-6 rounded-lg border border-orange-200">
                                                ...
                                                <ul className="list-disc list-inside space-y-2 text-gray-700">
                                                    ...
                                                    <li>Caídas de altura &gt; 3 metros o 3 veces la altura del paciente</li>
                            ...
                            {activeTab === 'assessment' && (
                                <div className="space-y-6">
                                    ...
                                    <div>
                                        <h2 className="text-2xl font-semibold mb-3 text-gray-800 border-b pb-2">Evaluación neurológica - Escala de Glasgow</h2>
                                        <div className="overflow-x-auto">
                                            <table className="min-w-full bg-white border">
                                                <thead>
                                                    <tr className="bg-gray-100">
                                                        <th className="py-3 px-4 border text-left font-semibold">Puntuación</th>
                                                        <th className="py-3 px-4 border text-left font-semibold">Apertura ocular</th>
                                                        <th className="py-3 px-4 border text-left font-semibold">Respuesta verbal</th>
                                                        <th className="py-3 px-4 border text-left font-semibold">Respuesta motora</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td className="py-2 px-4 border">Flexión anormal (decorticación)</td>
                                                    </tr>
                                                    <tr className="bg-orange-50">
                                                        ...
                                                        <td className="py-2 px-4 border">Extensión anormal (descerebración)</td>
                                                    </tr>
                                        ...
                                        <div className="mt-4 p-4 bg-blue-50 rounded-lg">
                                            ...
                                            <ul className="space-y-1 text-gray-700">
                                                ...
                                                <li><strong>≤8:</strong> TCE severo (requiere manejo avanzado de vía aérea)</li>
                                            </ul>
                                        </div>
                                    </div>

                                    <div>
                                        <h2 className="text-2xl font-semibold mb-3 text-gray-800 border-b pb-2">Signos y síntomas críticos</h2>
                            ...
                            <div className="space-y-8">
                                ...
                                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border-l-4 border-blue-500 p-6 rounded-lg">
                                    <div className="flex items-center mb-4">
                                        ...
                                        <h2 className="text-2xl font-bold text-blue-800">Principios Fundamentales del Manejo</h2>
                                    </div>
                                    <div className="grid md:grid-cols-3 gap-4">
                                        ...
                                        <div className="bg-orange-50 p-6 rounded-lg border border-orange-200">
                                            ...
                                            <div className="space-y-3">
                                                <div className="p-3 bg-green-100 rounded border-l-4 border-green-500">
                                                    <p className="font-semibold text-green-800">TCE Leve (GCS 14-15)</p>
                                                    <p className="text-sm text-gray-700">Observación, evaluación seriada, traslado para TC</p>
                                                </div>
                                                <div className="p-3 bg-yellow-100 rounded border-l-4 border-yellow-500">
                                                    <p className="font-semibold text-yellow-800">TCE Moderado (GCS 9-13)</p>
                                                    <p className="text-sm text-gray-700">O₂, monitorización continua, traslado urgente</p>
                                                </div>
                                                <div className="p-3 bg-red-100 rounded border-l-4 border-red-500">
                                                    <p className="font-semibold text-red-800">TCE Severo (GCS ≤8)</p>
                                                    <p className="text-sm text-gray-700">Intubación, ventilación controlada, traslado inmediato</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <table className="min-w-full bg-white border border-gray-200 rounded-lg">
                                            <thead>
                                                <tr className="bg-gradient-to-r from-gray-100 to-gray-200">
                                                    ...
                                                    <th className="py-3 px-4 border text-left font-semibold text-gray-800">Consideraciones críticas</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr className="hover:bg-blue-50">
                                                    <td className="py-3 px-4 border font-medium text-blue-700">Estabilización manual</td>
                                                    <td className="py-3 px-4 border">Inicio inmediato, mantener hasta inmovilización completa</td>
                                                    <td className="py-3 px-4 border">❌ Sin tracción, posición anatómica neutra</td>
                                                </tr>
                                                <tr className="hover:bg-green-50">
                                                    <td className="py-3 px-4 border font-medium text-green-700">Collarín cervical</td>
                                                    <td className="py-3 px-4 border">Complemento, NO reemplaza estabilización manual</td>
                                                    <td className="py-3 px-4 border">✅ Talla correcta, no compromete vía aérea</td>
                                                </tr>
                                                <tr className="hover:bg-orange-50">
                                                    <td className="py-3 px-4 border font-medium text-orange-700">Inmovilizador de cabeza</td>
                                                    <td className="py-3 px-4 border">Limitar movimiento lateral en tabla espinal</td>
                                                    <td className="py-3 px-4 border">⚠️ Asegurar con cintas, acceso a vía aérea</td>
                                                </tr>
                                                <tr className="hover:bg-red-50">
                                                    <td className="py-3 px-4 border font-medium text-red-700">Tabla espinal</td>
                                                    <td className="py-3 px-4 border">Uso selectivo basado en criterios clínicos</td>
                                                    <td className="py-3 px-4 border">🕐 Tiempo mínimo, riesgo úlceras por presión</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div>
                                    <h2 className="text-2xl font-semibold mb-4 text-gray-800 border-b pb-2">Toma de Decisiones Críticas</h2>
                                    <div className="grid md:grid-cols-2 gap-6">
                                        <div className="space-y-4">
                                            <div className="p-5 bg-green-50 border border-green-200 rounded-lg">
                                                ...
                                                <p className="text-gray-700 mb-3 font-medium">Inmovilizar SI existe alguno:</p>
                                                <ol className="list-decimal list-inside space-y-2 text-gray-700">
                                                    <li>🚗 <strong>Mecanismo de alto riesgo</strong> (MVA, caída &gt;3m, zambullida)</li>
                                                    <li>🎯 <strong>Dolor línea media</strong> cervical o dorsal</li>
                                                    <li>🧠 <strong>Déficit neurológico</strong> motor o sensitivo</li>
                                                    <li>😵 <strong>Alteración conciencia</strong> (GCS &lt;15, intoxicación)</li>
                                                    <li>🤕 <strong>Lesión distractora</strong> dolorosa</li>
                                                    <li>🗣️ <strong>Incapacidad comunicarse</strong> (idioma, edad)</li>
                                                </ol>
                                            </div>
                                        </div>
                                            ...
                                            <div className="p-5 bg-orange-50 border border-orange-200 rounded-lg">
                                                ...
                                                <div className="space-y-3">
                                                    <div className="flex items-start">
                                                        <span className="bg-orange-200 text-orange-800 text-xs font-bold px-2 py-1 rounded mr-2 mt-0.5">1</span>
                                                        <span className="text-gray-700">Estabilización manual inmediata (rescatador principal)</span>
                                                    </div>
                                                    <div className="flex items-start">
                                                        <span className="bg-orange-200 text-orange-800 text-xs font-bold px-2 py-1 rounded mr-2 mt-0.5">2</span>
                                                        <span className="text-gray-700">Evaluación inicial ABC manteniendo control</span>
                                                    </div>
                                                    <div className="flex items-start">
                                                        <span className="bg-orange-200 text-orange-800 text-xs font-bold px-2 py-1 rounded mr-2 mt-0.5">3</span>
                                                        <span className="text-gray-700">Aplicación de collarín (segundo rescatador)</span>
                                                    </div>
                                                    <div className="flex items-start">
                                                        <span className="bg-orange-200 text-orange-800 text-xs font-bold px-2 py-1 rounded mr-2 mt-0.5">4</span>
                                                        <span className="text-gray-700">Rotación en bloque coordinada (mín. 3-4 personas)</span>
                                                    </div>
                                                    <div className="flex items-start">
                                                        <span className="bg-orange-200 text-orange-800 text-xs font-bold px-2 py-1 rounded mr-2 mt-0.5">5</span>
                                ...
                                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
                                    ...
                                    <div className="grid md:grid-cols-2 gap-6">
                                        ...
                                        <div className="bg-green-100 p-4 rounded-lg border border-green-300">
                                            <h4 className="font-semibold text-green-800 mb-2">✅ MANTENER casco si:</h4>
                                            <ul className="space-y-1 text-gray-700 text-sm">
                                    ...
                                    <div className="mt-4 p-3 bg-white rounded border-l-4 border-yellow-500">
                                        <p className="text-sm text-gray-700"><strong>⚠️ Técnica de retirada:</strong> Siempre con 2 rescatadores: uno mantiene estabilización cervical mientras el otro retira el casco lentamente. Aplicar collarín inmediatamente.</p>
                                    </div>
                                </div>
                            </div>
                        )}
