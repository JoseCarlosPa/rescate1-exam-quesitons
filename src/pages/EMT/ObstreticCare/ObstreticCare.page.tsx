                    ...
                    <div className="max-w-5xl mx-auto bg-white rounded-lg shadow-sm p-6 mb-8">
                        {activeTab === 'overview' && (
                            <div className="space-y-8">
                                {/* Importancia crítica */}
                                <div className="bg-gradient-to-r from-pink-50 to-orange-50 border-l-4 border-pink-500 p-6 rounded-lg">
                                    <div className="flex items-center mb-4">
                                        <FaExclamationTriangle className="w-8 h-8 text-pink-500 mr-3"/>
                                        <h2 className="text-2xl font-bold text-pink-700">¡Emergencia Obstétrica!</h2>
                                    </div>
                                    <p className="text-gray-800 leading-relaxed text-lg">
                                        Las emergencias obstétricas requieren <strong>acción rápida y coordinada</strong>.
                                ...
                                <div>
                                    ...
                                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                                        ...
                                        <div className="bg-gradient-to-b from-green-50 to-green-100 p-4 rounded-lg border">
                                            <h3 className="text-lg font-bold text-green-700 mb-2">P - Provocación</h3>
                                            <ul className="text-sm space-y-1 text-gray-700">
                                        ...
                                        <div className="bg-gradient-to-b from-yellow-50 to-yellow-100 p-4 rounded-lg border">
                                            <h3 className="text-lg font-bold text-yellow-700 mb-2">S - Severidad</h3>
                                            <ul className="text-sm space-y-1 text-gray-700">
                                ...
                                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
                                    <div className="flex items-center mb-4">
                                        ...
                                        <h3 className="text-xl font-bold text-yellow-800">🚨 Signos de Parto Inminente</h3>
                                    </div>
                                    <div className="grid md:grid-cols-2 gap-6">
                                        <div>
                                            <h4 className="font-semibold text-yellow-800 mb-2">Signos Objetivos:</h4>
                                            <ul className="space-y-2">
                                                ...
                                                <li className="flex items-start">
                                                    <FiEye className="w-4 h-4 mt-1 mr-2 text-yellow-600"/>
                                                    <span className="text-gray-700"><strong>Ruptura de membranas:</strong> Líquido amniótico</span>
                                                </li>
                                            </ul>
                                        </div>
                                        <div>
                                            <h4 className="font-semibold text-yellow-800 mb-2">Signos Subjetivos:</h4>
                                            <ul className="space-y-2">
                                                <li className="flex items-start">
                                                    <FiEye className="w-4 h-4 mt-1 mr-2 text-yellow-600"/>
                                                    <span className="text-gray-700"><strong>Urgencia de pujar:</strong> Sensación irresistible</span>
                                                </li>
                                                <li className="flex items-start">
                                                    <FiEye className="w-4 h-4 mt-1 mr-2 text-yellow-600"/>
                                                    <span className="text-gray-700"><strong>Sensación rectal:</strong> "Ganas de evacuar"</span>
                                                </li>
                                                <li className="flex items-start">
                                                    <FiEye className="w-4 h-4 mt-1 mr-2 text-yellow-600"/>
                            ...
                            <div className="space-y-8">
                                ...
                                <div className="bg-gradient-to-r from-blue-50 to-cyan-50 border-l-4 border-blue-500 p-6 rounded-lg">
                                    <div className="flex items-center mb-4">
                                        ...
                                        <h2 className="text-2xl font-bold text-blue-700">Evaluación Sistemática de la Paciente Obstétrica</h2>
                                    </div>
                                    <div className="grid md:grid-cols-2 gap-6">
                                        <div className="bg-white p-4 rounded-lg shadow-sm">
                                            <h3 className="font-medium text-lg mb-3 text-blue-700">Evaluación Primaria</h3>
                                        ...
                                        <div className="bg-white p-4 rounded-lg shadow-sm">
                                            <h3 className="font-medium text-lg mb-3 text-green-700">Evaluación Obstétrica</h3>
                                            <ul className="space-y-2 text-gray-700">
                                                <li className="flex items-start">
                                ...
                                <div>
                                    <h2 className="text-2xl font-semibold mb-4 text-gray-800 border-b pb-2">Complicaciones Obstétricas Críticas</h2>
                                    <div className="grid md:grid-cols-2 gap-6">
                                        <div className="bg-red-50 p-6 rounded-lg border-2 border-red-200">
                                            ...
                                            <div className="space-y-3">
                                                <div className="bg-white p-3 rounded">
                                                    <h4 className="font-medium text-red-600 mb-1">Signos Clínicos:</h4>
                                        ...
                                        <div className="bg-purple-50 p-6 rounded-lg border-2 border-purple-200">
                                            ...
                                            <div className="space-y-3">
                                                <div className="bg-white p-3 rounded">
                                                    <h4 className="font-medium text-purple-600 mb-1">Signos Clínicos:</h4>
                                                    <ul className="text-sm text-gray-700 space-y-1">
                                        ...
                                        <div className="bg-yellow-50 p-6 rounded-lg border-2 border-yellow-200">
                                            ...
                                            <div className="space-y-3">
                                                <div className="bg-white p-3 rounded">
                                                    <h4 className="font-medium text-yellow-600 mb-1">Signos Clínicos:</h4>
                                                    <ul className="text-sm text-gray-700 space-y-1">
                                        ...
                                        <div className="bg-orange-50 p-6 rounded-lg border-2 border-orange-200">
                                            ...
                                            <div className="space-y-3">
                                                <div className="bg-white p-3 rounded">
                                                    <h4 className="font-medium text-orange-600 mb-1">Signos Clínicos:</h4>
                                                    <ul className="text-sm text-gray-700 space-y-1">
                                ...
                                <div>
                                    <h2 className="text-2xl font-semibold mb-4 text-gray-800 border-b pb-2">Tabla de Signos de Alarma</h2>
                                    <div className="overflow-x-auto bg-white rounded-lg shadow">
                                        <table className="min-w-full">
                                            <thead className="bg-gray-50">
                                                <tr>
                                                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Sistema</th>
                                                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Signo Normal</th>
                                                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Signo de Alarma</th>
                                                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Acción Inmediata</th>
                                                </tr>
                                            </thead>
                                            <tbody className="divide-y divide-gray-200">
                                                <tr>
                                                    <td className="px-6 py-4 whitespace-nowrap font-medium text-gray-900">Cardiovascular</td>
                                                    <td className="px-6 py-4 text-sm text-gray-700">FC: 60-100, PA: &lt;140/90</td>
                                                    <td className="px-6 py-4 text-sm text-red-600">Taquicardia, hipotensión, PA ≥140/90</td>
                                                    <td className="px-6 py-4 text-sm text-blue-600">IV, monitorización, posición lateral</td>
                                                </tr>
                                                <tr>
                                                    <td className="px-6 py-4 whitespace-nowrap font-medium text-gray-900">Respiratorio</td>
                                                    <td className="px-6 py-4 text-sm text-gray-700">FR: 12-20, SatO₂ ≥95%</td>
                                                    <td className="px-6 py-4 text-sm text-red-600">Disnea, taquipnea, SatO₂ &lt;95%</td>
                                                    <td className="px-6 py-4 text-sm text-blue-600">Oxígeno, posición semi-Fowler</td>
                                                </tr>
                                                <tr>
                                                    <td className="px-6 py-4 whitespace-nowrap font-medium text-gray-900">Neurológico</td>
                                                    <td className="px-6 py-4 text-sm text-gray-700">Alerta, orientada</td>
                                                    <td className="px-6 py-4 text-sm text-red-600">Confusión, convulsiones, cefalea</td>
                                                    <td className="px-6 py-4 text-sm text-blue-600">Ambiente tranquilo, anticonvulsivos</td>
                                                </tr>
                                                <tr>
                                                    <td className="px-6 py-4 whitespace-nowrap font-medium text-gray-900">Obstétrico</td>
                                                    <td className="px-6 py-4 text-sm text-gray-700">Sin sangrado, contracciones regulares</td>
                                                    <td className="px-6 py-4 text-sm text-red-600">Sangrado abundante, dolor severo</td>
                                                    <td className="px-6 py-4 text-sm text-blue-600">Control sangrado, transporte urgente</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div className="grid md:grid-cols-2 gap-6">
                                    <div className="bg-gray-50 p-6 rounded-lg">
                                        <h3 className="font-bold text-lg mb-3 text-gray-800">Factores de Riesgo Materno</h3>
                                        <div className="space-y-3">
                                            <div>
                                    ...
                                    <div className="bg-gray-50 p-6 rounded-lg">
                                        <h3 className="font-bold text-lg mb-3 text-gray-800">Factores de Riesgo Fetal</h3>
                                        <div className="space-y-3">
                                            <div>
                            ...
                            <div className="space-y-8">
                                ...
                                <div className="bg-gradient-to-r from-green-50 to-blue-50 border-l-4 border-green-500 p-6 rounded-lg">
                                    <div className="flex items-center mb-4">
                                        ...
                                        <h2 className="text-2xl font-bold text-green-700">Preparación para Parto de Emergencia</h2>
                                    </div>
                                    <div className="grid md:grid-cols-2 gap-6">
                                        <div className="bg-white p-4 rounded-lg shadow-sm">
                                            <h3 className="font-bold text-lg mb-3 text-green-700">Kit Obstétrico Esencial</h3>
                                            <div className="space-y-2">
                                                ...
                                                <div className="flex items-start">
                                                    <FiCheckCircle className="w-4 h-4 mt-1 mr-2 text-green-600"/>
                                                    <span className="text-sm">Guantes estériles (varios pares)</span>
                                                </div>
                                                <div className="flex items-start">
                                                    <FiCheckCircle className="w-4 h-4 mt-1 mr-2 text-green-600"/>
                                        ...
                                        <div className="bg-white p-4 rounded-lg shadow-sm">
                                            <h3 className="font-bold text-lg mb-3 text-blue-700">Preparación del Ambiente</h3>
                                            <div className="space-y-2">
                                                <div className="flex items-start">
                                                    <FiCheckCircle className="w-4 h-4 mt-1 mr-2 text-blue-600"/>
                                ...
                                <div>
                                    <h2 className="text-2xl font-semibold mb-4 text-gray-800 border-b pb-2">Procedimiento de Parto Normal - Paso a Paso</h2>
                                    <div className="space-y-6">
                                        <div className="bg-blue-50 p-6 rounded-lg border-l-4 border-blue-500">
                                            ...
                                            <div className="grid md:grid-cols-2 gap-4">
                                                <div>
                                                    <h4 className="font-medium text-blue-600 mb-2">Evaluación rápida:</h4>
                                                    <ul className="text-sm text-gray-700 space-y-1">
                                        ...
                                        <div className="bg-green-50 p-6 rounded-lg border-l-4 border-green-500">
                                            ...
                                            <div className="mt-4 p-3 bg-white rounded border border-green-200">
                                                <p className="text-sm text-green-800">
                                                    <strong>Recuerda:</strong> La cabeza rotará naturalmente (restitución). No fuerces este movimiento.
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="bg-orange-50 p-6 rounded-lg border-l-4 border-orange-500">
                                            ...
                                            <div className="mt-4 p-3 bg-white rounded border border-orange-200">
                                                <p className="text-sm text-orange-800">
                                                    <strong>Importante:</strong> Una vez que salen los hombros, el bebé puede salir rápidamente. ¡Estate preparado!
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div>
                                    <h2 className="text-2xl font-semibold mb-4 text-gray-800 border-b pb-2">Cuidados Inmediatos del Recién Nacido</h2>
                                    <div className="grid md:grid-cols-2 gap-6">
                                        <div className="bg-yellow-50 p-6 rounded-lg border-2 border-yellow-200">
                                            <h3 className="font-bold text-lg mb-3 text-yellow-700">Pasos Iniciales (30 segundos)</h3>
                                            <ol className="space-y-2 text-sm text-gray-700">
                                                <li className="flex items-start">
                                                    <span className="bg-yellow-500 text-white rounded-full w-6 h-6 flex items-center justify-center mr-2 text-xs">1</span>
                                                    <span><strong>Secar vigorosamente:</strong> Usa toalla seca, frota espalda y extremidades</span>
                                                </li>
                                                <li className="flex items-start">
                                                    <span className="bg-yellow-500 text-white rounded-full w-6 h-6 flex items-center justify-center mr-2 text-xs">2</span>
                                                    <span><strong>Mantener caliente:</strong> Piel con piel, cubrir con manta seca</span>
                                                </li>
                                                <li className="flex items-start">
                                                    <span className="bg-yellow-500 text-white rounded-full w-6 h-6 flex items-center justify-center mr-2 text-xs">3</span>
                                                    <span><strong>Posicionar:</strong> Cabeza en posición neutral, cuello ligeramente extendido</span>
                                                </li>
                                                <li className="flex items-start">
                                                    <span className="bg-yellow-500 text-white rounded-full w-6 h-6 flex items-center justify-center mr-2 text-xs">4</span>
                                                    <span><strong>Succionar:</strong> Solo si hay secreciones visibles (boca primero, luego nariz)</span>
                                                </li>
                                                <li className="flex items-start">
                                                    <span className="bg-yellow-500 text-white rounded-full w-6 h-6 flex items-center justify-center mr-2 text-xs">5</span>
                                        ...
                                        <div className="bg-purple-50 p-6 rounded-lg border-2 border-purple-200">
                                            <h3 className="font-bold text-lg mb-3 text-purple-700">Evaluación APGAR</h3>
                                            <div className="space-y-3">
                                                <div className="bg-white p-3 rounded">
                                                    <h4 className="font-medium text-purple-600 mb-1">Parámetros (0-1-2 puntos):</h4>
                                                    <ul className="text-sm text-gray-700 space-y-1">
                                                        <li>• <strong>A</strong>pariencia: Azul/rosado extremidades/completamente rosado</li>
                                                        <li>• <strong>P</strong>ulso: Ausente/&lt;100/&gt;100 lpm</li>
                                                        <li>• <strong>G</strong>esticulación: Sin respuesta/mueca/llanto</li>
                                                        <li>• <strong>A</strong>ctividad: Flácido/algo flexión/activo</li>
                                                        <li>• <strong>R</strong>espiración: Ausente/irregular/llanto fuerte</li>
                                                    </ul>
                                                </div>
                                                <div className="bg-white p-3 rounded">
                                ...
                                <div className="bg-red-50 p-6 rounded-lg border-2 border-red-200">
                                    ...
                                    <div className="space-y-4">
                                        <div className="bg-white p-4 rounded-lg">
                                            <h4 className="font-medium text-red-600 mb-2">Evaluación inicial (30 segundos):</h4>
                                        ...
                                        <div className="bg-white p-4 rounded-lg">
                                            <h4 className="font-medium text-red-600 mb-2">Acciones por condición:</h4>
                                            <div className="grid md:grid-cols-3 gap-4">
                                                <div className="bg-green-50 p-3 rounded">
                                                    <h5 className="font-medium text-green-700 mb-1">Bebé Normal:</h5>
                                                    <ul className="text-sm text-gray-700 space-y-1">
                                                ...
                                                <div className="bg-yellow-50 p-3 rounded">
                                                    <h5 className="font-medium text-yellow-700 mb-1">Depresión Moderada:</h5>
                                                    <ul className="text-sm text-gray-700 space-y-1">
                                                        <li>• Estimular más</li>
                                                ...
                                                <div className="bg-red-50 p-3 rounded">
                                                    <h5 className="font-medium text-red-700 mb-1">Depresión Severa:</h5>
                                                    <ul className="text-sm text-gray-700 space-y-1">
                                                        <li>• VPP inmediata</li>
                                ...
                                <div className="grid md:grid-cols-2 gap-6">
                                    <div className="bg-gray-50 p-6 rounded-lg">
                                        <h3 className="font-bold text-lg mb-3 text-gray-800">Manejo del Cordón Umbilical</h3>
                                        <div className="space-y-3">
                                            <div className="bg-white p-3 rounded">
                                    ...
                                    <div className="bg-gray-50 p-6 rounded-lg">
                                        ...
                                        <div className="space-y-3">
                                            <div className="bg-white p-3 rounded">
                                                <h4 className="font-medium text-gray-700 mb-1">Signos de separación:</h4>
                                                <ul className="text-sm text-gray-600 space-y-1">
                                                    <li>• Sangrado vaginal</li>
                                ...
                                <div className="bg-orange-50 p-6 rounded-lg border-2 border-orange-200">
                                    <h3 className="font-bold text-xl mb-4 text-orange-700">🚨 Complicaciones Durante el Parto</h3>
                                    <div className="grid md:grid-cols-2 gap-4">
                                        <div className="bg-white p-4 rounded">
                                            <h4 className="font-medium text-orange-600 mb-2">Presentación pélvica:</h4>
                                            <ul className="text-sm text-gray-700 space-y-1">
                                        ...
                                        <div className="bg-white p-4 rounded">
                                            <h4 className="font-medium text-orange-600 mb-2">Hemorragia postparto:</h4>
                                            <ul className="text-sm text-gray-700 space-y-1">
                                        ...
                                        <div className="bg-white p-4 rounded">
                                            <h4 className="font-medium text-orange-600 mb-2">Prolapso de cordón:</h4>
                                            <ul className="text-sm text-gray-700 space-y-1">
                                                <li>• Posición genupectoral</li>
                                                <li>• Elevar presentación fetal</li>
                                        ...
                                        <div className="bg-white p-4 rounded">
                                            <h4 className="font-medium text-orange-600 mb-2">Bebé sin respiración:</h4>
                                            <ul className="text-sm text-gray-700 space-y-1">
                        ...
                        {activeTab === 'practice' && (
                            <div className="space-y-8">
                                <div className="bg-gradient-to-r from-indigo-50 to-purple-50 border-l-4 border-indigo-500 p-6 rounded-lg">
                                    <h2 className="text-2xl font-bold text-indigo-700 mb-2">Casos Clínicos para Análisis</h2>
                                    <p className="text-gray-700">
                                        Practica tu toma de decisiones con estos casos clínicos reales. Cada caso incluye evaluación paso a paso y justificación de las acciones.
                                    </p>
                                </div>
                                ...
                                <div className="space-y-6">
                                    <div className="bg-white p-6 rounded-lg shadow-lg border border-gray-200">
                                        <div className="flex items-center mb-4">
                                            <span className="bg-orange-500 text-white rounded-full w-8 h-8 flex items-center justify-center mr-3 font-bold">1</span>
                                            <h3 className="text-xl font-bold text-orange-600">Caso: Parto Precipitado</h3>
                                        </div>
                                        
                                        <div className="bg-gray-50 p-4 rounded-lg mb-4">
                                            <h4 className="font-bold text-gray-800 mb-2">Escenario:</h4>
                                            <p className="text-gray-700 italic">
                                                Mujer de 28 años, G3P2, embarazo de 38 semanas. Llama al 911 refiriendo contracciones intensas cada 2 minutos desde hace 1 hora. 
                                                Al llegar, observas coronamiento de la cabeza del bebé. La paciente refiere: "¡Ya viene, ya viene!" 
                                        ...
                                        <div className="grid md:grid-cols-2 gap-6">
                                            <div className="bg-blue-50 p-4 rounded-lg">
                                                ...
                                                <ul className="space-y-1 text-sm text-gray-700">
                                                    <li>• <strong>A:</strong> Vía aérea permeable, grita con contracciones</li>
                                                    <li>• <strong>B:</strong> FR 22/min, respiración adecuada</li>
                                                    <li>• <strong>C:</strong> FC 95/min, TA 125/80 mmHg, piel rosada</li>
                                                    <li>• <strong>D:</strong> Alerta, ansiosa pero cooperativa</li>
                                                    <li>• <strong>E:</strong> Contracciones c/2 min, coronamiento visible</li>
                                                    <li>• <strong>Historia:</strong> G3P2, partos rápidos previos</li>
                                                </ul>
                                            </div>
                                            ...
                                            <div className="bg-green-50 p-4 rounded-lg">
                                                ...
                                                <ol className="space-y-1 text-sm text-gray-700">
                                                    <li>1. <strong>Preparar kit obstétrico</strong> inmediatamente</li>
                                                    <li>2. <strong>Posicionar</strong> a la paciente semi-sentada</li>
                                                    <li>3. <strong>EPP completo</strong> y preparar área estéril</li>
                                                    <li>4. <strong>NO tirar</strong> de la cabeza, solo apoyar</li>
                                                    <li>5. <strong>Verificar cordón</strong> alrededor del cuello</li>
                                                    <li>6. <strong>Asistir nacimiento</strong> de hombros y cuerpo</li>
                                                    <li>7. <strong>Secar y estimular</strong> al bebé inmediatamente</li>
                                                    <li>8. <strong>Clampear cordón</strong> después de 1-3 minutos</li>
                                                </ol>
                                            </div>
                                        </div>
                                        ...
                                        <div className="mt-4 p-4 bg-yellow-50 rounded-lg border border-yellow-200">
                                            ...
                                            <ul className="text-sm text-gray-700 space-y-1">
                                                <li>• <strong>Multiparidad:</strong> Los partos subsecuentes tienden a ser más rápidos</li>
                                                <li>• <strong>Coronamiento:</strong> Signo inequívoco de parto inminente</li>
                                                <li>• <strong>Preparación rápida:</strong> Tener kit obstétrico siempre listo</li>
                                                <li>• <strong>Tranquilidad:</strong> Mantener calma transmite confianza a la paciente</li>
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    <div className="bg-white p-6 rounded-lg shadow-lg border border-gray-200">
                                        <div className="flex items-center mb-4">
                                            <span className="bg-red-500 text-white rounded-full w-8 h-8 flex items-center justify-center mr-3 font-bold">2</span>
                                            <h3 className="text-xl font-bold text-red-600">Caso: Hemorragia Postparto</h3>
                                        </div>
                                        
                                        <div className="bg-gray-50 p-4 rounded-lg mb-4">
                                            <h4 className="font-bold text-gray-800 mb-2">Escenario:</h4>
                                            <p className="text-gray-700 italic">
                                                Mujer de 32 años que tuvo un parto vaginal exitoso hace 20 minutos. La placenta fue expulsada aparentemente completa, 
                                                pero ahora presenta sangrado vaginal abundante, empapando múltiples toallas sanitarias. 
                                                La paciente se queja de mareo y náuseas. El útero se palpa blando y no se contrae adecuadamente.
                                            </p>
                                        </div>
                                        ...
                                        <div className="grid md:grid-cols-2 gap-6">
                                            <div className="bg-blue-50 p-4 rounded-lg">
                                                ...
                                                <ul className="space-y-1 text-sm text-gray-700">
                                                    ...
                                                    <li>• <strong>C:</strong> FC 115/min, TA 100/60 mmHg, palidez</li>
                                                    <li>• <strong>D:</strong> Alerta pero débil, ligera confusión</li>
                                                    <li>• <strong>E:</strong> Sangrado vaginal abundante, útero blando</li>
                                                    <li>• <strong>Estimación:</strong> Pérdida sanguínea &gt; 500 ml</li>
                                                </ul>
                                            </div>
                                            ...
                                            <div className="bg-red-50 p-4 rounded-lg">
                                                ...
                                                <ol className="space-y-1 text-sm text-gray-700">
                                                    <li>1. <strong>Masaje uterino vigoroso</strong> para promover contracción</li>
                                                    <li>2. <strong>Acceso IV doble</strong> con catéter grande (14G-16G)</li>
                                                    <li>3. <strong>Solución salina isotónica</strong> para reposición</li>
                                                    <li>4. <strong>Oxígeno suplementario</strong> alto flujo</li>
                                                    <li>5. <strong>Posición Trendelenburg</strong> si hipotensión</li>
                                                    <li>6. <strong>Compresas perineales</strong> para tamponar</li>
                                                    <li>7. <strong>Transporte inmediato</strong> con notificación</li>
                                                    <li>8. <strong>Monitorización</strong> continua de signos vitales</li>
                                                </ol>
                                            </div>
                                        </div>
                                        ...
                                        <div className="mt-4 p-4 bg-red-50 rounded-lg border border-red-200">
                                            ...
                                            <ul className="text-sm text-gray-700 space-y-1">
                                                <li>• <strong>Reconocimiento temprano:</strong> HPP es causa principal de muerte materna</li>
                                                <li>• <strong>Atonía uterina:</strong> Causa más común de hemorragia postparto</li>
                                                <li>• <strong>Masaje uterino:</strong> Primera línea de tratamiento</li>
                                                <li>• <strong>Reposición de volumen:</strong> Prevenir shock hemorrágico</li>
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    <div className="bg-white p-6 rounded-lg shadow-lg border border-gray-200">
                                        <div className="flex items-center mb-4">
                                            <span className="bg-purple-500 text-white rounded-full w-8 h-8 flex items-center justify-center mr-3 font-bold">3</span>
                                            <h3 className="text-xl font-bold text-purple-600">Caso: Reanimación Neonatal</h3>
                                        </div>
                                        
                                        <div className="bg-gray-50 p-4 rounded-lg mb-4">
                                            <h4 className="font-bold text-gray-800 mb-2">Escenario:</h4>
                                            <p className="text-gray-700 italic">
                                                Recién nacido de término nacido tras parto vaginal sin complicaciones. El bebé nace flácido, 
                                                sin esfuerzo respiratorio, y con cianosis central. Tras secar y estimular vigorosamente por 30 segundos, 
                                                no hay mejoría. FC: 80 latidos por minuto medida por auscultación. La madre pregunta angustiada: "¿Está bien mi bebé?"
                                            </p>
                                        </div>
                                        ...
                                        <div className="grid md:grid-cols-2 gap-6">
                                            <div className="bg-red-50 p-4 rounded-lg">
                                                ...
                                                <div className="space-y-2 text-sm text-gray-700">
                                                    ...
                                                    <div className="flex justify-between">
                                                        <span>Pulso:</span>
                                                        <span className="font-bold text-yellow-600">80 lpm (1 pt)</span>
                                                    </div>
                                                    <div className="flex justify-between">
                                                    ...
                                                    <div className="flex justify-between">
                                                        <span>Actividad:</span>
                                                        <span className="font-bold text-red-600">Flácido (0 pts)</span>
                                                    </div>
                                                    <div className="flex justify-between">
                                                        <span>Respiración:</span>
                                                        <span className="font-bold text-red-600">Ausente (0 pts)</span>
                                                    </div>
                                                    <div className="border-t pt-2 mt-2">
                                                        <div className="flex justify-between font-bold">
                                                            <span>Total APGAR:</span>
                                                            <span className="text-red-600">1/10 (Depresión severa)</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="bg-blue-50 p-4 rounded-lg">
                                                ...
                                                <ol className="space-y-1 text-sm text-gray-700">
                                                    <li>1. <strong>Continuar secado</strong> y estimulación táctil</li>
                                                    <li>2. <strong>Posicionar cabeza</strong> en extensión leve</li>
                                                    <li>3. <strong>Succionar</strong> boca y nariz si secreciones</li>
                                                    <li>4. <strong>Iniciar VPP</strong> a 40-60 ventilaciones/min</li>
                                                    <li>5. <strong>Bolsa y mascarilla</strong> con aire ambiente</li>
                                                    <li>6. <strong>Reevaluar FC</strong> cada 30 segundos</li>
                                                    <li>7. <strong>Si FC &lt; 60:</strong> iniciar compresiones</li>
                                                    <li>8. <strong>Relación 3:1</strong> (3 compresiones : 1 ventilación)</li>
                                                    <li>9. <strong>Transporte inmediato</strong> con soporte continuo</li>
                                                </ol>
                                            </div>
                                        </div>

                                        <div className="mt-4 p-4 bg-blue-50 rounded-lg border border-blue-200">
                                            <h4 className="font-bold text-blue-700 mb-2">Comunicación con la Familia:</h4>
                                            <p className="text-sm text-gray-700">
                                                "Su bebé necesita ayuda para respirar. Estamos proporcionando oxígeno y estimulando la respiración. 
                                                Es importante que sepan que estamos haciendo todo lo necesario y vamos a trasladar al bebé al hospital 
                                    ...
                                    <div className="bg-white p-6 rounded-lg shadow-lg border border-gray-200">
                                        <div className="flex items-center mb-4">
                                            <span className="bg-yellow-500 text-white rounded-full w-8 h-8 flex items-center justify-center mr-3 font-bold">4</span>
                                        ...
                                        <div className="bg-gray-50 p-4 rounded-lg mb-4">
                                            <h4 className="font-bold text-gray-800 mb-2">Escenario:</h4>
                                            <p className="text-gray-700 italic">
                                                Mujer de 24 años, G1P0, 36 semanas de gestación, presenta convulsiones tónico-clónicas generalizadas 
                                                que duran 2 minutos. Su esposo refiere que en los últimos días ha tenido dolor de cabeza severo, 
                                                visión borrosa y edema en cara y manos. No tiene antecedentes de epilepsia. La convulsión acaba de cesar.
                                            </p>
                                        </div>
                                        ...
                                        <div className="grid md:grid-cols-2 gap-6">
                                            <div className="bg-yellow-50 p-4 rounded-lg">
                                                ...
                                                <ul className="space-y-1 text-sm text-gray-700">
                                                    ...
                                                    <li>• <strong>Historia:</strong> Cefalea, alteraciones visuales</li>
                                                </ul>
                                            </div>
                                            ...
                                            <div className="bg-red-50 p-4 rounded-lg">
                                                ...
                                                <ol className="space-y-1 text-sm text-gray-700">
                                                    <li>1. <strong>Proteger vía aérea</strong> - posición de seguridad</li>
                                                    <li>2. <strong>Oxígeno alto flujo</strong> - 15 L/min por mascarilla</li>
                                                    <li>3. <strong>Acceso IV</strong> - catéter gran calibre</li>
                                                    <li>4. <strong>Ambiente tranquilo</strong> - reducir estímulos</li>
                                                    <li>5. <strong>Posición lateral izquierda</strong> - mejorar perfusión</li>
                                                    <li>6. <strong>Monitorización continua</strong> - PA y SatO₂</li>
                                                    <li>7. <strong>Preparar anticonvulsivos</strong> (si protocolo)</li>
                                                    <li>8. <strong>Transporte CODE 3</strong> - notificar hospital</li>
                                                </ol>
                                            </div>
                                        </div>

                                        <div className="mt-4 p-4 bg-yellow-50 rounded-lg border border-yellow-200">
                                            <h4 className="font-bold text-yellow-700 mb-2">Consideraciones Especiales:</h4>
                                            <ul className="text-sm text-gray-700 space-y-1">
                                                <li>• <strong>Eclampsia:</strong> Emergencia obstétrica que amenaza la vida</li>
                                                <li>• <strong>Riesgo de convulsiones recurrentes:</strong> Mantener ambiente tranquilo</li>
                                                <li>• <strong>Hipertensión severa:</strong> Riesgo de ACV, monitorizar continuamente</li>
                                                <li>• <strong>Bienestar fetal:</strong> Optimizar oxigenación materna</li>
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    <div className="bg-white p-6 rounded-lg shadow-lg border border-gray-200">
                                        <div className="flex items-center mb-4">
                                            <span className="bg-indigo-500 text-white rounded-full w-8 h-8 flex items-center justify-center mr-3 font-bold">5</span>
                                            <h3 className="text-xl font-bold text-indigo-600">Caso: Prolapso de Cordón</h3>
                                        </div>
                                        
                                        <div className="bg-gray-50 p-4 rounded-lg mb-4">
                                            <h4 className="font-bold text-gray-800 mb-2">Escenario:</h4>
                                            <p className="text-gray-700 italic">
                                                Mujer de 29 años, G2P1, 38 semanas, en trabajo de parto activo. Acaba de "romperse la fuente" 
                                                con salida abundante de líquido amniótico claro. Inmediatamente después, la paciente grita de dolor 
                                                y refiere sensación de "algo que se sale". Al examinar, observas cordón umbilical pulsátil 
                                        ...
                                        <div className="grid md:grid-cols-2 gap-6">
                                            <div className="bg-red-50 p-4 rounded-lg">
                                                ...
                                                <ul className="space-y-1 text-sm text-gray-700">
                                                    <li>• <strong>A:</strong> Vía aérea permeable, hiperventilando</li>
                                                    <li>• <strong>B:</strong> FR 32/min, respiración superficial</li>
                                                    ...
                                                    <li>• <strong>Urgencia:</strong> Comprometimiento fetal inminente</li>
                                                </ul>
                                            </div>
                                            ...
                                            <div className="bg-orange-50 p-4 rounded-lg">
                                                ...
                                                <ol className="space-y-1 text-sm text-gray-700">
                                                    <li>1. <strong>Posición genupectoral</strong> - cabeza abajo, rodillas al pecho</li>
                                                    <li>2. <strong>Elevar presentación fetal</strong> - mano enguantada estéril</li>
                                                    <li>3. <strong>NO manipular cordón</strong> - mantener húmedo y tibio</li>
                                                    <li>4. <strong>Oxígeno alto flujo</strong> - 15 L/min a la madre</li>
                                                    <li>5. <strong>Transporte CODE 3</strong> - notificar cesárea emergente</li>
                                                    <li>6. <strong>Mantener posición</strong> durante todo el transporte</li>
                                                    <li>7. <strong>Apoyo emocional</strong> - explicar procedimiento</li>
                                                    <li>8. <strong>Monitorización continua</strong> - signos vitales maternos</li>
                                                </ol>
                                            </div>
                                        </div>

                                        <div className="mt-4 p-4 bg-red-50 rounded-lg border border-red-200">
                                            <h4 className="font-bold text-red-700 mb-2">Puntos Críticos de Supervivencia:</h4>
                                            <ul className="text-sm text-gray-700 space-y-1">
                                                <li>• <strong>Tiempo es vida:</strong> Cada minuto cuenta para supervivencia fetal</li>
                                                <li>• <strong>Mantener elevación:</strong> Reducir compresión del cordón</li>
                                                <li>• <strong>Posición clave:</strong> Genupectoral o Trendelenburg extremo</li>
                                                <li>• <strong>Comunicación:</strong> Notificar hospital para preparar cesárea STAT</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="bg-gradient-to-r from-green-50 to-blue-50 p-6 rounded-lg border-2 border-green-200">
                                    ...
                                    <div className="bg-white p-4 rounded-lg">
                                        ...
                                        <p className="text-gray-700 italic mb-3">
                                            "¿Cuáles son los tres factores más importantes para decidir si intentar transportar a una paciente 
                                            obstétrica al hospital o asistir el parto en el lugar?"
                                        </p>
                                        <div className="bg-gray-50 p-3 rounded">
                                            <p className="text-sm text-gray-600">
                                                <strong>Reflexiona sobre:</strong> Tiempo estimado de parto, condición materna, 
                                                distancia al hospital, recursos disponibles, complicaciones presentes.
                                            </p>
                                        </div>
                                    </div>
                                </div>
