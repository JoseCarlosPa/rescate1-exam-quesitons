...
import {MdCheckCircle, MdOutlineLocalHospital, MdQuiz, MdWarning} from "react-icons/md";
...
import {FaAllergies, FaBacteria, FaExclamationTriangle, FaFirstAid, FaHeartbeat, FaLungsVirus} from "react-icons/fa";
import {FiAlertTriangle, FiClock, FiEye, FiUser} from "react-icons/fi";
                ...
                <div
                    ...
                    <div className="w-full max-w-7xl">
                        ...
                        <header className="mb-8 text-center">
                            ...
                            <p className="text-sm italic mb-4">Basado en AAOS 11ª Edición - Atención Médica
                                Prehospitalaria</p>
                            <div className="flex justify-center">
                                <NavLink
                                    to={AllRoutes.EMT}
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-8 max-w-4xl mx-auto">
                            ...
                            <a href="https://docs.google.com/presentation/d/1WgMPahaLhRsJiK8zHHa-aG1y2yrZMmCF/edit?usp=sharing&ouid=107287742628985461156&rtpof=true&sd=true"
                               target="_blank"
                        ...
                        <div className="max-w-5xl mx-auto bg-white rounded-lg shadow-sm p-6 mb-8">
                                ...
                                <div className="space-y-8">
                                    ...
                                    <div
                                        ...
                                        <p className="text-gray-800 leading-relaxed text-lg">
                                            La anafilaxia es una <strong>reacción alérgica sistémica grave</strong> que
                                            puede
                                            causar la muerte en cuestión de minutos. El reconocimiento inmediato y la
                                            administración de <span
                                            className="text-red-600 font-bold">epinefrina</span> pueden salvar vidas.
                                        </p>
                                        ...
                                        <div className="grid lg:grid-cols-2 gap-6">
                                            <div>
                                                <div className="bg-blue-50 p-6 rounded-lg border border-blue-200 mb-4">
                                                    <h3 className="font-bold text-blue-700 mb-3">Sistema Inmunológico
                                                        Normal</h3>
                                            ...
                                            <div className="flex justify-center items-center">
                                                <div className="text-center">
                                                    ...
                                                    />
                                                    <p className="text-sm text-gray-600 italic">Proceso de reacción
                                                        alérgica</p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
                                        <div className="flex items-center mb-4">
                                            ...
                                            <h3 className="text-xl font-bold text-yellow-800">Signos y Síntomas de
                                                Anafilaxia - Reconocimiento Inmediato</h3>
                                        </div>
                                    ...
                                    <div>
                                        <h2 className="text-2xl font-semibold mb-4 text-gray-800 border-b pb-2">Alérgenos
                                            ...
                                            <div className="bg-orange-50 p-6 rounded-lg border border-orange-200">
                                                ...
                                                <ul className="space-y-2 text-gray-700">
                                                    <li className="flex items-center">
                                                        <span
                                                            className="w-2 h-2 bg-orange-500 rounded-full mr-2"></span>
                                    ...
                                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                                        <div className="flex items-center mb-4">
                                            ...
                                            <h3 className="text-xl font-bold text-blue-800">Puntos Clave para
                                                Recordar</h3>
                                        </div>
                            ...
                            {activeTab === 'physiology' && (
                                <div className="space-y-8">
                                        ...
                                        <div className="grid lg:grid-cols-2 gap-8">
                                            <div>
                                                <div className="bg-blue-50 p-6 rounded-lg border border-blue-200 mb-6">
                                                    <h3 className="text-xl font-bold text-blue-700 mb-4">Mecanismo de
                                                        Reacción</h3>
                                                    <div className="space-y-4">
                                                        <div className="flex items-start space-x-3">
                                                            <div
                                                                className="w-8 h-8 bg-blue-500 rounded-full flex items-center justify-center text-white font-bold">1
                                                            </div>
                                                            <div>
                                                                <h4 className="font-semibold">Sensibilización
                                                                    Inicial</h4>
                                                                <p className="text-sm text-gray-600">Primera exposición
                                                                    al alérgeno. El sistema inmunológico produce
                                                                    anticuerpos IgE específicos.</p>
                                                            </div>
                                                        </div>
                                                        <div className="flex items-start space-x-3">
                                                            <div
                                                                className="w-8 h-8 bg-blue-500 rounded-full flex items-center justify-center text-white font-bold">2
                                                            </div>
                                                            <div>
                                                                <h4 className="font-semibold">Activación de
                                                                    Mastocitos</h4>
                                                                <p className="text-sm text-gray-600">Los anticuerpos IgE
                                                                    se unen a mastocitos y basófilos, preparándolos para
                                                                    futuras exposiciones.</p>
                                                            </div>
                                                        </div>
                                                        <div className="flex items-start space-x-3">
                                                            <div
                                                                className="w-8 h-8 bg-red-500 rounded-full flex items-center justify-center text-white font-bold">3
                                                            </div>
                                                            <div>
                                                                <h4 className="font-semibold">Degranulación Masiva</h4>
                                                                <p className="text-sm text-gray-600">Nueva exposición
                                                                    causa liberación súbita de mediadores
                                                                    inflamatorios.</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div className="flex justify-center items-center">
                                                <div className="text-center">
                                                    <img
                                                        ...
                                                        className="rounded-lg shadow-lg max-w-full h-auto mb-4"
                                                    />
                                                    <p className="text-sm text-gray-600 italic">Liberación de mediadores
                                                        inflamatorios</p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    {/* Efectos sistémicos */}
                                    <div>
                                        <h2 className="text-2xl font-semibold mb-4 text-gray-800 border-b pb-2">Efectos
                                            Sistémicos de la Anafilaxia</h2>
                                        <div className="grid lg:grid-cols-2 gap-6">
                                            <div className="space-y-4">
                                                <div className="bg-red-50 p-6 rounded-lg border border-red-200">
                                                    ...
                                                    <div className="space-y-2">
                                                        <div className="flex items-start space-x-2">
                                                            ...
                                                            <span
                                                                className="text-sm"><strong>Broncoconstricción:</strong> Cierre de vías aéreas pequeñas</span>
                                                        </div>
                                                        <div className="flex items-start space-x-2">
                                                            <span className="text-red-600 font-bold">•</span>
                                                ...
                                                <div className="bg-blue-50 p-6 rounded-lg border border-blue-200">
                                                    ...
                                                    <div className="space-y-2">
                                                        ...
                                                        <div className="flex items-start space-x-2">
                                                            <span className="text-blue-600 font-bold">•</span>
                                                            <span
                                                                className="text-sm"><strong>Pérdida de líquidos:</strong> Paso al espacio intersticial</span>
                                                        </div>
                                                        <div className="flex items-start space-x-2">
                                                            <span className="text-blue-600 font-bold">•</span>
                                                            <span
                                                                className="text-sm"><strong>Disminución precarga:</strong> Retorno venoso reducido</span>
                                                        </div>
                                                        <div className="flex items-start space-x-2">
                                                            <span className="text-blue-600 font-bold">•</span>
                                                ...
                                                <div className="bg-green-50 p-6 rounded-lg border border-green-200">
                                                    ...
                                                    <div className="space-y-2">
                                                        ...
                                                        <div className="flex items-start space-x-2">
                                                            <span className="text-green-600 font-bold">•</span>
                                                            <span
                                                                className="text-sm"><strong>Aumento permeabilidad:</strong> Urticaria, angioedema</span>
                                                        </div>
                                                        <div className="flex items-start space-x-2">
                                                            <span className="text-green-600 font-bold">•</span>
                                                            <span
                                                                className="text-sm"><strong>Estimulación nerviosa:</strong> Prurito intenso</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="bg-purple-50 p-6 rounded-lg border border-purple-200">
                                                    ...
                                                    <div className="space-y-2">
                                                        ...
                                                        <div className="flex items-start space-x-2">
                                                            <span className="text-purple-600 font-bold">•</span>
                                                            <span
                                                                className="text-sm"><strong>Liberación catecolaminas:</strong> Ansiedad, pánico</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div className="bg-gray-50 border border-gray-200 rounded-lg p-6">
                                        <h3 className="text-xl font-bold text-gray-700 mb-4">Progresión Temporal de la
                                            Anafilaxia</h3>
                                        <div className="space-y-4">
                                            <div className="grid md:grid-cols-4 gap-4">
                                                <div className="bg-yellow-100 p-4 rounded-lg text-center">
                                                    <div className="text-2xl font-bold text-yellow-700 mb-2">1-5 min
                                                    </div>
                                                    <div className="text-sm text-gray-700">
                                                        <strong>Fase inicial:</strong> Prurito, urticaria localizada,
                                                        sensación extraña
                                                    </div>
                                                </div>
                                                <div className="bg-orange-100 p-4 rounded-lg text-center">
                                                    <div className="text-2xl font-bold text-orange-700 mb-2">5-15 min
                                                    </div>
                                                    <div className="text-sm text-gray-700">
                                                        <strong>Desarrollo:</strong> Urticaria generalizada, dificultad
                                                        respiratoria leve
                                                    </div>
                                                </div>
                                                <div className="bg-red-100 p-4 rounded-lg text-center">
                                                    <div className="text-2xl font-bold text-red-700 mb-2">15-30 min
                                                    </div>
                                                    <div className="text-sm text-gray-700">
                                                        <strong>Crítica:</strong> Broncoespasmo, hipotensión, edema
                                                        laríngeo
                                                    </div>
                                                </div>
                                            ...
                                            <div className="bg-red-50 p-4 rounded-lg">
                                                <p className="text-red-700 font-semibold text-center">
                                                    ⚠️ La progresión puede ser MUY rápida: desde síntomas leves hasta
                                                    shock en minutos
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    <div>
                                        <h2 className="text-2xl font-semibold mb-4 text-gray-800 border-b pb-2">Factores
                                            que Influyen en la Gravedad</h2>
                                        <div className="grid md:grid-cols-2 gap-6">
                                            <div className="bg-red-50 p-6 rounded-lg border border-red-200">
                                ...
                                <div className="space-y-8">
                                    ...
                                    <div
                                        ...
                                        <div className="flex items-center mb-4">
                                            ...
                                            <h2 className="text-2xl font-bold text-red-700">Algoritmo de Manejo
                                                Prehospitalario</h2>
                                        </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="grid lg:grid-cols-2 gap-6">
                                            <div className="bg-blue-50 p-6 rounded-lg border border-blue-200">
                                                ...
                                                <div className="space-y-4">
                                                    <div className="bg-white p-4 rounded-lg">
                                                        <h4 className="font-semibold text-red-700 mb-2">A - Vía
                                                            Aérea</h4>
                                                        <ul className="text-sm space-y-1 text-gray-700">
                                                    ...
                                                    <div className="bg-white p-4 rounded-lg">
                                                        <h4 className="font-semibold text-green-700 mb-2">B -
                                                            Respiración</h4>
                                                        <ul className="text-sm space-y-1 text-gray-700">
                                                    ...
                                                    <div className="bg-white p-4 rounded-lg">
                                                        <h4 className="font-semibold text-blue-700 mb-2">C -
                                                            Circulación</h4>
                                                        <ul className="text-sm space-y-1 text-gray-700">
                                            ...
                                            <div className="bg-orange-50 p-6 rounded-lg border border-orange-200">
                                                ...
                                                <div className="space-y-4">
                                                    ...
                                                    <div className="bg-yellow-50 p-4 rounded-lg">
                                                        <h4 className="font-semibold text-yellow-700 mb-2">Preguntas
                                                            Clave</h4>
                                                        <ul className="text-sm space-y-1 text-gray-700">
                                    ...
                                    <div className="bg-green-50 border border-green-200 rounded-lg p-6">
                                        ...
                                        <div className="grid lg:grid-cols-2 gap-6">
                                            <div>
                                                <h4 className="font-semibold text-green-800 mb-3">Mecanismo de
                                                    Acción</h4>
                                                <div className="space-y-2">
                                                    <div className="bg-white p-3 rounded-lg">
                                                        <strong>Alfa-1 agonista:</strong> Vasoconstricción → mejora
                                                        hipotensión
                                                    </div>
                                                    <div className="bg-white p-3 rounded-lg">
                                                        <strong>Beta-1 agonista:</strong> Cronotropismo e inotropismo
                                                        positivo
                                                    </div>
                                                    <div className="bg-white p-3 rounded-lg">
                                                        <strong>Beta-2 agonista:</strong> Broncodilatación → mejora
                                                        respiración
                                                    </div>
                                                    <div className="bg-white p-3 rounded-lg">
                                                        <strong>Estabiliza mastocitos:</strong> Reduce liberación de
                                                        histamina
                                                    </div>
                                                </div>
                                            </div>
                                            <div>
                                                <h4 className="font-semibold text-green-800 mb-3">Dosificación y
                                                    Administración</h4>
                                                <div className="overflow-x-auto">
                                                    <table className="min-w-full bg-white border rounded-lg">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td className="py-2 px-3 border text-center">Sin mejoría
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                ...
                                                <div className="mt-4 bg-green-100 p-3 rounded-lg">
                                                    <p className="text-sm text-green-800">
                                                        <strong>Sitio de aplicación:</strong> Cara anterolateral del
                                                        muslo (vasto lateral)
                                                    </p>
                                                </div>
                                            </div>
                                    ...
                                    {/* Autoinyectores */}
                                    <div>
                                        <h2 className="text-2xl font-semibold mb-4 text-gray-800 border-b pb-2">Autoinyectores
                                            de Epinefrina</h2>
                                        <div className="grid md:grid-cols-2 gap-6">
                                            <div className="bg-blue-50 p-6 rounded-lg border border-blue-200">
                                                ...
                                                <div className="space-y-3">
                                                    <div className="flex items-start space-x-3">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className="text-sm text-gray-600">Quitar la tapa de
                                                                seguridad azul</p>
                                                        </div>
                                                    </div>
                                                    <div className="flex items-start space-x-3">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className="text-sm text-gray-600">Sostener firmemente con
                                                                punta naranja hacia abajo</p>
                                                        </div>
                                                    </div>
                                                    <div className="flex items-start space-x-3">
                                                        <div
                                                            className="w-8 h-8 bg-blue-500 rounded-full flex items-center justify-center text-white font-bold">3
                                                        </div>
                                                        <div>
                                                            <h4 className="font-semibold">Aplicar en muslo</h4>
                                                            <p className="text-sm text-gray-600">Presionar firmemente
                                                                hasta escuchar "click"</p>
                                                        </div>
                                                    </div>
                                                    <div className="flex items-start space-x-3">
                                                        <div
                                                            className="w-8 h-8 bg-blue-500 rounded-full flex items-center justify-center text-white font-bold">4
                                                        </div>
                                                        <div>
                                                            <h4 className="font-semibold">Mantener 10 segundos</h4>
                                                            <p className="text-sm text-gray-600">Mantener presionado
                                                                para completar inyección</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="bg-orange-50 p-6 rounded-lg border border-orange-200">
                                                <h3 className="font-bold text-orange-700 mb-3">Consideraciones
                                                    Importantes</h3>
                                                <ul className="space-y-2 text-gray-700">
                                                    <li className="flex items-start">
                                                        <BsExclamationTriangle
                                                            className="w-4 h-4 mt-1 mr-2 text-orange-600"/>
                                    ...
                                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                                        <h3 className="text-xl font-bold text-blue-700 mb-4">Medicamentos de Segunda
                                            Línea (Solo si protocolos lo permiten)</h3>
                                        <div className="overflow-x-auto">
                                            <table className="min-w-full bg-white border rounded-lg">
                                                <thead className="bg-gray-100">
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td className="py-3 px-4 border text-center">NUNCA como único
                                                        tratamiento
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td className="py-3 px-4 border text-center">Efecto tardío (4-6
                                                        hrs)
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td className="py-3 px-4 border text-center">2.5-5 mg nebulizado
                                                    </td>
                                                    <td className="py-3 px-4 border text-center">Adjunto, NO sustituto
                                                    </td>
                                                </tr>
                                                </tbody>
                                            </table>
                                        ...
                                        <div className="mt-4 bg-yellow-50 p-3 rounded-lg">
                                            <p className="text-sm text-yellow-800 font-semibold">
                                                ⚠️ Recordar: La EPINEFRINA es el único medicamento que puede detener la
                                                anafilaxia
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        <h2 className="text-2xl font-semibold mb-4 text-gray-800 border-b pb-2">Monitorización
                                            y Transporte</h2>
                                        <div className="grid md:grid-cols-2 gap-6">
                                            <div className="bg-green-50 p-6 rounded-lg border border-green-200">
                                                <h3 className="font-bold text-green-700 mb-3">Monitorización
                                                    Continua</h3>
                                                <ul className="space-y-2 text-gray-700">
                                                    <li className="flex items-start">
                                            ...
                                            <div className="bg-orange-50 p-6 rounded-lg border border-orange-200">
                                                <h3 className="font-bold text-orange-700 mb-3">Criterios de
                                                    Transporte</h3>
                                                <div className="space-y-4">
                                                    <div className="bg-white p-4 rounded-lg">
                                                        <h4 className="font-semibold text-red-700 mb-2">TRANSPORTE
                                                            URGENTE</h4>
                                                        <ul className="text-sm space-y-1 text-gray-700">
                                                    ...
                                                    <div className="bg-white p-4 rounded-lg">
                                                        <h4 className="font-semibold text-green-700 mb-2">SIEMPRE
                                                            TRANSPORTAR</h4>
                                                        <ul className="text-sm space-y-1 text-gray-700">
                                ...
                                <div className="space-y-8">
                                    <div
                                        ...
                                        <div className="flex items-center mb-4">
                                            ...
                                            <h2 className="text-2xl font-bold text-blue-700">Casos Clínicos para
                                                Aprendizaje</h2>
                                        </div>
                                        <p className="text-gray-800 leading-relaxed text-lg">
                                            Analiza estos casos reales adaptados para practicar tu toma de decisiones.
                                            Cada caso incluye presentación clínica, evaluación paso a paso y puntos de
                                            aprendizaje.
                                        </p>
                                    </div>
                                    ...
                                    <div className="bg-white border border-gray-200 rounded-lg shadow-sm">
                                        <div className="bg-red-50 p-6 rounded-t-lg border-b border-red-200">
                                            ...
                                            <div className="bg-white p-4 rounded-lg">
                                                ...
                                                <p className="text-gray-700 italic">
                                                    Mujer de 24 años, sin antecedentes médicos conocidos, cenando en un
                                                    restaurante de mariscos.
                                                    Aproximadamente 10 minutos después de consumir camarones, comienza
                                                    con prurito intenso en
                                                    palmas y plantas. Rápidamente desarrolla urticaria generalizada,
                                        ...
                                        <div className="p-6">
                                            <div className="grid lg:grid-cols-2 gap-6">
                                                <div>
                                                    <h4 className="font-semibold text-blue-700 mb-3">A tu llegada
                                                        encuentras:</h4>
                                                    <div className="space-y-3">
                                                        <div className="bg-red-50 p-4 rounded-lg">
                                                            <h5 className="font-semibold text-red-700 mb-2">Apariencia
                                                                General</h5>
                                                            <ul className="text-sm space-y-1 text-gray-700">
                                                ...
                                                <div>
                                                    <h4 className="font-semibold text-green-700 mb-3">Evaluación
                                                        Sistemática:</h4>
                                                    <div className="space-y-3">
                                                        <div className="bg-blue-50 p-4 rounded-lg">
                                                            <h5 className="font-semibold text-blue-700 mb-2">A - Vía
                                                                Aérea</h5>
                                                            <ul className="text-sm space-y-1 text-gray-700">
                                                        ...
                                                        <div className="bg-green-50 p-4 rounded-lg">
                                                            <h5 className="font-semibold text-green-700 mb-2">B -
                                                                Respiración</h5>
                                                            <ul className="text-sm space-y-1 text-gray-700">
                                                        ...
                                                        <div className="bg-purple-50 p-4 rounded-lg">
                                                            <h5 className="font-semibold text-purple-700 mb-2">C -
                                                                Circulación</h5>
                                                            <ul className="text-sm space-y-1 text-gray-700">
                                            ...
                                            <div className="mt-6 bg-yellow-50 p-4 rounded-lg">
                                                <h4 className="font-semibold text-yellow-800 mb-2">Tu Manejo (Paso a
                                                    Paso)</h4>
                                            ...
                                            <div className="mt-6 bg-green-50 p-4 rounded-lg">
                                                <h4 className="font-semibold text-green-800 mb-2">Evolución del
                                                    Caso:</h4>
                                                <p className="text-sm text-gray-700">
                                                    <strong>A los 5 minutos:</strong> Mejoría notable de la disnea, SpO₂
                                                    94%, TA 100/60 mmHg.
                                                    Urticaria persiste pero menos intensa. Paciente más tranquila.
                                                </p>
                                                <p className="text-sm text-gray-700 mt-2">
                                                    <strong>Durante transporte:</strong> Mantiene mejoría, signos
                                                    vitales estables.
                                            ...
                                            <div className="mt-6 bg-blue-50 p-4 rounded-lg">
                                                <h4 className="font-semibold text-blue-800 mb-2">Puntos de
                                                    Aprendizaje:</h4>
                                                <ul className="text-sm space-y-1 text-gray-700">
                                                    <li>• Los mariscos son una de las causas más comunes de anafilaxia
                                                        alimentaria
                                                    </li>
                                                    <li>• El inicio rápido de síntomas sistémicos requiere acción
                                                        inmediata
                                                    </li>
                                                    <li>• La combinación de síntomas cutáneos + respiratorios +
                                                        cardiovasculares = anafilaxia
                                                    </li>
                                                    <li>• La epinefrina es el tratamiento de primera línea y debe
                                                        administrarse sin demora
                                                    </li>
                                                    <li>• La posición supina ayuda a mejorar el retorno venoso en el
                                                        shock
                                                    </li>
                                                </ul>
                                            </div>
                                    ...
                                    <div className="bg-white border border-gray-200 rounded-lg shadow-sm">
                                        <div className="bg-orange-50 p-6 rounded-t-lg border-b border-orange-200">
                                            ...
                                            <div className="bg-white p-4 rounded-lg">
                                                <h4 className="font-semibold text-gray-800 mb-2">Presentación del
                                                    Caso</h4>
                                                <p className="text-gray-700 italic">
                                                    Hombre de 45 años, jardinero, picado por una abeja en el brazo
                                                    izquierdo mientras
                                                    trabajaba. Refiere que hace años tuvo una reacción "fuerte" a una
                                                    picadura, pero
                                                    no recuerda detalles. Aproximadamente 3 minutos después de la
                                                    picadura, desarrolla
                                                    rápidamente urticaria generalizada, dificultad respiratoria severa y
                                                    mareo intenso.
                                                </p>
                                            </div>
                                        </div>
                                        <div className="p-6">
                                            <div className="grid lg:grid-cols-2 gap-6">
                                                <div>
                                                    <h4 className="font-semibold text-orange-700 mb-3">Evaluación
                                                        Inicial:</h4>
                                                    <div className="space-y-3">
                                                        <div className="bg-red-50 p-4 rounded-lg">
                                                            <h5 className="font-semibold text-red-700 mb-2">Signos
                                                                Críticos</h5>
                                                            <ul className="text-sm space-y-1 text-gray-700">
                                                                <li>• <strong>Estridor inspiratorio audible</strong>
                                                                </li>
                                                ...
                                                <div>
                                                    <h4 className="font-semibold text-red-700 mb-3">¡SITUACIÓN
                                                        CRÍTICA!</h4>
                                                    <div className="bg-red-100 p-4 rounded-lg">
                                                        <h5 className="font-semibold text-red-800 mb-2">Amenaza
                                                            Inmediata a la Vida</h5>
                                                        <ul className="text-sm space-y-1 text-gray-700">
                                                    ...
                                                    <div
                                                        className="bg-white p-4 rounded-lg border-2 border-red-200 mt-4">
                                                        <h5 className="font-semibold text-red-800 mb-2">Acción
                                                            Inmediata:</h5>
                                                        <ol className="text-sm space-y-1 text-gray-700">
                                                            <li><strong>1. Epinefrina 0.5 mg IM INMEDIATAMENTE</strong>
                                                            </li>
                                                            ...
                                                            <li><strong>5. Preparar segunda dosis epinefrina</strong>
                                                            </li>
                                                        </ol>
                                                    </div>
                                                </div>
                                            ...
                                            <div className="mt-6 bg-yellow-50 p-4 rounded-lg">
                                                <h4 className="font-semibold text-yellow-800 mb-2">Evolución - Primeros
                                                    10 minutos:</h4>
                                                <div className="grid md:grid-cols-2 gap-4">
                                                    <div>
                                                        <h5 className="font-semibold text-green-700 mb-2">Mejoría
                                                            Gradual:</h5>
                                                        <ul className="text-sm space-y-1 text-gray-700">
                                                    ...
                                                    <div>
                                                        <h5 className="font-semibold text-blue-700 mb-2">Manejo
                                                            Continuo:</h5>
                                                        <ul className="text-sm space-y-1 text-gray-700">
                                            ...
                                            <div className="mt-6 bg-blue-50 p-4 rounded-lg">
                                                <h4 className="font-semibold text-blue-800 mb-2">Puntos Clave de este
                                                    Caso:</h4>
                                                <ul className="text-sm space-y-1 text-gray-700">
                                                    <li>• El estridor es un signo de alarma que requiere acción
                                                        inmediata
                                                    </li>
                                                    <li>• La anafilaxia por picaduras puede ser más severa que la
                                                        alimentaria
                                                    </li>
                                                    <li>• La historia previa de reacciones aumenta el riesgo</li>
                                                    <li>• En casos críticos, no dudar en usar dosis más alta de
                                                        epinefrina
                                                    </li>
                                    ...
                                    <div className="bg-white border border-gray-200 rounded-lg shadow-sm">
                                        <div className="bg-green-50 p-6 rounded-t-lg border-b border-green-200">
                                            ...
                                            <div className="bg-white p-4 rounded-lg">
                                                <h4 className="font-semibold text-gray-800 mb-2">Presentación del
                                                    Caso</h4>
                                                <p className="text-gray-700 italic">
                                                    Mujer de 65 años con antecedentes de hipertensión arterial, recibió
                                                    antibiótico
                                                    (amoxicilina) para infección urinaria hace 20 minutos en la consulta
                                                    médica.
                                                    Mientras esperaba en la sala, desarrolla súbitamente urticaria,
                                                    disnea y
                                                    alteración del estado mental. El personal médico solicita
                                                    ambulancia.
                                                </p>
                                            </div>
                                        </div>
                                        <div className="p-6">
                                            <div className="grid lg:grid-cols-2 gap-6">
                                                <div>
                                                    <h4 className="font-semibold text-green-700 mb-3">Hallazgos
                                                        Clínicos:</h4>
                                                    <div className="space-y-3">
                                                        <div className="bg-purple-50 p-4 rounded-lg">
                                                            <h5 className="font-semibold text-purple-700 mb-2">Estado
                                                                Mental</h5>
                                                            <ul className="text-sm space-y-1 text-gray-700">
                                                ...
                                                <div>
                                                    <h4 className="font-semibold text-orange-700 mb-3">Desafíos
                                                        Específicos:</h4>
                                                    <div className="space-y-3">
                                                        <div className="bg-yellow-50 p-4 rounded-lg">
                                            ...
                                            <div className="mt-6 bg-blue-50 p-4 rounded-lg">
                                                ...
                                                <div className="grid md:grid-cols-2 gap-4">
                                                    <div>
                                                        <h5 className="font-semibold text-green-700 mb-2">Tratamiento
                                                            Inicial:</h5>
                                                        <ol className="text-sm space-y-1 text-gray-700">
                                                    ...
                                                    <div>
                                                        <h5 className="font-semibold text-blue-700 mb-2">Preparación
                                                            para:</h5>
                                                        <ul className="text-sm space-y-1 text-gray-700">
                                            ...
                                            <div className="mt-6 bg-green-50 p-4 rounded-lg">
                                                ...
                                                <p className="text-sm text-gray-700">
                                                    <strong>Respuesta parcial:</strong> Mejoría leve de la urticaria y
                                                    estado mental,
                                                    pero persistencia de hipotensión. Se administra segunda dosis de
                                                    epinefrina a
                                                    los 10 minutos. Con líquidos IV y epinefrina, logra estabilización
                                                    para transporte.
                                                </p>
                                            </div>

                                            <div className="mt-6 bg-blue-50 p-4 rounded-lg">
                                                <h4 className="font-semibold text-blue-800 mb-2">Lecciones
                                                    Aprendidas:</h4>
                                                <ul className="text-sm space-y-1 text-gray-700">
                                                    <li>• Los medicamentos son la segunda causa más común de
                                                        anafilaxia
                                                    </li>
                                                    <li>• Los IECA pueden empeorar la respuesta anafiláctica</li>
                                                    <li>• Los pacientes mayores pueden tener respuesta atenuada</li>
                                                    <li>• La alteración del estado mental puede ser el síntoma
                                                        predominante
                                                    </li>
                                    ...
                                    <div className="bg-white border border-gray-200 rounded-lg shadow-sm">
                                        <div className="bg-purple-50 p-6 rounded-t-lg border-b border-purple-200">
                                            ...
                                            <div className="bg-white p-4 rounded-lg">
                                                <h4 className="font-semibold text-gray-800 mb-2">Presentación del
                                                    Caso</h4>
                                                <p className="text-gray-700 italic">
                                                    Niño de 8 años, en una fiesta de cumpleaños, consume una galleta que
                                                    contenía
                                                    nueces sin que los padres lo supieran. Tiene antecedentes de alergia
                                                    severa
                                                    a frutos secos. Desarrolla rápidamente urticaria, vómitos y
                                                    dificultad
                                        ...
                                        <div className="p-6">
                                            <div className="grid lg:grid-cols-2 gap-6">
                                                <div>
                                                    <h4 className="font-semibold text-purple-700 mb-3">Particularidades
                                                        Pediátricas:</h4>
                                                    <div className="space-y-3">
                                                        <div className="bg-yellow-50 p-4 rounded-lg">
                                                            <h5 className="font-semibold text-yellow-700 mb-2">Diferencias
                                                                en Niños</h5>
                                                            <ul className="text-sm space-y-1 text-gray-700">
                                                ...
                                                <div>
                                                    <h4 className="font-semibold text-red-700 mb-3">Manejo
                                                        Pediátrico:</h4>
                                                    <div className="space-y-3">
                                                        <div className="bg-green-50 p-4 rounded-lg">
                                                            <h5 className="font-semibold text-green-700 mb-2">Dosis
                                                                Pediátrica</h5>
                                                            <ul className="text-sm space-y-1 text-gray-700">
                                                                <li>• Peso: 25 kg</li>
                                            ...
                                            <div className="mt-6 bg-blue-50 p-4 rounded-lg">
                                                <h4 className="font-semibold text-blue-800 mb-2">Puntos Especiales en
                                                    Pediatría:</h4>
                                                <ul className="text-sm space-y-1 text-gray-700">
                                    ...
                                    {/* Resumen de casos */}
                                    <div className="bg-gray-50 border border-gray-200 rounded-lg p-6">
                                        <h3 className="text-xl font-bold text-gray-800 mb-4">Resumen de Conceptos
                                            Clave</h3>
                                        <div className="grid md:grid-cols-2 gap-6">
                                            <div>
                                            ...
                                            <div>
                                                <h4 className="font-semibold text-blue-700 mb-2">Factores de Mal
                                                    Pronóstico:</h4>
                                                <ul className="text-sm space-y-1 text-gray-700">
                        ...
                        <section className="max-w-5xl mx-auto p-6 bg-white rounded-lg shadow-sm">
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <ul className="list-disc list-inside space-y-2 text-gray-700">
                                        <li><a href="https://www.ems1.com/allergy-anaphylaxis/" target="_blank"
                                               rel="noopener noreferrer" className="text-blue-600 hover:underline">EMS1
                                            - Artículos sobre anafilaxia y alergias</a></li>
                                        <li><a href="https://www.jems.com/patient-care/allergy-anaphylaxis/"
                                               target="_blank" rel="noopener noreferrer"
                                               className="text-blue-600 hover:underline">JEMS - Sección de alergias y
                                            anafilaxia</a></li>
                                        <li><a href="https://www.youtube.com/c/MedicTests" target="_blank"
                                            ...
                                            - Videos educativos sobre emergencias</a></li>
                                    </ul>
                                </div>
