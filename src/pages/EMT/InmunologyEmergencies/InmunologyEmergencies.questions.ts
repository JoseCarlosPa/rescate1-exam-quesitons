...
export const inmunologieQuestions: Question[] = [
    ...
    },
    {
        ...
        options: [
            { letter: "a", text: "Asegurarse de que el paciente tenga una vía aérea permeable y administrar oxígeno a alto flujo" },
        ...
        correctAnswer: "b", // En el contexto de anafilaxia con compromiso vital, la epinefrina es la prioridad #1.
    },
    {
    ...
    },
    {
        ...
        options: [
            ...
            { letter: "c", text: "Una persona no puede desarrollar una alergia a algo a lo que ha estado expuesta muchas veces sin problemas" },
            { letter: "d", text: "Una exposición que inicialmente solo causa una reacción leve puede sensibilizar a la persona para una reacción anafiláctica en el futuro" },
        ],
        correctAnswer: "d",
    },
    {
    ...
    },
    {
        ...
        options: [
            { letter: "a", text: "Administrar una segunda dosis de epinefrina inmediatamente para tratar la taquicardia" },
            { letter: "b", text: "Administrar oxígeno, continuar la evaluación y prepararse para el transporte, reconociendo que la taquicardia es un efecto esperado de la epinefrina" },
    ...
    },
    {
        ...
        correctAnswer: "d", // Si bien la comida es una causa muy común, las reacciones más rápidas y fatales suelen ser por sustancias inyectadas.
    },
];