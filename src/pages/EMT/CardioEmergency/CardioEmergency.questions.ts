...
export const cardiovascularQuestions: Question[] = [
    ...
    },
    {
        ...
        "options": [
            ...
            {
                "letter": "b",
                "text": "La incapacidad del corazón para bombear suficiente sangre para satisfacer las demandas del cuerpo, lo que lleva a la acumulación de líquidos."
            },
    ...
    },
    {
        ...
        "options": [
            ...
            {
                "letter": "c",
                "text": "Mantener la calma, monitorear y transportar al paciente de forma segura y rápida."
            },
    ...
    },
    {
        ...
        "options": [
            ...
            {
                "letter": "b",
                "text": "La nitroglicerina está absolutamente contraindicada debido al riesgo de hipotensión severa."
            },
