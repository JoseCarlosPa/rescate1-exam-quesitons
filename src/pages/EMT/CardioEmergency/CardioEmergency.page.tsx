                ...
                <div
                    ...
                    <div className="w-full max-w-7xl">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-8 max-w-4xl mx-auto">
                            ...
                            <a href="https://docs.google.com/presentation/d/1_zVz80qNK29WdLTiTk9EfEaaV7jjT2PZ/edit?usp=sharing&ouid=107287742628985461156&rtpof=true&sd=true"
                               target="_blank"
                            ...
                            <a href="https://drive.google.com/file/d/1GMhJk8VQbxIrEDeyOj7zMY4fSikj40Qm/view?usp=drive_link"
                        ...
                        <section className="max-w-5xl mx-auto p-6 bg-white rounded-lg shadow-sm">
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <ul className="list-disc list-inside space-y-2 text-gray-700">
                                        <li><a href="https://www.ems1.com/ems-products/cardiac-care/" target="_blank"
                                               rel="noopener noreferrer" className="text-blue-600 hover:underline">EMS1
                                            - Artículos sobre emergencias cardíacas</a></li>
