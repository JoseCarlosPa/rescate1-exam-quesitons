                    ...
                    <div className="w-full max-w-7xl">
                        ...
                        {showQuickQuiz && (
                            <div className="bg-white p-6 rounded-lg shadow-md mb-8 max-w-4xl mx-auto">
                                ...
                                <p className="text-gray-700">El quiz rápido de trauma estará disponible
                                    próximamente.</p>
                                <button
                                ...
                                <div className="space-y-8">
                                    <div>
                                        ...
                                        <p className="text-gray-700 leading-relaxed">
                                            El trauma es una lesión o daño físico producido por la transferencia de
                                            energía al cuerpo, resultado de accidentes, caídas, agresiones, colisiones,
                                            entre otros. Es la principal causa de muerte en personas menores de 45 años
                                            y una de las principales causas de discapacidad. La atención prehospitalaria
                                            rápida y sistemática es fundamental para mejorar el pronóstico.
                                        </p>
                                    </div>
                                    <div className="grid md:grid-cols-2 gap-6">
                                        <div className="bg-orange-50 p-4 rounded-lg">
                                            <h3 className="font-medium text-lg mb-2 text-orange-700">Importancia del
                                                trauma</h3>
                                        ...
                                        <div className="bg-blue-50 p-4 rounded-lg">
                                            <h3 className="font-medium text-lg mb-2 text-blue-700">Cadena de
                                                supervivencia en trauma</h3>
                                            <ul className="list-disc list-inside space-y-1 text-gray-700">
                                                <li>Prevención</li>
                                ...
                                <div className="space-y-8">
                                    <div>
                                        ...
                                        <p className="text-gray-700 leading-relaxed">
                                            ...
                                            determina el tipo y gravedad de las lesiones. Comprender el MOI ayuda a
                                            anticipar lesiones ocultas y priorizar intervenciones.
                                        </p>
                                        <ul className="list-disc list-inside space-y-1 mt-2 text-gray-700">
                                            <li><strong>Trauma contuso:</strong> Impacto sin penetración de la piel
                                                (colisiones, caídas, agresiones).
                                            </li>
                                            <li><strong>Trauma penetrante:</strong> Objeto atraviesa la piel (heridas
                                                por arma blanca o de fuego).
                                            </li>
                                            <li><strong>Otros mecanismos:</strong> Explosiones, quemaduras, ahogamiento,
                                                asfixia.
                                            </li>
                                        </ul>
                                    </div>
                                    <div>
                                        <h2 className="text-2xl font-semibold mb-3 text-gray-800 border-b pb-2">Cinética
                                            del trauma</h2>
                                        <div className="grid md:grid-cols-2 gap-6">
                                            <div>
                                                <h3 className="font-medium text-lg mb-2 text-orange-700">Principios
                                                    clave</h3>
                                                <ul className="list-disc list-inside space-y-1 text-gray-700">
                                                    <li>Energía cinética = ½ masa x velocidad² (la velocidad es el
                                                        factor más determinante).
                                                    </li>
                                                    <li>Intercambio de energía: mayor velocidad, mayor daño potencial.
                                                    </li>
                                                    <li>Cavitación: en trauma penetrante, se forman cavidades temporales
                                                        y permanentes.
                                                    </li>
                                                </ul>
                                            </div>
                                            <div className="bg-gray-50 p-4 rounded-lg">
                                                <h3 className="font-medium text-lg mb-2 text-blue-700">Ejemplos de
                                                    MOI</h3>
                                                <ul className="list-disc list-inside space-y-1 text-gray-700">
                                                    <li>Colisión vehicular (frontal, lateral, trasera,
                                                        atropellamiento)
                                                    </li>
                                    ...
                                    <div>
                                        <h2 className="text-2xl font-semibold mb-3 text-gray-800 border-b pb-2">Lesiones
                                            específicas por región</h2>
                                        <div className="grid md:grid-cols-2 gap-6">
                                            <div className="bg-orange-50 p-4 rounded-lg">
                                                <h3 className="font-medium text-lg mb-2 text-orange-700">Cabeza y
                                                    columna</h3>
                                                <ul className="list-disc list-inside space-y-1 text-gray-700">
                                            ...
                                            <div className="bg-blue-50 p-4 rounded-lg">
                                                <h3 className="font-medium text-lg mb-2 text-blue-700">Tórax y
                                                    abdomen</h3>
                                                <ul className="list-disc list-inside space-y-1 text-gray-700">
                                            ...
                                            <div className="bg-green-50 p-4 rounded-lg">
                                                <h3 className="font-medium text-lg mb-2 text-green-700">Extremidades y
                                                    piel</h3>
                                                <ul className="list-disc list-inside space-y-1 text-gray-700">
                                ...
                                <div className="space-y-8">
                                    <div>
                                        <h2 className="text-2xl font-semibold mb-3 text-gray-800 border-b pb-2">Evaluación
                                            inicial del paciente de trauma</h2>
                                        <p className="text-gray-700 leading-relaxed">
                                            La evaluación prehospitalaria sigue el enfoque XABCDE para identificar y
                                            tratar amenazas vitales de inmediato. Cada paso es fundamental para la
                                            supervivencia:
                                        </p>
                                        <ul className="list-disc list-inside space-y-2 mt-2 text-gray-700">
                                            <li><strong>X (Exanguinación):</strong> Control inmediato de hemorragias
                                                externas masivas.
                                            </li>
                                            <li><strong>A (Airway):</strong> Asegurar vía aérea permeable y proteger
                                                columna cervical.
                                            </li>
                                            <li><strong>B (Breathing):</strong> Evaluar ventilación, oxigenación y
                                                lesiones torácicas.
                                            </li>
                                            <li><strong>C (Circulation):</strong> Control de hemorragias, pulso,
                                                perfusión y choque.
                                            </li>
                                            <li><strong>D (Disability):</strong> Valoración neurológica rápida (AVDI,
                                                Glasgow).
                                            </li>
                                            <li><strong>E (Exposure/Environment):</strong> Exposición completa, búsqueda
                                                de lesiones ocultas y prevención de hipotermia.
                                            </li>
                                        </ul>
                                    </div>
                                    <div className="bg-gray-50 p-4 rounded-lg">
                                        <h3 className="font-medium text-lg mb-2 text-orange-700">Evaluación
                                            secundaria</h3>
                                        <ul className="list-disc list-inside space-y-1 text-gray-700">
                                    ...
                                    <div>
                                        <h2 className="text-2xl font-semibold mb-3 text-gray-800 border-b pb-2">Escalas
                                            y herramientas útiles</h2>
                                ...
                                <div className="space-y-8">
                                    <div>
                                        <h2 className="text-2xl font-semibold mb-3 text-gray-800 border-b pb-2">Manejo
                                            inicial y estabilización</h2>
                                        <p className="text-gray-700 leading-relaxed">
                                            El manejo prehospitalario del trauma se basa en intervenciones rápidas y
                                            efectivas para reducir la mortalidad y morbilidad. Basado en AAOS 11ª
                                            edición y PHTLS.
                                        </p>
                                    </div>
                                    <div className="grid md:grid-cols-2 gap-6">
                                        <div className="bg-orange-50 p-4 rounded-lg">
                                            <h3 className="font-medium text-lg mb-2 text-orange-700">Prioridades
                                                iniciales</h3>
                                            <ul className="list-disc list-inside space-y-1 text-gray-700">
                                    ...
                                    <div>
                                        <h2 className="text-2xl font-semibold mb-3 text-gray-800 border-b pb-2">La "hora
                                            dorada" y el transporte</h2>
                                        <p className="text-gray-700 leading-relaxed">
                                            La "hora dorada" es el periodo crítico tras una lesión grave donde la
                                            intervención médica oportuna mejora significativamente el pronóstico. El
                                            transporte debe ser expedito y seguro, priorizando el centro de trauma más
                                            adecuado.
                                        </p>
                                    </div>
                                </div>
                            ...
                            {activeTab === 'practice' && (
                                <div className="space-y-8">
                                    <h2 className="text-2xl font-semibold mb-3 text-gray-800 border-b pb-2">Casos
                                        clínicos de trauma</h2>
                                    <div className="p-5 bg-gray-50 rounded-lg shadow-sm mb-4">
                                        <h3 className="text-xl font-semibold mb-2 text-orange-600">Caso 1: Accidente
                                            vehicular de alta energía</h3>
                                        <p className="italic text-gray-600 mb-4">Hombre de 28 años, conductor de
                                            motocicleta, colisiona contra un automóvil a alta velocidad. Presenta
                                            inconsciencia breve, sangrado activo en pierna derecha y dificultad
                                            respiratoria.</p>
                                        <div className="mb-4">
                                    ...
                                    <div className="p-5 bg-gray-50 rounded-lg shadow-sm mb-4">
                                        <h3 className="text-xl font-semibold mb-2 text-blue-600">Caso 2: Caída de
                                            altura</h3>
                                        <p className="italic text-gray-600 mb-4">Mujer de 65 años cae de una escalera (2
                                            metros). Presenta dolor lumbar intenso, deformidad en tobillo izquierdo y
                                            dificultad para moverse.</p>
                                        <div className="mb-4">
                                            <h4 className="font-medium mb-2">Evaluación inicial:</h4>
                                            <ul className="list-disc list-inside space-y-1 text-gray-700">
                                    ...
                                    <div className="p-5 bg-gray-50 rounded-lg shadow-sm">
                                        <h3 className="text-xl font-semibold mb-2 text-green-600">Caso 3: Herida por
                                            arma blanca</h3>
                                        <p className="italic text-gray-600 mb-4">Varón de 35 años con herida penetrante
                                            en abdomen tras agresión. Presenta dolor abdominal intenso y signos de
                                            shock.</p>
                                        <div className="mb-4">
                                            <h4 className="font-medium mb-2">Evaluación inicial:</h4>
                                            <ul className="list-disc list-inside space-y-1 text-gray-700">
