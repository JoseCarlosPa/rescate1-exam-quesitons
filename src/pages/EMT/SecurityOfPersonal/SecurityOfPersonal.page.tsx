                    ...
                    <div className="w-full max-w-7xl">
                        ...
                        {showQuickQuiz && (
                            <div className="bg-white p-6 rounded-lg shadow-md mb-8 max-w-4xl mx-auto">
                                <h3 className="text-xl font-bold mb-4 text-gray-800">Quiz Rápido - Seguridad y
                                    bienestar</h3>
                                <button
                        ...
                        <div className="max-w-5xl mx-auto bg-white rounded-lg shadow-sm p-6 mb-8">
                                ...
                                <div className="space-y-6">
                                    <div>
                                        <h2 className="text-2xl font-semibold mb-3 text-gray-800 border-b pb-2">Importancia
                                            de la seguridad y bienestar</h2>
                                        <ul className="list-disc list-inside space-y-2 text-gray-700">
                                            <li>La seguridad del personal es la prioridad número uno en cualquier
                                                emergencia (AAOS 11ª ed.).
                                            </li>
                                            <li>Un rescatista lesionado no puede ayudar a otros y puede convertirse en
                                                una víctima más.
                                            </li>
                                            <li>El bienestar físico y mental es esencial para un desempeño óptimo y para
                                                evitar errores.
                                            </li>
                                        </ul>
                                    </div>
                                    <div>
                                        ...
                                        <ul className="list-disc list-inside space-y-2 text-gray-700">
                                            ...
                                            <li>Identificar riesgos: eléctricos, biológicos, químicos, físicos y
                                                sociales.
                                            </li>
                                    ...
                                    <div>
                                        <h2 className="text-2xl font-semibold mb-3 text-gray-800 border-b pb-2">Normas y
                                            reglamentos</h2>
                                        <ul className="list-disc list-inside space-y-2 text-gray-700">
                                            <li><strong>NOM-035-STPS-2018:</strong> Bienestar psicológico y prevención
                                                de riesgos psicosociales.
                                            </li>
                                            <li><strong>NOM-034-SSA3-2013:</strong> Seguridad y equipamiento en
                                                ambulancias.
                                            </li>
                                            <li><strong>Protocolos AAOS:</strong> Seguridad en escena, uso de EPP y
                            ...
                            {activeTab === 'epp' && (
                                <div className="space-y-6">
                                    <div>
                                        <h2 className="text-2xl font-semibold mb-3 text-gray-800 border-b pb-2">Equipo
                                            de Protección Personal (EPP)</h2>
                                        <ul className="list-disc list-inside space-y-2 text-gray-700">
                                    ...
                                    <div>
                                        <h2 className="text-2xl font-semibold mb-3 text-gray-800 border-b pb-2">Seguridad
                                            en la escena</h2>
                                        <ul className="list-disc list-inside space-y-2 text-gray-700">
                                            <li>Evaluar peligros antes de acercarse: tráfico, fuego, armas, sustancias
                                                químicas.
                                            </li>
                                    ...
                                    <div>
                                        <h2 className="text-2xl font-semibold mb-3 text-gray-800 border-b pb-2">Prevención
                                            de lesiones y riesgos</h2>
                                        <ul className="list-disc list-inside space-y-2 text-gray-700">
                                            <li>Ergonomía: técnicas correctas de levantamiento y traslado de
                                                pacientes.
                                            </li>
                            ...
                            {activeTab === 'stress' && (
                                <div className="space-y-6">
                                    <div>
                                        <h2 className="text-2xl font-semibold mb-3 text-gray-800 border-b pb-2">Estrés,
                                            fatiga y bienestar psicológico</h2>
                                        <ul className="list-disc list-inside space-y-2 text-gray-700">
                                            <li>El trabajo prehospitalario es altamente estresante y puede causar fatiga
                                                crónica.
                                            </li>
                                            <li>Reconocer signos de estrés: insomnio, irritabilidad, ansiedad,
                                                dificultad para concentrarse.
                                            </li>
                                            <li>Importancia del autocuidado: alimentación, hidratación, descanso y
                                                ejercicio.
                                            </li>
                                            <li>Buscar apoyo psicológico tras eventos traumáticos (CISM, grupos de
                                                apoyo).
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div>
                                        <h2 className="text-2xl font-semibold mb-3 text-gray-800 border-b pb-2">Bienestar
                                            integral</h2>
                                        <ul className="list-disc list-inside space-y-2 text-gray-700">
                            ...
                            {activeTab === 'practice' && (
                                <div className="space-y-6">
                                    ...
                                    <div className="p-5 bg-gray-50 rounded-lg shadow-sm mb-4">
                                        <h3 className="text-xl font-semibold mb-2 text-orange-600">Caso 1: Escena
                                            insegura</h3>
                                        <p className="italic text-gray-600 mb-4">
                                            El equipo llega a un accidente vial en carretera de noche, con tráfico
                                            activo y poca visibilidad.
                                        </p>
                                        <div>
                                    ...
                                    <div className="p-5 bg-gray-50 rounded-lg shadow-sm mb-4">
                                        <h3 className="text-xl font-semibold mb-2 text-blue-600">Caso 2: Exposición a
                                            material biológico</h3>
                                        <p className="italic text-gray-600 mb-4">
                                            Durante la atención de un paciente con hemorragia, un TAMP sufre una
                                            salpicadura de sangre en el ojo.
                                        </p>
                                        <div>
                                    ...
                                    <div className="p-5 bg-gray-50 rounded-lg shadow-sm">
                                        <h3 className="text-xl font-semibold mb-2 text-green-600">Caso 3: Estrés agudo
                                            tras evento crítico</h3>
                                        <p className="italic text-gray-600 mb-4">
                                            Tras atender un accidente con víctimas fatales, un miembro del equipo
                                            presenta insomnio y ansiedad persistente.
                                        </p>
                                        <div>
