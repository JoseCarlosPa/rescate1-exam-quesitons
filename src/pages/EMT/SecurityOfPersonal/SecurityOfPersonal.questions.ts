...
export const securityQuestions: Question[] = [
    ...
    },
    {
        ...
        "options": [
            ...
            {
                "letter": "c",
                "text": "Participar en actividades físicas fuera del trabajo y mantener una dieta equilibrada."
            },
    ...
    },
    {
        ...
        "options": [
            ...
            {
                "letter": "c",
                "text": "Esperar a la llegada de la policía o personal de seguridad para asegurar la escena."
            },
    ...
    },
    {
        ...
        "options": [
            ...
            {
                "letter": "b",
                "text": "Indicar áreas seguras y peligrosas para los equipos de emergencia y desviar el tráfico."
            },
    ...
    },
    {
        ...
        "options": [
            ...
            {
                "letter": "c",
                "text": "Evaluar cuidadosamente el entorno, usar EPP adecuado para el clima y proceder con precaución."
            },
    ...
    },
    {
        ...
        "options": [
            ...
            {
                "letter": "c",
                "text": "Mantener un equilibrio entre la vida laboral y personal, incluyendo ejercicio y dieta adecuada."
            },
    ...
    },
    {
        ...
        "options": [
            ...
            {
                "letter": "c",
                "text": "Limpiar y descontaminar exhaustivamente todo el equipo y las superficies de la ambulancia."
            },
...
export const securityChallengingQuestions: Question[] = [
    {
        ...
        options: [
            ...
            {
                letter: "b",
                text: "Retirarse inmediatamente y solicitar respaldo policial, manteniendo observación desde distancia segura"
            },
    ...
    },
    {
        ...
        options: [
            ...
            {
                letter: "b",
                text: "Solicitar al despachador cobertura de otra unidad y reportar fatiga crítica que compromete la seguridad"
            },
    ...
    },
    {
        ...
        options: [
            {
                letter: "a",
                text: "Ingresar inmediatamente con equipo de protección básico (mascarilla N95) para rescatar al paciente"
            },
            {
                letter: "b",
                text: "Establecer perímetro de seguridad, solicitar equipo HAZMAT especializado, y comenzar descontaminación de víctimas que puedan caminar"
            },
    ...
    },
    {
        ...
        options: [
            ...
            {
                letter: "b",
                text: "Colocar mascarilla quirúrgica al paciente, usar doble mascarilla quirúrgica, ventilar el área, y limitar el personal en contacto directo"
            },
    ...
    },
    {
        ...
        options: [
            {
                letter: "a",
                text: "Detenerse inmediatamente en el acotamiento y intentar controlar físicamente al paciente"
            },
            {
                letter: "b",
                text: "Conducir más rápido al hospital más cercano mientras su compañero maneja la situación"
            },
            {
                letter: "c",
                text: "Detenerse de forma segura, activar emergencia, solicitar respaldo policial, y evacuar el compartimento del conductor si es necesario"
            },
    ...
    },
    {
        ...
        options: [
            ...
            {
                letter: "b",
                text: "Reconocer los signos de estrés traumático secundario y buscar ayuda profesional inmediata"
            },
    ...
    },
    {
        ...
        options: [
            ...
            {
                letter: "b",
                text: "Establecer un punto de encuentro seguro fuera de la línea de fuego, solicitar respaldo policial urgente, y esperar aseguración de la escena"
            },
    ...
    },
    {
        ...
        options: [
            ...
            {
                letter: "b",
                text: "Reportar inmediatamente las preocupaciones al supervisor para proteger la seguridad del paciente"
            },
    ...
    },
    {
        ...
        options: [
            ...
            {
                letter: "b",
                text: "Establecer perímetro de seguridad amplio, controlar tráfico, confirmar estado de cables eléctricos, y evaluar estabilidad de vehículos antes de acceder a pacientes"
            },
            {
                letter: "c",
                text: "Enviar a un miembro del equipo a verificar los cables mientras el otro comienza atención"
            },
    ...
    },
    {
        ...
        options: [
            {
                letter: "a",
                text: "Subir rápidamente, apagar todos los equipos electrónicos, y evacuar al paciente inmediatamente"
            },
            {
                letter: "b",
                text: "Establecer zona de seguridad, solicitar departamento de bomberos para evaluación de gases, y preparar para recibir al paciente si otros pueden evacuarlo"
            },
