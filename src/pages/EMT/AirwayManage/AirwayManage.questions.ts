...
export const airwayManagementQuestions: Question[] = [
    ...
    },
    {
        ...
        options: [
            ...
            {
                letter: "b",
                text: "Un paciente con lesiones faciales graves y sospecha de fractura de la base del cráneo"
            },
    ...
    },
    {
        ...
        options: [
            ...
            {
                letter: "d",
                text: "Abrir la vía aérea (frente-mentón), insertar una OPA si no hay reflejo nauseoso, y ventilar con BVM"
            },
        ],
        correctAnswer: "d",
    },
...
export const airwayManagementChallengingQuestions: Question[] = [
    {
        ...
        options: [
            ...
            {
                letter: "b",
                text: "Preparación inmediata para intubación temprana antes de que el edema laríngeo cause obstrucción completa, considerando cricotirotomía como respaldo"
            },
    ...
    },
    {
        ...
        options: [
            ...
            {
                letter: "b",
                text: "Abandonar intubación inmediatamente, ventilar con BVM, considerar dispositivo supraglótico, y preparar vía aérea quirúrgica si persiste falla ventilatoria"
            },
    ...
    },
    {
        ...
        options: [
            ...
            {
                letter: "b",
                text: "Posición de rampa (elevación de cabeza y hombros), sellado hermético con dos personas en BVM, preparación para intubación rápida o dispositivo supraglótico debido a desaturación acelerada"
            },
    ...
    },
    {
        ...
        options: [
            {
                letter: "a",
                text: "Intentar ventilación a presión positiva para empujar el objeto hacia bronquio principal"
            },
            {
                letter: "b",
                text: "Maniobras de desobstrucción (Heimlich modificado para niños), posición de confort, oxígeno humidificado, preparación para manejo avanzado si hay deterioro"
            },
    ...
    },
    {
        ...
        options: [
            ...
            {
                letter: "b",
                text: "Selección cuidadosa de agentes: evitar succinilcolina si hay trauma craneal (riesgo de hiperkalemia), usar etomidato con precaución en shock (supresión adrenal), considerar ketamina para inducción en pacientes inestables"
            },
    ...
    },
    {
        ...
        options: [
            ...
            {
                letter: "b",
                text: "Usar videolaringoscopio si disponible, considerar dispositivo supraglótico como primera línea, preparar vía aérea quirúrgica, evitar relajantes musculares hasta asegurar ventilación"
            },
    ...
    },
    {
        ...
        options: [
            ...
            {
                letter: "b",
                text: "Posición con elevación del flanco derecho para evitar compresión aortocava, preoxigenación acortada por reserva funcional reducida, mayor riesgo de aspiración, edema que puede dificultar visualización"
            },
    ...
    },
    {
        ...
        options: [
            ...
            {
                letter: "b",
                text: "Auto-PEEP por atrapamiento aéreo - reducir frecuencia respiratoria, permitir espiración completa, considerar desconexión temporal del ventilador"
            },
    ...
    },
    {
        ...
        options: [
            ...
            {
                letter: "b",
                text: "Evaluar compliance pulmonar, descartar neumotórax, broncoespasmo, o progresión de SDRA, ajustar estrategia ventilatoria a 'ventilación protectiva pulmonar'"
            },
    ...
    },
    {
        ...
        options: [
            ...
            {
                letter: "b",
                text: "Posición lateral de seguridad, aspiración agresiva, sedación controlada para prevenir autoextubación, monitoreo por síndrome de abstinencia y re-narcotización"
            },
