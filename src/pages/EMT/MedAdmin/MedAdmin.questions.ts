...
export const medicationAdministrationChallengeQuestions: Question[] = [
    {
        ...
        options: [
            ...
            {
                letter: "b",
                text: "La nitroglicerina puede causar vasodilatación venosa y arterial progresiva; suspender administración, posición Trendelenburg, acceso IV, y considerar que la hipotensión severa puede comprometer perfusión coronaria"
            },
    ...
    },
    {
        ...
        options: [
            ...
            {
                letter: "b",
                text: "La epinefrina 1:1000 IV causa estimulación masiva alfa y beta adrenérgica; manejo incluye monitoreo cardíaco continuo, beta-bloqueadores de acción corta si disponibles, nitroglicerina para hipertensión, y preparación para arritmias malignas"
            },
    ...
    },
    {
        ...
        options: [
            ...
            {
                letter: "b",
                text: "Glucagón 1 mg intramuscular - moviliza glucógeno hepático independientemente de la vía oral, efectivo en 10-20 minutos"
            },
    ...
    },
    {
        ...
        options: [
            ...
            {
                letter: "b",
                text: "Los efectos beta-2 selectivos del albuterol pueden causar estimulación beta-1 cardíaca; continuar tratamiento con monitoreo cardíaco estrecho, considerar dosis menores o intervalos más largos"
            },
    ...
    },
    {
        ...
        options: [
            ...
            {
                letter: "b",
                text: "Balance entre analgesia necesaria y depresión respiratoria: naloxona titulada en dosis pequeñas (0.04-0.08 mg) para revertir depresión respiratoria manteniendo algo de analgesia, ventilación asistida si es necesario"
            },
    ...
    },
    {
        ...
        options: [
            ...
            {
                letter: "b",
                text: "Manejo de reacción alérgica leve-moderada: difenhidramina, corticosteroides, monitoreo estrecho de vía aérea, pero continuar con otros antiagregantes (clopidogrel) si están indicados"
            },
    ...
    },
    {
        ...
        options: [
            ...
            {
                letter: "b",
                text: "La ventana de efectividad del carbón activado se cierra rápidamente; considerar anti-eméticos (ondansetrón), administrar carbón en dosis menores y más frecuentes, o considerar otras intervenciones como N-acetilcisteína temprana"
            },
    ...
    },
    {
        ...
        options: [
            ...
            {
                letter: "b",
                text: "La dextrosa 50% es altamente hipertónica; tratamiento incluye elevación del miembro, compresas tibias, hialuronidasa subcutánea para dispersar la solución, y monitoreo de síndrome compartimental"
            },
    ...
    },
    {
        ...
        options: [
            ...
            {
                letter: "b",
                text: "La cardioversión con anticoagulación supra-terapéutica aumenta riesgo embólico paradójico; considerar reversión parcial con vitamina K, plasma fresco congelado, o complejo protrombínico, balanceando riesgo hemorrágico vs embólico"
            },
    ...
    },
    {
        ...
        options: [
            ...
            {
                letter: "b",
                text: "Glucagón 5-10 mg IV - bypasa el bloqueo beta-adrenérgico activando adenilciclasa por vía independiente, mejorando cronotropismo e inotropismo"
            },
