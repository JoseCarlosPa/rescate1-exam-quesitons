...
export const medicationAdministrationQuestions: Question[] = [
    ...
    {
        question: "¿Cuál de las siguientes vías permite absorción directa hacia los pulmones?",
        options: [
            { letter: "a", text: "Sublingual" },
            { letter: "b", text: "Intramuscular" },
            { letter: "c", text: "Oral" },
    ...
    {
        question: "¿Qué vía se recomienda para administración de glucosa en pacientes conscientes?",
        options: [
            { letter: "a", text: "Intramuscular" },
            { letter: "b", text: "Oral" },
            { letter: "c", text: "Intravenosa" },
    ...
    {
        question: "¿Qué vía tiene mayor riesgo de infección si no se maneja correctamente?",
        options: [
            { letter: "a", text: "Inhalada" },
            { letter: "b", text: "Intramuscular" },
            { letter: "c", text: "Oral" },
            { letter: "d", text: "Sublingual" },
        ],
    ...
    {
        question: "¿Qué vía es usada para administrar medicamentos como nitroglicerina en emergencias?",
        options: [
            { letter: "a", text: "Intramuscular" },
            { letter: "b", text: "Oral" },
            { letter: "c", text: "Sublingual" },
    ...
    {
        question: "¿Qué vía es adecuada para administrar medicamentos a pacientes inconscientes?",
        options: [
            { letter: "a", text: "Oral" },
            { letter: "b", text: "Intravenosa" },
            { letter: "c", text: "Sublingual" },
    ...
    {
        question: "¿Qué vía requiere que el paciente sea capaz de tragar adecuadamente?",
        options: [
            { letter: "a", text: "Oral" },
            { letter: "b", text: "Intramuscular" },
            { letter: "c", text: "Intravenosa" },
    ...
    {
        question: "¿Qué complicación puede ocurrir si se administra un medicamento por vía oral en un paciente inconsciente?",
        options: [
            { letter: "a", text: "Hipoglucemia" },
            { letter: "b", text: "Broncoaspiración" },
            { letter: "c", text: "Hipertensión" },
            { letter: "d", text: "Fiebre alta" },
        ],
        correctAnswer: "b",
    },
    {
        question: "¿Qué medicamento administrado por vía inhalada mejora el intercambio gaseoso en pulmones?",
        options: [
            { letter: "a", text: "Epinefrina" },
            { letter: "b", text: "Oxígeno" },
            { letter: "c", text: "Carbón activado" },
            { letter: "d", text: "Glucosa" },
        ],
        correctAnswer: "b",
    },
    {
        question: "¿Qué vía de administración ofrece efecto casi inmediato en el cuerpo?",
        options: [
            { letter: "a", text: "Intravenosa" },
            { letter: "b", text: "Oral" },
    ...
    {
        question: "¿Qué documento debes completar después de administrar un medicamento?",
        options: [
            { letter: "a", text: "Reporte policial" },
            { letter: "b", text: "Registro médico de administración" },
            { letter: "c", text: "Carta de consentimiento" },
            { letter: "d", text: "Factura de servicios" },
        ],
        correctAnswer: "b",
    },
    {
        question: "¿Qué parámetro clínico puede mejorar tras administrar oxígeno suplementario?",
        options: [
            { letter: "a", text: "Presión arterial" },
            { letter: "b", text: "Nivel de saturación de oxígeno" },
            { letter: "c", text: "Frecuencia urinaria" },
            { letter: "d", text: "Nivel de glucosa" },
        ],
        correctAnswer: "b",
    },
    {
        question: "¿Qué vía de administración es utilizada comúnmente para medicamentos broncodilatadores?",
        options: [
            { letter: "a", text: "Intravenosa" },
            { letter: "b", text: "Oral" },
            { letter: "c", text: "Inhalada" },
    ...
    {
        question: "¿Qué factor puede retardar la absorción de un medicamento administrado oralmente?",
        options: [
            { letter: "a", text: "Alta frecuencia respiratoria" },
            { letter: "b", text: "Alimentos en el estómago" },
            { letter: "c", text: "Pulso acelerado" },
            { letter: "d", text: "Baja saturación de oxígeno" },
        ],
        correctAnswer: "b",
    },
    {
        question: "¿Qué se debe hacer antes de administrar un medicamento a través de vía intravenosa?",
        options: [
            { letter: "a", text: "Evaluar sitio de inyección" },
            { letter: "b", text: "Medir saturación de oxígeno" },
            { letter: "c", text: "Revisar temperatura corporal" },
            { letter: "d", text: "Tomar frecuencia respiratoria" },
        ],
        correctAnswer: "a",
    },
    {
        question: "¿Qué vía proporciona liberación lenta y prolongada de medicamentos?",
        options: [
            { letter: "a", text: "Intravenosa" },
            { letter: "b", text: "Sublingual" },
            { letter: "c", text: "Intramuscular" },
    ...
    {
        question: "¿Qué reacción adversa grave puede ocurrir con la administración errónea de epinefrina?",
        options: [
            { letter: "a", text: "Hipotensión severa" },
            { letter: "b", text: "Bradicardia" },
            { letter: "c", text: "Taquicardia extrema e hipertensión" },
