                        ...
                        <div className="max-w-5xl mx-auto bg-white rounded-lg shadow-sm p-6 mb-8">
                                ...
                                <div className="space-y-8">
                                    ...
                                    <div
                                        ...
                                        <p className="text-gray-800 leading-relaxed text-lg">
                                            La inmovilización inadecuada puede convertir una <strong>lesión cerrada en
                                            abierta</strong>,
                                            causando daño neurovascular permanente. Cada movimiento incorrecto puede
                                            significar
                                    ...
                                    <div>
                                        ...
                                        <div className="grid md:grid-cols-3 gap-6">
                                            <div
                                                ...
                                                <h3 className="text-xl font-bold text-blue-700 mb-3 text-center">C -
                                                    CIRCULACIÓN</h3>
                                            ...
                                            <div
                                                ...
                                                <h3 className="text-xl font-bold text-green-700 mb-3 text-center">S -
                                                    SENSIBILIDAD</h3>
                                                <ul className="space-y-2 text-gray-700">
                                                    <li className="flex items-start">
                                            ...
                                            <div
                                                ...
                                                <h3 className="text-xl font-bold text-orange-700 mb-3 text-center">M -
                                                    MOVIMIENTO</h3>
                                                <ul className="space-y-2 text-gray-700">
                                                    <li className="flex items-start">
                                    ...
                                    <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-4">
                                            ...
                                            <div>
                                                <h4 className="font-semibold text-yellow-800 mb-2">Síndrome
                                                    Compartimental:</h4>
                                                <ul className="list-disc list-inside space-y-1 text-gray-700">
                                    ...
                                    <div>
                                        <h2 className="text-2xl font-semibold mb-4 text-gray-800 border-b pb-2">Principios
                                            Fundamentales de Inmovilización</h2>
                                    ...
                                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                                        <div className="flex items-center mb-4">
                                            ...
                                            <h3 className="text-xl font-bold text-blue-800">Objetivos de la
                                                Inmovilización</h3>
                                        </div>
                                        <div className="grid md:grid-cols-2 gap-6">
                                            <div>
                                                <h4 className="font-semibold text-blue-800 mb-2">Objetivos
                                                    Inmediatos:</h4>
                                                <ol className="list-decimal list-inside space-y-1 text-gray-700">
                                                    <li><strong>Prevenir mayor daño:</strong> Evitar lesión de tejidos,
                                                        vasos y nervios
                                                    </li>
                                                    <li><strong>Reducir dolor:</strong> Limitar movimiento y espasmo
                                                        muscular
                                                    </li>
                                                    <li><strong>Controlar hemorragia:</strong> Estabilizar fragmentos
                                                        óseos
                                                    </li>
                                                    <li><strong>Prevenir shock:</strong> Minimizar pérdida sanguínea
                                                    </li>
                                                </ol>
                                            </div>
                                            <div>
                                                <h4 className="font-semibold text-blue-800 mb-2">Objetivos a Largo
                                                    Plazo:</h4>
                                                <ol className="list-decimal list-inside space-y-1 text-gray-700">
                                                    <li><strong>Facilitar transporte:</strong> Permitir movilización
                                                        segura
                                                    </li>
                                                    <li><strong>Favorecer cicatrización:</strong> Alineación apropiada
                                                        del hueso
                                                    </li>
                                                    <li><strong>Preservar función:</strong> Mantener integridad
                                                        neurovascular
                                                    </li>
                                                    <li><strong>Reducir complicaciones:</strong> Evitar embolia grasa y
                            ...
                            {activeTab === 'materials' && (
                                <div className="space-y-8">
                                        ...
                                        <div className="grid lg:grid-cols-2 gap-8">
                                            <div>
                                                <div className="bg-blue-50 p-6 rounded-lg border border-blue-200 mb-6">
                                                    <h3 className="text-xl font-bold text-blue-700 mb-4">Inmovilización
                                                        Espinal</h3>
                                                    <div className="space-y-4">
                                                        <div className="flex items-start space-x-3">
                                                            ...
                                                            <div>
                                                                ...
                                                                <p className="text-sm text-gray-600">Rígido de una
                                                                    pieza, con soporte mentoniano y occipital</p>
                                                                <p className="text-xs text-blue-600 mt-1">Tallas:
                                                                    Pediátrico, Pequeño, Mediano, Grande</p>
                                                            </div>
                                                        </div>
                                                        <div className="flex items-start space-x-3">
                                                            <div
                                                            ...
                                                            <div>
                                                                ...
                                                                <p className="text-sm text-gray-600">Inmovilización
                                                                    completa, radiotransparente</p>
                                                                <p className="text-xs text-blue-600 mt-1">Incluye:
                                                                    Sujetadores, inmovilizadores laterales</p>
                                                            </div>
                                                        </div>
                                                        <div className="flex items-start space-x-3">
                                                            <div
                                                                className="w-3 h-3 bg-blue-500 rounded-full mt-2"></div>
                                                            <div>
                                                                <h4 className="font-semibold">Chaleco de Extricación
                                                                    (KED)</h4>
                                                                <p className="text-sm text-gray-600">Para extracción
                                                                    vehicular y espacios confinados</p>
                                                                <p className="text-xs text-blue-600 mt-1">Tiempo de
                                                                    aplicación: 8-12 minutos</p>
                                                            </div>
                                                        </div>
                                                        <div className="flex items-start space-x-3">
                                                            <div
                                                            ...
                                                            <div>
                                                                ...
                                                                <p className="text-sm text-gray-600">Transferencia con
                                                                    mínimo movimiento</p>
                                                                <p className="text-xs text-blue-600 mt-1">Ideal para:
                                                                    Espacios reducidos, trauma múltiple</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div>
                                                <div className="bg-green-50 p-6 rounded-lg border border-green-200">
                                                    <h3 className="text-xl font-bold text-green-700 mb-4">Férulas para
                                                        Extremidades</h3>
                                                    <div className="space-y-4">
                                                        <div className="flex items-start space-x-3">
                                                            <div
                                                            ...
                                                            <div>
                                                                ...
                                                                <p className="text-sm text-gray-600">SAM splint, férulas
                                                                    de cartón, madera</p>
                                                                <p className="text-xs text-green-600 mt-1">Ventaja:
                                                                    Soporte firme, reusables</p>
                                                            </div>
                                                        </div>
                                                        <div className="flex items-start space-x-3">
                                                            <div
                                                            ...
                                                            <div>
                                                                ...
                                                                <p className="text-sm text-gray-600">Inflables,
                                                                    transparentes para observación</p>
                                                                <p className="text-xs text-green-600 mt-1">Precaución:
                                                                    Cambios de presión por altitud</p>
                                                            </div>
                                                        </div>
                                                        <div className="flex items-start space-x-3">
                                                            <div
                                                            ...
                                                            <div>
                                                                ...
                                                                <p className="text-sm text-gray-600">Se moldean a
                                                                    cualquier deformidad</p>
                                                                <p className="text-xs text-green-600 mt-1">Ideal:
                                                                    Fracturas anguladas, articulaciones</p>
                                                            </div>
                                                        </div>
                                                        <div className="flex items-start space-x-3">
                                                            <div
                                                            ...
                                                            <div>
                                                                ...
                                                                <p className="text-sm text-gray-600">Hare, Sager,
                                                                    Kendrick para fracturas de fémur</p>
                                                                <p className="text-xs text-green-600 mt-1">Reduce:
                                                                    Dolor, sangrado, espasmo muscular</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div>
                                        <h3 className="text-xl font-semibold mb-4">Comparación de Dispositivos por
                                            Región</h3>
                                        <div className="overflow-x-auto">
                                            <table className="min-w-full bg-white border rounded-lg">
                                                ...
                                                <tr>
                                                    ...
                                                    <th className="py-3 px-4 border text-center">Dispositivo Preferido
                                                    </th>
                                                ...
                                                <tr className="hover:bg-gray-50">
                                                    ...
                                                    <td className="py-3 px-4 border text-center">Collarín rígido +
                                                        tabla
                                                    </td>
                                                    <td className="py-3 px-4 border text-center">KED</td>
                                                    <td className="py-3 px-4 border text-center">Penetrante en cuello
                                                    </td>
                                                    <td className="py-3 px-4 border text-center">2-3 min</td>
                                                </tr>
                                                <tr className="hover:bg-gray-50">
                                                    <td className="py-3 px-4 border font-medium">Húmero</td>
                                                    <td className="py-3 px-4 border text-center">SAM splint +
                                                        cabestrillo
                                                    </td>
                                                    <td className="py-3 px-4 border text-center">Férula de vacío</td>
                                                    <td className="py-3 px-4 border text-center">Fractura abierta
                                                        severa
                                                    </td>
                                                ...
                                                <tr className="hover:bg-gray-50">
                                                    ...
                                                    <td className="py-3 px-4 border text-center">Férula rígida
                                                        bilateral
                                                    </td>
                                                    <td className="py-3 px-4 border text-center">Férula neumática</td>
                                                    <td className="py-3 px-4 border text-center">Síndrome
                                                        compartimental
                                                    </td>
                                                ...
                                                <tr className="hover:bg-gray-50">
                                                    ...
                                                    <td className="py-3 px-4 border text-center">Herida con sangrado
                                                        activo
                                                    </td>
                                                ...
                                                <tr className="hover:bg-gray-50">
                                                    ...
                                                    <td className="py-3 px-4 border text-center">Luxación con compromiso
                                                        vascular
                                                    </td>
                                    ...
                                    <div>
                                        <h3 className="text-xl font-semibold mb-4">Materiales de Sujeción y
                                            Acolchamiento</h3>
                                        <div className="grid md:grid-cols-3 gap-6">
                                            <div className="bg-orange-50 p-6 rounded-lg border border-orange-200">
                                                ...
                                                <ul className="space-y-2 text-gray-700">
                                                    <li className="flex items-start">
                                                        ...
                                                        <div>
                                                            <strong>Araña de sujeción:</strong> Sistema de correas para
                                                            tabla espinal
                                                        </div>
                                                    </li>
                                                    <li className="flex items-start">
                                                    ...
                                                    <li className="flex items-start">
                                                        <span
                                                            className="w-2 h-2 bg-orange-500 rounded-full mt-2 mr-2"></span>
                                                        <div>
                                                            <strong>Correas con hebilla:</strong> Sujeción firme y
                                                            segura
                                                        </div>
                                                    </li>
                                                </ul>
                                                ...
                                                <ul className="space-y-2 text-gray-700">
                                                    ...
                                                    <li className="flex items-start">
                                                        <span
                                                            className="w-2 h-2 bg-green-500 rounded-full mt-2 mr-2"></span>
                                                        <div>
                                                            <strong>Rollos de gasa:</strong> Separar dedos, rellenar
                                                            espacios
                                                        </div>
                                                    </li>
                                                    <li className="flex items-start">
                                    ...
                                    <div className="bg-purple-50 border border-purple-200 rounded-lg p-6">
                                        ...
                                        <div className="grid md:grid-cols-3 gap-6">
                                            <div>
                                                <h4 className="font-semibold text-purple-800 mb-2">Pacientes
                                                    Pediátricos:</h4>
                            ...
                            {activeTab === 'techniques' && (
                                <div className="space-y-8">
                                        ...
                                        <div className="grid lg:grid-cols-2 gap-6">
                                            <div className="bg-white p-6 rounded-lg shadow-sm">
                                                ...
                                                <ol className="list-decimal list-inside space-y-2 text-sm text-gray-700">
                                                    ...
                                                    <li><strong>ABC primario:</strong> Vía aérea, respiración,
                                                        circulación
                                                    </li>
                                                    <li><strong>Exposición:</strong> Quitar ropa y joyas de la zona</li>
                                                    <li><strong>Inspección:</strong> Deformidad, edema, equimosis</li>
                                                    <li><strong>Palpación:</strong> Dolor, crepitación, inestabilidad
                                                    </li>
                                                    <li><strong>CSM inicial:</strong> Documentar antes de inmovilizar
                                                    </li>
                                                </ol>
                                            </div>
                                            <div className="bg-white p-6 rounded-lg shadow-sm">
                                                <h4 className="font-bold text-orange-700 mb-3">🔧 APLICACIÓN DEL
                                                    DISPOSITIVO</h4>
                                                <ol className="list-decimal list-inside space-y-2 text-sm text-gray-700">
                                                    <li><strong>Selección:</strong> Dispositivo apropiado y talla</li>
                                                    <li><strong>Preparación:</strong> Acolchamiento en puntos de presión
                                                    </li>
                                    ...
                                    <div className="space-y-6">
                                        <h3 className="text-xl font-bold text-gray-800">Técnicas Específicas por
                                            Región</h3>
                                        ...
                                        <div className="p-6 bg-red-50 rounded-lg border border-red-200">
                                            ...
                                            <div className="grid lg:grid-cols-2 gap-6">
                                                <div>
                                                    <h5 className="font-semibold text-red-800 mb-2">Técnica Log-Roll
                                                        (Volteo en Bloque):</h5>
                                                ...
                                                <div>
                                                    <h5 className="font-semibold text-red-800 mb-2">Aplicación de
                                                        Collarín Cervical:</h5>
                                                    <ol className="list-decimal list-inside space-y-1 text-sm text-gray-700">
                                            ...
                                            <div className="mt-4 p-4 bg-white rounded border border-red-300">
                                                <p className="text-sm text-red-700">
                                                    <strong>⚠️ ADVERTENCIA:</strong> Nunca liberar estabilización manual
                                                    hasta que el paciente esté
                                                    completamente inmovilizado en tabla espinal con sujeciones y
                                                    collarín aplicado.
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="p-6 bg-blue-50 rounded-lg border border-blue-200">
                                            ...
                                            <div className="grid lg:grid-cols-3 gap-4">
                                                <div>
                                                    <h5 className="font-semibold text-blue-800 mb-2">Húmero
                                                        (Brazo):</h5>
                                        ...
                                        <div className="p-6 bg-green-50 rounded-lg border border-green-200">
                                            ...
                                            <div className="grid lg:grid-cols-2 gap-6">
                                                <div>
                                                    <h5 className="font-semibold text-green-800 mb-2">Fractura de Fémur
                                                        - Férula de Tracción:</h5>
                                                    <ol className="list-decimal list-inside space-y-1 text-sm text-gray-700">
                                                    ...
                                                    <div className="mt-2 p-2 bg-white rounded border border-green-300">
                                                        <p className="text-xs text-green-700">
                                                            <strong>Contraindicaciones:</strong> Fractura de cadera,
                                                            rodilla, tobillo, o herida abierta severa
                                                        </p>
                                                    </div>
                                                </div>
                                                <div>
                                                    ...
                                                    <ul className="list-disc list-inside space-y-2 text-sm text-gray-700">
                                                        <li><strong>Férula de vacío:</strong> Ideal para deformidades
                                                        </li>
                                                        <li><strong>SAM splint:</strong> Férula en U desde ingle hasta
                                                            pie
                                                        </li>
                                                        <li><strong>Incluir articulaciones:</strong> Rodilla y tobillo
                                                        </li>
                                        ...
                                        <div className="p-6 bg-yellow-50 rounded-lg border border-yellow-200">
                                            <h4 className="font-bold text-yellow-700 mb-4">Consideraciones
                                                Especiales</h4>
                                            <div className="grid lg:grid-cols-2 gap-6">
                                                <div>
                                                    <h5 className="font-semibold text-yellow-800 mb-2">Fracturas
                                                        Abiertas:</h5>
                                                    <ul className="list-disc list-inside space-y-1 text-sm text-gray-700">
                                    ...
                                    <div className="bg-red-50 border border-red-200 rounded-lg p-6">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-6">
                                            <div>
                                                <h4 className="font-semibold text-red-800 mb-2">❌ Errores
                                                    Frecuentes:</h4>
                                                <ul className="list-disc list-inside space-y-1 text-gray-700">
                                            ...
                                            <div>
                                                <h4 className="font-semibold text-green-800 mb-2">✅ Cómo Prevenir
                                                    Errores:</h4>
                                                <ul className="list-disc list-inside space-y-1 text-gray-700">
                            ...
                            {activeTab === 'practice' && (
                                <div className="space-y-8">
                                    ...
                                    <div className="p-6 bg-red-50 rounded-lg shadow-sm border border-red-200">
                                        ...
                                        <div className="bg-white p-4 rounded-lg mb-4">
                                            <p className="italic text-gray-600 mb-3">
                                                <strong>Escenario:</strong> Motociclista de 28 años impacta contra
                                                automóvil a 60 km/h.
                                                Se encuentra consciente, con dolor intenso en pierna derecha. Hay
                                                deformidad evidente
                                                en tercio medio de tibia con exposición ósea de 3 cm y sangrado moderado
                                                activo.
                                            </p>
                                            <div className="grid lg:grid-cols-2 gap-4">
                                                <div>
                                                    <h4 className="font-medium mb-2 text-gray-800">📋 Evaluación
                                                        Inicial:</h4>
                                                    <ul className="list-disc list-inside space-y-1 text-sm text-gray-700">
                                                        <li><strong>A:</strong> Vía aérea permeable, habla
                                                            coherentemente
                                                        </li>
                                                        <li><strong>B:</strong> FR 24/min, SpO₂ 98%, expansión simétrica
                                                        </li>
                                                        <li><strong>C:</strong> FC 110/min, TA 120/85, pulso radial
                                                            fuerte
                                                        </li>
                                                        <li><strong>D:</strong> Alerta (GCS 15), dolor severo (8/10)
                                                        </li>
                                                        <li><strong>E:</strong> Fractura abierta tibia Dx, sangrado
                                                            50ml/min
                                                        </li>
                                                        <li><strong>CSM:</strong> Pulso pedío débil, parestesias en pie,
                                                            no movimiento activo
                                                        </li>
                                                    </ul>
                                                </div>
                                                <div>
                                                    <h4 className="font-medium mb-2 text-gray-800">🚨 Signos de
                                                        Alerta:</h4>
                                        ...
                                        <div className="grid lg:grid-cols-2 gap-4">
                                            <div className="bg-green-50 p-4 rounded border border-green-300">
                                                <h4 className="font-bold text-green-700 mb-2">✅ Manejo Correcto
                                                    Secuencial:</h4>
                                                <ol className="list-decimal list-inside space-y-1 text-sm text-gray-700">
                                                    <li><strong>Control hemorrágico:</strong> Presión directa + apósito
                                                        estéril
                                                    </li>
                                                    <li><strong>Analgesia:</strong> Fentanyl 2 μg/kg IV (protocolo
                                                        local)
                                                    </li>
                                                    <li><strong>Irrigación:</strong> 500ml SSN estéril sobre herida</li>
                                                    <li><strong>Cobertura:</strong> Gasa estéril húmeda, no secar</li>
                                                    <li><strong>Evaluación CSM:</strong> Documentar antes de inmovilizar
                                                    </li>
                                                    <li><strong>Inmovilización:</strong> Férula de vacío incluyendo
                                                        rodilla-tobillo
                                                    </li>
                                                    <li><strong>Elevación:</strong> 15° sobre nivel cardíaco</li>
                                                    <li><strong>Reevaluación:</strong> CSM cada 15 min durante
                                                        transporte
                                                    </li>
                                                    <li><strong>Traslado código rojo:</strong> Centro de trauma nivel I
                                                    </li>
                                                </ol>
                                            </div>
                                            <div className="bg-yellow-50 p-4 rounded border border-yellow-300">
                                                <h4 className="font-bold text-yellow-700 mb-2">🎯 Puntos Clave de
                                                    Aprendizaje:</h4>
                                                <ul className="list-disc list-inside space-y-1 text-sm text-gray-700">
                                                    <li><strong>Prioridad 1:</strong> Control de sangrado antes que
                                                        inmovilización
                                                    </li>
                                                    <li><strong>NO reintroducir</strong> hueso expuesto bajo ninguna
                                                        circunstancia
                                                    </li>
                                                    <li><strong>Irrigación:</strong> Solo con SSN estéril, no agua del
                                                        grifo
                                                    </li>
                                                    <li><strong>Tiempo crítico:</strong> En hospital &lt;60 min (golden
                                                        hour)
                                                    </li>
                                                    <li><strong>Documentación:</strong> CSM seriado fundamental para
                                                        cirugía
                                                    </li>
                                                    <li><strong>Comunicación:</strong> Alertar trauma team sobre
                                                        compromiso vascular
                                                    </li>
                                                </ul>
                                            </div>
                                    ...
                                    <div className="p-6 bg-blue-50 rounded-lg shadow-sm border border-blue-200">
                                        ...
                                        <div className="bg-white p-4 rounded-lg mb-4">
                                            <p className="italic text-gray-600 mb-3">
                                                <strong>Escenario:</strong> Adolescente de 17 años se lanza de clavado
                                                en piscina poco profunda.
                                                Los testigos refieren que flotó inmóvil hasta ser rescatado. Se
                                                encuentra consciente pero
                                            ...
                                            <div className="grid lg:grid-cols-2 gap-4">
                                                <div>
                                                    ...
                                                    <ul className="list-disc list-inside space-y-1 text-sm text-gray-700">
                                                        ...
                                                        <li><strong>B:</strong> Respiración diafragmática, FR 28/min
                                                        </li>
                                                        <li><strong>C:</strong> Bradicardia 50/min, TA 90/60 (shock
                                                            espinal)
                                                        </li>
                                                        <li><strong>D:</strong> Consciente, cuadriplejia flácida C5</li>
                                                        <li><strong>E:</strong> Hipotermia 35°C, priapismo presente</li>
                                                        <li><strong>Sensibilidad:</strong> Ausente bajo nivel C5
                                                            bilateral
                                                        </li>
                                                    </ul>
                                                </div>
                                                <div>
                                                    <h4 className="font-medium mb-2 text-gray-800">🔍 Hallazgos
                                                        Críticos:</h4>
                                                    <ul className="list-disc list-inside space-y-1 text-sm text-red-700">
                                        ...
                                        <div className="grid lg:grid-cols-2 gap-4">
                                            <div className="bg-red-50 p-4 rounded border border-red-300">
                                                ...
                                                <ol className="list-decimal list-inside space-y-1 text-sm text-gray-700">
                                                    <li><strong>Estabilización inmediata:</strong> Manual en línea, SIN
                                                        tracción
                                                    </li>
                                                    <li><strong>Vía aérea:</strong> Preparar para intubación (compromiso
                                                        respiratorio)
                                                    </li>
                                                    <li><strong>Oxigenación:</strong> VM con BVM si SpO₂ &lt;95%</li>
                                                    <li><strong>Acceso vascular:</strong> 2 líneas IV calibre grueso
                                                    </li>
                                                    <li><strong>Collarín cervical:</strong> Talla exacta, sin comprimir
                                                    </li>
                                                    <li><strong>Log-roll:</strong> Mínimo 4 personas, líder en cabeza
                                                    </li>
                                                    <li><strong>Inmovilización completa:</strong> Tabla + sujeciones +
                                                        bloques laterales
                                                    </li>
                                                    <li><strong>Monitorización:</strong> ECG, TA, SpO₂, EtCO₂ continua
                                                    </li>
                                                    <li><strong>Temperatura:</strong> Mantas térmicas, calentamiento
                                                        activo
                                                    </li>
                                                </ol>
                                            </div>
                                            <div className="bg-purple-50 p-4 rounded border border-purple-300">
                                                <h4 className="font-bold text-purple-700 mb-2">🧠 Conceptos
                                                    Neurofisiológicos:</h4>
                                                <ul className="list-disc list-inside space-y-1 text-sm text-gray-700">
                                                    <li><strong>Shock espinal:</strong> Pérdida temporal función por
                                                        edema
                                                    </li>
                                                    <li><strong>Lesión primaria:</strong> Daño mecánico inicial
                                                        irreversible
                                                    </li>
                                                    <li><strong>Lesión secundaria:</strong> Hipoxia, hipotensión
                                                        (PREVENIBLE)
                                                    </li>
                                                    <li><strong>Ventana terapéutica:</strong> 8 horas para
                                                        neuroprotección
                                                    </li>
                                                    <li><strong>Metilprednisolona:</strong> Ya no recomendada (evidencia
                                                        negativa)
                                                    </li>
                                                    <li><strong>Hipotensión permisiva:</strong> NO en trauma espinal
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div className="p-6 bg-green-50 rounded-lg shadow-sm border border-green-200">
                                        ...
                                        <div className="bg-white p-4 rounded-lg mb-4">
                                            <p className="italic text-gray-600 mb-3">
                                                <strong>Escenario:</strong> Trabajador de construcción de 45 años cae
                                                desde 4 metros de altura.
                                                Impacta de pie, presenta dolor severo en muslo izquierdo con deformidad,
                                                acortamiento
                                                y rotación externa. Paciente ansioso, diaforético, con signos de shock
                                                compensado.
                                            </p>
                                            <div className="grid lg:grid-cols-2 gap-4">
                                                <div>
                                                    <h4 className="font-medium mb-2 text-gray-800">📊 Signos Vitales
                                                        Seriados:</h4>
                                                    <div className="text-sm text-gray-700">
                                                        <p><strong>Inicial:</strong> FC 125, TA 100/70, FR 28, SpO₂ 94%
                                                        </p>
                                                        <p><strong>5 min:</strong> FC 135, TA 95/65, FR 32, SpO₂ 92%</p>
                                                        <p><strong>10 min:</strong> FC 145, TA 90/60, FR 36, SpO₂ 90%
                                                        </p>
                                                    </div>
                                                    <ul className="list-disc list-inside space-y-1 text-sm text-gray-700 mt-2">
                                                        <li><strong>Deformidad:</strong> Acortamiento 4 cm, rotación
                                                            externa 45°
                                                        </li>
                                                        <li><strong>CSM inicial:</strong> Pulso pedío débil,
                                                            sensibilidad disminuida
                                                        </li>
                                                        <li><strong>Pérdida estimada:</strong> 1000-1500 ml (fractura
                                                            cerrada fémur)
                                                        </li>
                                                    </ul>
                                                </div>
                                                <div>
                                                    <h4 className="font-medium mb-2 text-gray-800">⚡ Decisiones
                                                        Críticas:</h4>
                                                    <div className="space-y-2 text-sm">
                                                        <div className="p-2 bg-yellow-100 rounded">
                                                            <p><strong>Dilema:</strong> ¿Férula de tracción vs.
                                                                transporte inmediato?</p>
                                                        </div>
                                                        <div className="p-2 bg-green-100 rounded">
                                                            <p><strong>Decisión:</strong> Férula de tracción ANTES del
                                                                transporte</p>
                                                            <p className="text-xs">Reduce sangrado 40% y dolor
                                                                significativamente</p>
                                                        </div>
                                                        <div className="p-2 bg-blue-100 rounded">
                                                            <p><strong>Contraindicaciones verificadas:</strong></p>
                                                            <p className="text-xs">✓ No fractura de cadera ✓ No fractura
                                                                de rodilla ✓ No herida abierta</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div className="grid lg:grid-cols-2 gap-4">
                                            <div className="bg-blue-50 p-4 rounded border border-blue-300">
                                                <h4 className="font-bold text-blue-700 mb-2">🔧 Aplicación de Férula de
                                                    Tracción:</h4>
                                                <ol className="list-decimal list-inside space-y-1 text-sm text-gray-700">
                                                    <li><strong>Medición:</strong> Desde axila hasta 10 cm post maléolo
                                                        (extremidad sana)
                                                    </li>
                                                    <li><strong>Analgesia previa:</strong> Morfina 0.1 mg/kg IV lenta
                                                    </li>
                                                    <li><strong>Posicionamiento:</strong> Férula Hare en lado lateral de
                                                        extremidad
                                                    </li>
                                                    <li><strong>Acolchamiento:</strong> Tuberosidad isquiática y maléolo
                                                        lateral
                                                    </li>
                                                    <li><strong>Correa pélvica:</strong> Sobre ropa, snug fit sin
                                                        comprimir
                                                    </li>
                                                    <li><strong>Tracción manual:</strong> 10% peso corporal, alineación
                                                        gradual
                                                    </li>
                                                    <li><strong>Fijación mecánica:</strong> Ajuste hasta alivio del
                                                        dolor (7→3/10)
                                                    </li>
                                                    <li><strong>Sujeción:</strong> Correas cada 15 cm, verificar CSM
                                                    </li>
                                                    <li><strong>Resultado:</strong> FC↓ 145→110, TA↑ 90→105/65</li>
                                                </ol>
                                            </div>
                                            <div className="bg-orange-50 p-4 rounded border border-orange-300">
                                                <h4 className="font-bold text-orange-700 mb-2">📚 Fisiopatología de la
                                                    Fractura de Fémur:</h4>
                                                <ul className="list-disc list-inside space-y-1 text-sm text-gray-700">
                                                    <li><strong>Sangrado:</strong> 1000-2000 ml en espacio muscular</li>
                                                    <li><strong>Espasmo muscular:</strong> Cuádriceps, isquiotibiales,
                                                        aductores
                                                    </li>
                                                    <li><strong>Acortamiento:</strong> Superposición de fragmentos óseos
                                                    </li>
                                                    <li><strong>Rotación:</strong> Pérdida de estabilidad mecánica</li>
                                                    <li><strong>Tracción terapéutica:</strong> Reduce espasmo →
                                                        ↓sangrado
                                                    </li>
                                                    <li><strong>Beneficio hemodinámico:</strong> 30-40% menos pérdida
                                                        sanguínea
                                                    </li>
                                                    <li><strong>Evidencia:</strong> Estudios muestran ↓mortalidad con
                                                        tracción precoz
                                                    </li>
                                                </ul>
                                            </div>
                                        ...
                                        <div className="space-y-4">
                                            <div className="bg-white p-4 rounded-lg">
                                                ...
                                                <p className="text-sm text-gray-700 mb-3">
                                                    Accidente vehicular múltiple. Tienes 3 pacientes con trauma
                                                    ortopédico.
                                                    Recursos limitados: 2 paramédicos, 1 férula de tracción, 2 férulas
                                                    de vacío.
                                                </p>
                                                <div className="grid md:grid-cols-3 gap-4">
                                                    <div className="p-3 bg-red-100 rounded border border-red-300">
                                                        <h5 className="font-semibold text-red-700">Paciente A</h5>
                                                        <p className="text-xs">Fx fémur bilateral<br/>FC 140, TA
                                                            80/50<br/>Inconsciente</p>
                                                    </div>
                                                    <div className="p-3 bg-yellow-100 rounded border border-yellow-300">
                                                        <h5 className="font-semibold text-yellow-700">Paciente B</h5>
                                                        <p className="text-xs">Fx antebrazo abierta<br/>FC 90, TA 120/80<br/>Consciente,
                                                            dolor 9/10</p>
                                                    </div>
                                                    <div className="p-3 bg-green-100 rounded border border-green-300">
                                                        <h5 className="font-semibold text-green-700">Paciente C</h5>
                                                        <p className="text-xs">Fx tibial cerrada<br/>FC 100, TA
                                                            110/70<br/>Consciente, dolor 6/10</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="bg-gray-50 p-4 rounded-lg">
                                                ...
                                                <ol className="list-decimal list-inside space-y-1 text-sm text-gray-700">
                                                    ...
                                                    <li>¿Cuándo estarías dispuesto a retrasar el transporte para
                                                        inmovilizar?
                                                    </li>
                                                </ol>
                                            </div>
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <ul className="list-disc list-inside space-y-2 text-gray-700">
                                        ...
                                        <li>American Academy of Orthopaedic Surgeons. (2022). <em>Manejo de fracturas en
                                            entorno prehospitalario</em>.
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div>
                                    ...
                                    <ul className="list-disc list-inside space-y-2 text-gray-700">
                                        <li><a href="https://www.jems.com/patient-care/how-to-use-traction-splints/"
                                               target="_blank" rel="noopener noreferrer"
                                               className="text-blue-600 hover:underline">JEMS - Uso de férulas de
                                            tracción</a></li>
                                        <li><a
                                            href="https://www.ems1.com/ems-products/ambulance-disposable-supplies/articles/immobilization-device-for-spinal-injuries-aGcHE5GHYj2TmzLZ/"
                                            target="_blank" rel="noopener noreferrer"
                                            className="text-blue-600 hover:underline">EMS1 - Dispositivos para lesiones
                                            espinales</a></li>
                                        <li><a href="https://www.youtube.com/c/EMTprep" target="_blank"
                                               rel="noopener noreferrer" className="text-blue-600 hover:underline">EMT
                                            Prep - Canal de YouTube con técnicas de inmovilización</a></li>
                                    </ul>
                                </div>
