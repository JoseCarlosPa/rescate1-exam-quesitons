        ...
        <div className="space-y-6">
            ...
            <div className="p-5 bg-gray-50 rounded-lg shadow-sm mb-4">
                ...
                <p className="italic text-gray-600 mb-4">
                    Joven de 25 años encontrado en la calle con una herida punzante en la cara anterior del muslo
                    derecho. Presenta sangrado activo, rojo brillante y pulsátil. Está pálido y ansioso.
                </p>
                ...
                <ul className="list-disc list-inside space-y-1 text-gray-700">
                    ...
                    <li>C: FC 120/min, filiforme. TA 90/60 mmHg. Piel pálida, fría y sudorosa. Llenado capilar 3 seg.
                    </li>
                    <li>D: Alerta, orientado pero ansioso (GCS 15).</li>
                    <li>E: Herida visible en muslo, resto del cuerpo sin lesiones evidentes inicialmente. Temperatura
                        36.0°C.
                    </li>
                </ul>
                ...
                <ol className="list-decimal list-inside space-y-1 text-gray-700">
                    ...
                    <li>Canalizar acceso IV de grueso calibre. Iniciar fluidoterapia según protocolo (hipotensión
                        permisiva).
                    </li>
            ...
            <div className="p-5 bg-gray-50 rounded-lg shadow-sm mb-4">
                <h3 className="text-xl font-semibold mb-2 text-blue-600">Caso 2: Caída de altura con sospecha de
                    hemorragia interna</h3>
                <p className="italic text-gray-600 mb-4">
                    Varón de 50 años que cayó de un andamio (aprox. 3 metros). Se queja de dolor abdominal intenso. No
                    hay sangrado externo visible.
                </p>
                <h4 className="font-medium mb-2">Evaluación Inicial (XABCDE):</h4>
                <ul className="list-disc list-inside space-y-1 text-gray-700">
                    ...
                    <li>C: FC 130/min, débil. TA 85/50 mmHg. Piel pálida y fría. Abdomen distendido y doloroso a la
                        palpación. Pelvis estable.
                    </li>
                ...
                <ol className="list-decimal list-inside space-y-1 text-gray-700">
                    ...
                    <li>Administrar oxígeno a alto flujo.</li>
                    <li>Canalizar dos accesos IV de grueso calibre. Iniciar fluidoterapia con precaución (objetivo PAS
                        80-90 mmHg).
                    </li>
