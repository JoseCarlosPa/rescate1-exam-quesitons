...
import {MdCheckCircle, MdQuiz, MdWarning} from "react-icons/md";
                    ...
                    <div className="w-full max-w-7xl">
                        ...
                        <div className="max-w-5xl mx-auto bg-white rounded-lg shadow-sm p-6 mb-8">
                            ...
                            <section className="max-w-5xl mx-auto p-6 bg-white rounded-lg shadow-sm">
                                <h2 className="text-2xl font-bold mb-4">Referencias y recursos adicionales para Lesiones
                                    de
                                    Tejido Blando</h2>
                                ...
                                <div className="space-y-4">
                                    <div>
                                        <h3 className="text-lg font-medium mb-2">Bibliografía principal y
                                            complementaria</h3>
                                        <ul className="list-disc list-inside space-y-2 text-gray-700">
                                            <li>AAOS. (2021). <em>Emergencias Médicas Prehospitalarias</em> (11ª
                                                edición).
                                                Jones & Bartlett Learning. (Referencia principal para este módulo)
                                            </li>
                                            <li>NAEMT. (2020). <em>PHTLS: Soporte Vital de Trauma
                                                Prehospitalario</em> (9ª
                                                edición). (Relevante para el manejo de trauma en tejidos blandos)
                                            </li>
                                            <li>American Heart Association. (2020). <em>Soporte Vital Básico y
                                                Avanzado</em>.
                                    ...
                                    <div>
                                        ...
                                        <ul className="list-disc list-inside space-y-2 text-gray-700">
                                            ...
                                            <li><a href="https://www.jems.com/ems-insider/category/trauma/"
                                                   target="_blank"
                                            ...
                                            <li><a href="https://www.youtube.com/c/MedicTests" target="_blank"
                                                ...
                                                - Videos educativos (buscar listas de reproducción sobre
                                                trauma/heridas)</a>
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <ul className="list-disc list-inside space-y-2 text-gray-700">
                                            ...
                                            <li>Simuladores de Casos de Trauma (buscar en tiendas de apps) - Para
                                                practicar
