...
export const svbQuestions: Question[] = [
    {
        ...
        options: [
            ...
            {
                letter: "b",
                text: "El SVB se enfoca en maniobras no invasivas, mientras que el SVA incluye procedimientos invasivos y farmacología."
            },
    ...
    },
    {
        ...
        options: [
            ...
            {
                letter: "b",
                text: "Inmediatamente después de determinar que el paciente no responde y no respira normalmente."
            },
    ...
    },
    {
        ...
        options: [
            ...
            {
                letter: "c",
                text: "Puede indicar una ventilación excesiva o inadecuada, aumentando el riesgo de regurgitación y aspiración pulmonar."
            },
...
export const svbChallengeQuestions: Question[] = [
    {
        ...
        options: [
            ...
            {
                letter: "b",
                text: "Actividad eléctrica sin pulso (AESP) - evaluar y tratar causas reversibles (5H y 5T), continuar RCP de alta calidad, considerar que el pronóstico empeora significativamente después de 10 minutos"
            },
    ...
    },
    {
        ...
        options: [
            ...
            {
                letter: "b",
                text: "Los movimientos agonales y 'convulsión' inicial sugieren paro cardíaco; iniciar RCP inmediatamente y preparar DEA, ya que las convulsiones pueden ser la manifestación inicial de fibrilación ventricular"
            },
    ...
    },
    {
        ...
        options: [
            ...
            {
                letter: "b",
                text: "La oximetría durante paro cardíaco puede ser falsamente elevada debido a bajo flujo; la profundidad de 6 cm puede ser excesiva causando lesiones; enfocar en calidad de compresiones óptima (5-6 cm máximo)"
            },
    ...
    },
    {
        ...
        options: [
            ...
            {
                letter: "b",
                text: "Iniciar inmediatamente RCP con compresiones torácicas - las compresiones pueden desalojar el objeto y son más efectivas que maniobras específicas en paciente inconsciente"
            },
    ...
    },
    {
        ...
        options: [
            ...
            {
                letter: "b",
                text: "Síndrome post-paro cardíaco - optimizar oxigenación (objetivo SatO2 94-98%), soporte hemodinámico si es necesario, preparar para hipotermia terapéutica, transporte urgente"
            },
    ...
    },
    {
        ...
        options: [
            ...
            {
                letter: "b",
                text: "Indica ventilación excesiva o vía aérea inadecuada; aumenta riesgo de regurgitación y compromete retorno venoso. Ajustar técnica: volúmenes menores, inflación más lenta, verificar posición de cabeza"
            },
    ...
    },
    {
        ...
        options: [
            ...
            {
                letter: "b",
                text: "Colocar parches al menos 8 cm del marcapaso, proceder con desfibrilación ya que los beneficios superan los riesgos. El marcapaso puede evaluarse posteriormente"
            },
    ...
    },
    {
        ...
        options: [
            ...
            {
                letter: "b",
                text: "Probable paro cardíaco primario (miocardiopatía hipertrófica, displasia arritmogénica) - el pronóstico es mejor si la desfibrilación se realiza dentro de 3-5 minutos del colapso"
            },
    ...
    },
    {
        ...
        options: [
            ...
            {
                letter: "b",
                text: "Desplazamiento uterino manual hacia la izquierda durante compresiones, o inclinar todo el cuerpo 15-30° hacia la izquierda para aliviar compresión aortocava"
            },
    ...
    },
    {
        ...
        options: [
            ...
            {
                letter: "b",
                text: "La decisión debe basarse en: factores pronósticos (tiempo sin reanimación, comorbilidades, calidad de RCP), directivas anticipadas del paciente, y consideraciones de futilidad médica vs autonomía familiar"
            },
