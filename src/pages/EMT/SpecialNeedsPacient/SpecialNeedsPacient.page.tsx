                ...
                <div className="w-full max-w-7xl">
                    ...
                    <div className="max-w-5xl mx-auto bg-white rounded-lg shadow-sm p-6 mb-8">
                            ...
                            <div className="space-y-6">
                                <div>
                                    <h2 className="text-2xl font-semibold mb-3 text-gray-800 border-b pb-2">¿Qué son los
                                        pacientes con necesidades especiales?</h2>
                                    <p className="text-gray-700 leading-relaxed">
                                        Los pacientes con necesidades especiales son aquellos que requieren
                                    ...
                                    <p className="text-gray-700 mt-2 leading-relaxed">
                                        ...
                                        adaptaciones en el abordaje,
                                        comunicación y tratamiento para brindar una atención de calidad y segura.
                                    </p>
                                </div>

                                <div>
                                    <h2 className="text-2xl font-semibold mb-3 text-gray-800 border-b pb-2">Categorías
                                        principales</h2>
                                ...
                                <div>
                                    <h2 className="text-2xl font-semibold mb-3 text-gray-800 border-b pb-2">Principios
                                        fundamentales de atención</h2>
                                    <div className="grid md:grid-cols-2 gap-6">
                                        <div className="bg-orange-50 p-4 rounded-lg">
                                            <h3 className="font-medium text-lg mb-2 text-orange-700">Respeto y
                                                dignidad</h3>
                                        ...
                                        <div className="bg-blue-50 p-4 rounded-lg">
                                            <h3 className="font-medium text-lg mb-2 text-blue-700">Comunicación
                                                efectiva</h3>
                                            <ul className="list-disc list-inside space-y-1 text-gray-700">
                                    ...
                                    <div className="bg-gray-50 p-4 rounded-lg">
                                        <ul className="list-disc list-inside space-y-2 text-gray-700">
                                            <li><strong>Ley de Estadounidenses con Discapacidades
                                                (ADA):</strong> Prohíbe la discriminación y garantiza acceso equitativo
                                            </li>
                                            <li><strong>Consentimiento informado:</strong> Adaptado a la capacidad de
                                                comprensión del paciente
                                            </li>
                                            <li><strong>Tutores legales:</strong> Identificar quién tiene autoridad para
                                                tomar decisiones médicas
                                            </li>
                                            <li><strong>Confidencialidad:</strong> Proteger la información de salud
                                                mental y discapacidades
                                            </li>
                                            <li><strong>No discriminación:</strong> Brindar el mismo nivel de atención
                                                médica a todos los pacientes
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        {activeTab === 'conditions' && (
                            <div className="space-y-6">
                                <div>
                                    <h2 className="text-2xl font-semibold mb-3 text-gray-800 border-b pb-2">Discapacidades
                                        físicas</h2>
                                    <div className="grid md:grid-cols-2 gap-6">
                                        <div>
                                            <h3 className="font-medium text-lg mb-2 text-gray-800">Parálisis y lesiones
                                                de médula espinal</h3>
                                            <ul className="list-disc list-inside space-y-2 text-gray-700">
                                                <li><strong>Paraplejia:</strong> Parálisis de extremidades inferiores
                                                </li>
                                                <li><strong>Cuadriplejia:</strong> Parálisis de las cuatro extremidades
                                                </li>
                                ...
                                <div>
                                    ...
                                    <div className="grid md:grid-cols-2 gap-6">
                                        <div className="bg-blue-50 p-4 rounded-lg">
                                            <h3 className="font-medium text-lg mb-2 text-blue-700">Discapacidad
                                                visual</h3>
                                            <ul className="list-disc list-inside space-y-1 text-gray-700">
                                        ...
                                        <div className="bg-green-50 p-4 rounded-lg">
                                            <h3 className="font-medium text-lg mb-2 text-green-700">Discapacidad
                                                auditiva</h3>
                                            <ul className="list-disc list-inside space-y-1 text-gray-700">
                                ...
                                <div>
                                    <h2 className="text-2xl font-semibold mb-3 text-gray-800 border-b pb-2">Condiciones
                                        mentales y neurológicas</h2>
                                    <div className="space-y-4">
                                        <div className="p-4 bg-purple-50 rounded-lg">
                                            <h3 className="font-medium text-lg mb-2 text-purple-700">Discapacidad
                                                intelectual</h3>
                                            <ul className="list-disc list-inside space-y-1 text-gray-700">
                                        ...
                                        <div className="p-4 bg-yellow-50 rounded-lg">
                                            <h3 className="font-medium text-lg mb-2 text-yellow-700">Trastorno del
                                                espectro autista (TEA)</h3>
                                            <ul className="list-disc list-inside space-y-1 text-gray-700">
                                ...
                                <div>
                                    <h2 className="text-2xl font-semibold mb-3 text-gray-800 border-b pb-2">Dependencia
                                        tecnológica</h2>
                                    <div className="overflow-x-auto">
                                        <table className="min-w-full bg-white">
                                            ...
                                            <tbody>
                                            <tr>
                                                <td className="py-2 px-4 border font-medium">Ventilador domiciliario
                                                </td>
                                                <td className="py-2 px-4 border">Soporte respiratorio</td>
                                                <td className="py-2 px-4 border">Mantener funcionamiento, tener BVM de
                                                    respaldo
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td className="py-2 px-4 border">Aspiración frecuente, kit de
                                                    traqueostomía
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td className="py-2 px-4 border">Evitar tracción, verificar posición
                                                </td>
                                            </tr>
                                            <tr>
                                                <td className="py-2 px-4 border font-medium">Catéter urinario</td>
                                                <td className="py-2 px-4 border">Drenaje urinario</td>
                                                <td className="py-2 px-4 border">Mantener bolsa por debajo del
                                                    paciente
                                                </td>
                                            </tr>
                                            <tr>
                                                <td className="py-2 px-4 border font-medium">Shunt
                                                    ventriculoperitoneal
                                                </td>
                                                <td className="py-2 px-4 border">Drenaje de LCR</td>
                                                <td className="py-2 px-4 border">Monitorizar signos de aumento de PIC
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
                        ...
                        {activeTab === 'considerations' && (
                            <div className="space-y-6">
                                <div>
                                    <h2 className="text-2xl font-semibold mb-3 text-gray-800 border-b pb-2">Estrategias
                                        de comunicación</h2>
                                    <div className="grid md:grid-cols-2 gap-6">
                                        <div>
                                            <h3 className="font-medium text-lg mb-2 text-gray-800">Comunicación
                                                general</h3>
                                            <ul className="list-disc list-inside space-y-2 text-gray-700">
                                        ...
                                        <div>
                                            <h3 className="font-medium text-lg mb-2 text-gray-800">Adaptaciones
                                                específicas</h3>
                                            <ul className="list-disc list-inside space-y-2 text-gray-700">
                                                <li><strong>Discapacidad visual:</strong> Describir acciones y entorno
                                                </li>
                                                <li><strong>Discapacidad auditiva:</strong> Usar gestos, escribir,
                                                    contacto visual
                                                </li>
                                                <li><strong>Discapacidad intelectual:</strong> Lenguaje simple,
                                                    instrucciones cortas
                                                </li>
                                                <li><strong>Autismo:</strong> Mantener calma, evitar cambios bruscos
                                                </li>
                                                <li><strong>Enfermedad mental:</strong> Ser empático, no confrontativo
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div className="space-y-4">
                                        <div className="p-4 bg-blue-50 rounded-lg">
                                            <h3 className="font-medium text-lg mb-2 text-blue-700">Evaluación primaria
                                                (ABCDE)</h3>
                                            <ul className="list-disc list-inside space-y-1 text-gray-700">
                                                <li><strong>A (Vía aérea):</strong> Verificar permeabilidad, considerar
                                                    traqueostomía
                                                </li>
                                                <li><strong>B (Respiración):</strong> Evaluar trabajo respiratorio,
                                                    ventiladores
                                                </li>
                                                <li><strong>C (Circulación):</strong> Acceso vascular puede ser limitado
                                                </li>
                                                <li><strong>D (Discapacidad):</strong> Establecer nivel basal de función
                                                </li>
                                                <li><strong>E (Exposición):</strong> Respetar dignidad, buscar
                                                    dispositivos
                                                </li>
                                            </ul>
                                        </div>
                                        ...
                                        <div className="p-4 bg-green-50 rounded-lg">
                                            <h3 className="font-medium text-lg mb-2 text-green-700">Historia
                                                clínica</h3>
                                ...
                                <div>
                                    ...
                                    <div className="grid md:grid-cols-2 gap-6">
                                        <div className="bg-orange-50 p-4 rounded-lg">
                                            <h3 className="font-medium text-lg mb-2 text-orange-700">Ventiladores
                                                portátiles</h3>
                                            <ul className="list-disc list-inside space-y-1 text-gray-700">
                                        ...
                                        <div className="bg-purple-50 p-4 rounded-lg">
                                            <h3 className="font-medium text-lg mb-2 text-purple-700">Sillas de
                                                ruedas</h3>
                                            <ul className="list-disc list-inside space-y-1 text-gray-700">
                                    ...
                                    <div className="overflow-x-auto">
                                        <table className="min-w-full bg-white">
                                            ...
                                            <tr>
                                                ...
                                                <td className="py-2 px-4 border">Camilla bariátrica, personal
                                                    adicional
                                                </td>
                                                <td className="py-2 px-4 border">Dispositivo de levantamiento, rampa
                                                </td>
                                            </tr>
                                            <tr>
                                                <td className="py-2 px-4 border font-medium">Autismo severo</td>
                                                <td className="py-2 px-4 border">Minimizar estímulos, permitir
                                                    cuidador
                                                </td>
                                                <td className="py-2 px-4 border">Sedación si está indicada</td>
                                            </tr>
                                            <tr>
                                                <td className="py-2 px-4 border font-medium">Dependiente de ventilador
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td className="py-2 px-4 border">Evaluar traslado vs transporte en
                                                    silla
                                                </td>
                                ...
                                <div>
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="p-4 bg-yellow-50 rounded-lg">
                                            <h3 className="font-medium text-lg mb-2 text-yellow-700">Intervenciones
                                                físicas</h3>
                                            <ul className="list-disc list-inside space-y-1 text-gray-700">
