                        ...
                        {activeTab === 'anatomy' && (
                            <div className="space-y-8">
                                ...
                                <div>
                                    <h2 className="text-2xl font-semibold mb-4 text-gray-800 border-b pb-2 flex items-center">
                                        <FiTarget className="w-6 h-6 mr-2 text-orange-500" />
                                        Cuadrantes Abdominales - Mapa Anatómico
                                    </h2>
                                    <div className="grid md:grid-cols-2 gap-6">
                                        <div className="bg-gradient-to-br from-red-50 to-red-100 p-6 rounded-lg border-2 border-red-200">
                                            <h3 className="text-xl font-bold text-red-700 mb-3 text-center">Cuadrante Superior Derecho</h3>
                                            <div className="space-y-2">
                                                <div className="flex items-center">
                                                    <GiLiver className="w-5 h-5 text-red-600 mr-2" />
                                                    <span className="font-medium">Hígado</span> - Órgano más grande, muy vascularizado
                                                </div>
                                                <div className="flex items-center">
                                                    <GiStomach className="w-5 h-5 text-red-600 mr-2" />
                                                    <span className="font-medium">Vesícula biliar</span> - Almacena bilis
                                                </div>
                                                <div className="flex items-center">
                                                    <GiKidneys className="w-5 h-5 text-red-600 mr-2" />
                                                    <span className="font-medium">Riñón derecho</span> - Filtrado sanguíneo
                                                </div>
                                                <p className="text-sm text-gray-600 mt-2">
                                                    <strong>Riesgo:</strong> Hemorragia masiva por lesión hepática
                                                </p>
                                            </div>
                                        </div>
                                        <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-6 rounded-lg border-2 border-blue-200">
                                            <h3 className="text-xl font-bold text-blue-700 mb-3 text-center">Cuadrante Superior Izquierdo</h3>
                                            <div className="space-y-2">
                                                <div className="flex items-center">
                                                    <GiStomach className="w-5 h-5 text-blue-600 mr-2" />
                                                    <span className="font-medium">Bazo</span> - Órgano más lesionado en trauma cerrado
                                                </div>
                                                <div className="flex items-center">
                                                    <GiStomach className="w-5 h-5 text-blue-600 mr-2" />
                                                    <span className="font-medium">Estómago</span> - Contenido puede causar peritonitis
                                                </div>
                                                <div className="flex items-center">
                                                    <GiKidneys className="w-5 h-5 text-blue-600 mr-2" />
                                                    <span className="font-medium">Riñón izquierdo</span> - Filtrado sanguíneo
                                                </div>
                                                <p className="text-sm text-gray-600 mt-2">
                                                    <strong>Riesgo:</strong> Signo de Kehr (dolor referido al hombro izquierdo)
                                                </p>
                                            </div>
                                        </div>
                                        <div className="bg-gradient-to-br from-green-50 to-green-100 p-6 rounded-lg border-2 border-green-200">
                                            <h3 className="text-xl font-bold text-green-700 mb-3 text-center">Cuadrante Inferior Derecho</h3>
                                            <div className="space-y-2">
                                                <div className="flex items-center">
                                                    <GiStomach className="w-5 h-5 text-green-600 mr-2" />
                                                    <span className="font-medium">Apéndice</span> - Inflamación común
                                                </div>
                                                <div className="flex items-center">
                                                    <GiStomach className="w-5 h-5 text-green-600 mr-2" />
                                                    <span className="font-medium">Intestino delgado</span> - Absorción de nutrientes
                                                </div>
                                                <div className="flex items-center">
                                                    <GiStomach className="w-5 h-5 text-green-600 mr-2" />
                                                    <span className="font-medium">Ovario derecho</span> - En mujeres
                                                </div>
                                                <p className="text-sm text-gray-600 mt-2">
                                                    <strong>Riesgo:</strong> Perforación intestinal y sepsis
                                                </p>
                                            </div>
                                        </div>
                                        <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-6 rounded-lg border-2 border-purple-200">
                                            <h3 className="text-xl font-bold text-purple-700 mb-3 text-center">Cuadrante Inferior Izquierdo</h3>
                                            <div className="space-y-2">
                                                <div className="flex items-center">
                                                    <GiStomach className="w-5 h-5 text-purple-600 mr-2" />
                                                    <span className="font-medium">Colon sigmoide</span> - Formación de heces
                                                </div>
                                                <div className="flex items-center">
                                                    <GiStomach className="w-5 h-5 text-purple-600 mr-2" />
                                                    <span className="font-medium">Intestino delgado</span> - Parte del íleon
                                                </div>
                                                <div className="flex items-center">
                                                    <GiStomach className="w-5 h-5 text-purple-600 mr-2" />
                                                    <span className="font-medium">Ovario izquierdo</span> - En mujeres
                                                </div>
                                                <p className="text-sm text-gray-600 mt-2">
                                                    <strong>Riesgo:</strong> Contaminación fecal severa
                                                </p>
                                            </div>
                                        </div>
                                    </div>
