                ...
                <div
                    ...
                    <div className="w-full max-w-7xl">
                        ...
                        <header className="mb-8 text-center">
                            ...
                            <h1 className="text-5xl font-bold mb-2 text-center">Lesiones abdominales y
                                genitourinarias</h1>
                        ...
                        <section className="max-w-5xl mx-auto p-6 bg-white rounded-lg shadow-sm">
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <ul className="list-disc list-inside space-y-2 text-gray-700">
                                        <li><a href="https://www.ems1.com/trauma-care/abdominal-trauma/" target="_blank"
                                               rel="noopener noreferrer" className="text-blue-600 hover:underline">EMS1
                                            - Artículos sobre trauma abdominal</a></li>
