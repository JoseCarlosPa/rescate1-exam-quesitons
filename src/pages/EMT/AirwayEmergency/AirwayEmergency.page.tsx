                ...
                <div
                    ...
                    <div className="w-full max-w-7xl">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8 max-w-4xl mx-auto">
                            ...
                            <a href="https://docs.google.com/presentation/d/11SiPNBLLp0RDVW5dMHnWc5JUpqGK2Yei/edit?usp=sharing&ouid=107287742628985461156&rtpof=true&sd=true"
                               target="_blank"
                        ...
                        {/* Foro de Discusión */}
                        <ForumSection
                            pagina="airway-emergency"
                            titulo="Foro de Discusión - Emergencias Respiratorias"
                        />
