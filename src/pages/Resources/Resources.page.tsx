...
import {resources} from "./Resources.constants.ts";
        ...
        <div className="flex flex-col min-h-screen bg-gradient-to-br from-orange-50 to-gray-200 pb-12 md:p-12 px-4 p-4">
            <div className="flex flex-col justify-center items-center mb-8">
                ...
                <input
                    ...
                    className="mt-2 w-full max-w-md px-4 py-2 rounded-full border border-orange-200 shadow focus:outline-none focus:ring-2 focus:ring-orange-300 text-lg"
                />
            </div>
