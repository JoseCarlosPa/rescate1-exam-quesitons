...
import {FaArrowLeft, FaCamera, FaEye, FaEyeSlash, FaSave, FaUser} from 'react-icons/fa';
                    ...
                    <div className="p-6">
                        ...
                        <div className="flex items-center space-x-6 mb-8">
                            <div className="relative">
                                ...
                                <div
                                    className={`w-24 h-24 bg-orange-500 rounded-full flex items-center justify-center border-4 border-gray-200 ${photoURL ? 'hidden' : ''}`}>
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-500">Estudiante
                                    desde {studentData?.createdAt?.toDate?.()?.toLocaleDateString() || 'N/A'}</p>
                            </div>
                        </div>
                        ...
                        <div className="space-y-6">
                            ...
                            <div>
                                ...
                                />
                                <p className="text-xs text-gray-500 mt-1">El correo electrónico no se puede
                                    modificar</p>
                            </div>
                            ...
                            <div>
                                ...
                                />
                                <p className="text-xs text-gray-500 mt-1">Proporciona una URL válida de tu foto de
                                    perfil</p>
                            </div>
