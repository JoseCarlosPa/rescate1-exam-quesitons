        ...
        <div className="bg-gray-50  min-h-screen">
            ...
            <main className="container mx-auto p-6 md:p-8">
                ...
                <section className="mb-10 mt-4 bg-white  p-6 rounded-lg shadow">
                    <h2 className="text-2xl font-semibold text-gray-800  mb-4 border-b pb-2">¿Qué es "Stop the Bleed"?</h2>
                ...
                <section className="mb-10 bg-white  p-6 rounded-lg shadow">
                    <h2 className="text-2xl font-semibold text-gray-800  mb-4 border-b pb-2">¿Por Qué es Importante Saber Detener el Sangrado?</h2>
                    <p className="text-gray-700  leading-relaxed mb-4">
                ...
                {/* Pasos Clave (ABC) */}
                <section className="mb-10 bg-white  p-6 rounded-lg shadow">
                    <h2 className="text-2xl font-semibold text-gray-800  mb-4 border-b pb-2">Los Pasos Clave: A-B-C del Control de Hemorragias</h2>
                    <p className="text-gray-700  leading-relaxed mb-4">
                    ...
                    <div className="mb-6 p-4 border border-blue-200 rounded-md bg-blue-50 ">
                        ...
                        <h4 className="text-lg font-semibold text-gray-700  mb-2">1. Presión Directa:</h4>
                        <ul className="list-disc ml-6 text-gray-700  leading-relaxed space-y-1 mb-3">
                        ...
                        <h4 className="text-lg font-semibold text-gray-700  mt-4 mb-2">2. Empaquetamiento de la Herida (Wound Packing):</h4>
                        <ul className="list-disc ml-6 text-gray-700  leading-relaxed space-y-1 mb-3">
                        ...
                        <h4 className="text-lg font-semibold text-gray-700  mt-4 mb-2">3. Aplicación de Torniquete:</h4>
                        <ul className="list-disc ml-6 text-gray-700  leading-relaxed space-y-1 mb-3">
                ...
                <section className="mb-10 bg-white  p-6 rounded-lg shadow">
                    <h2 className="text-2xl font-semibold text-gray-800  mb-4 border-b pb-2">Kits de Control de Hemorragias</h2>
                    <p className="text-gray-700  leading-relaxed mb-4">
                ...
                {/* Entrenamiento */}
                <section className="mb-10 bg-white  p-6 rounded-lg shadow">
                    <h2 className="text-2xl font-semibold text-gray-800  mb-4 border-b pb-2">¡Entrénate!</h2>
                    <p className="text-gray-700  leading-relaxed mb-4">
                ...
                <section className="bg-gray-200  p-6 rounded-lg shadow">
                    <h2 className="text-2xl font-semibold text-gray-800  mb-4 border-b border-gray-400 pb-2">Recursos y Referencias</h2>
