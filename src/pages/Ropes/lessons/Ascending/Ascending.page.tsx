...
import { MdArrowUpward, MdMenuBook, MdQuiz, MdElevator } from "react-icons/md";
...
import { ascendingFaqData } from "./Ascending.questions";
import Overview from "./components/Overview.component";
import Systems from "./components/Systems.component";

type AscendingTab = "overview" | "systems";

export default function Ascending() {
    const [activeTab, setActiveTab] = useState<AscendingTab>("overview");

    const tabs: { id: AscendingTab; label: string; icon: ReactNode }[] = [
        { id: "overview", label: "Principios de Seguridad", icon: <MdMenuBook className="w-4 h-4" /> },
        { id: "systems",  label: "Sistemas de Ascenso",     icon: <MdElevator className="w-4 h-4" /> },
    ];

    return (
        <SEOWrapper
            title="Ascenso por Cuerdas | Lección 21"
            description="Lección 21 del curso de Rescate con Cuerdas: Ascenso (Ascending). Sistemas Texas, Frog, Tender, y las reglas de los 2 puntos de anclaje de seguridad."
            keywords="ascenso por cuerda rescate, texas system rope, frog system rescate, rope climbing safety, tender system"
            section="ropes"
            difficulty="Advanced"
                ...
                <div className="flex flex-col items-center justify-center bg-gradient-to-b from-gray-100 to-white pb-12 px-4 p-4">
                    <div className="w-full max-w-5xl">
                        ...
                        <header className="mb-8 text-center">
                            ...
                            <p className="text-sm font-semibold text-teal-600 mb-1">Lección 21</p>
                            ...
                            <p className="text-sm italic mb-4 text-gray-500">Alumnos Rescate 1 (Capítulo 22)</p>
                            <div className="flex justify-center">
                                <NavLink
                        ...
                        <div className="flex justify-center mb-8">
                            <NavLink
                                to={`${AllRoutes.ROPE_ASCENDING}/exam`}
                        ...
                        {/* Foro */}
                        <ForumSection
                            pagina="rope-ascending"
                            titulo="Foro de Discusión - Ascenso"
                        />
                        ...
                        <section className="max-w-5xl mx-auto p-6 bg-white rounded-lg shadow-sm mt-8">
                            ...
                            <ul className="list-disc list-inside space-y-2 text-gray-700">
                                <li>CMC Rescue. (2020). <em>CMC Rope Rescue Technician Manual, 6th Edition</em> — Cap. 22: "Ascending".</li>
                            </ul>
                        </section>
