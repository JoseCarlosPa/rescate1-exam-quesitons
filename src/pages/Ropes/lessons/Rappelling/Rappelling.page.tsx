...
import { MdDownhillSkiing, MdMenuBook, MdQuiz, MdNordicWalking } from "react-icons/md";
...
import { rappellingFaqData } from "./Rappelling.questions";
import Overview from "./components/Overview.component";
import Technique from "./components/Technique.component";

type RappelTab = "overview" | "technique";

export default function Rappelling() {
    const [activeTab, setActiveTab] = useState<RappelTab>("overview");

    const tabs: { id: RappelTab; label: string; icon: ReactNode }[] = [
        { id: "overview",  label: "Principios",          icon: <MdMenuBook className="w-4 h-4" /> },
        { id: "technique", label: "Técnica y Postura",   icon: <MdNordicWalking className="w-4 h-4" /> },
    ];

    return (
        <SEOWrapper
            title="Rapel (Rappelling) | Lección 20"
            description="Lección 20 del curso de Rescate con Cuerdas: Rapel (Rappelling). Técnicas de despliegue de cuerdas, superación de bordes difíciles y postura biomecánica."
            keywords="rapel rescate, rappelling technique, rescue rappel, buddy check, bounding rappel"
            section="ropes"
            difficulty="Advanced"
                ...
                <div className="flex flex-col items-center justify-center bg-gradient-to-b from-gray-100 to-white pb-12 px-4 p-4">
                    <div className="w-full max-w-5xl">
                        ...
                        <header className="mb-8 text-center">
                            <div className="flex justify-center">
                                <div className="w-24 h-24 bg-gradient-to-br from-stone-500 to-neutral-600 rounded-2xl flex items-center justify-center mb-4 shadow-lg">
                                    <MdDownhillSkiing className="w-14 h-14 text-white" />
                                </div>
                            </div>
                            <p className="text-sm font-semibold text-stone-600 mb-1">Lección 20</p>
                            ...
                            <p className="text-sm italic mb-4 text-gray-500">Alumnos Rescate 1 (Capítulo 21)</p>
                            <div className="flex justify-center">
                                <NavLink
                        ...
                        <div className="flex justify-center mb-8">
                            <NavLink
                                to={`${AllRoutes.ROPE_RAPPELLING}/exam`}
                        ...
                        {/* Foro */}
                        <ForumSection
                            pagina="rope-rappelling"
                            titulo="Foro de Discusión - Rapel"
                        />
                        ...
                        <section className="max-w-5xl mx-auto p-6 bg-white rounded-lg shadow-sm mt-8">
                            ...
                            <ul className="list-disc list-inside space-y-2 text-gray-700">
                                <li>CMC Rescue. (2020). <em>CMC Rope Rescue Technician Manual, 6th Edition</em> — Cap. 21: "Rappelling".</li>
                            </ul>
                        </section>
