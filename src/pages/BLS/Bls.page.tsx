    ...
    return (
        ...
        >
            ...
            >
                ...
                {isOpen ? <FaChevronUp className="text-red-600 transition-transform duration-300" /> : <FaChevronDown className="text-red-600 transition-transform duration-300" />}
            </button>
            {isOpen && (
                <motion.div
            ...
            <main className="container mx-auto px-4 py-8 md:px-8 lg:flex lg:gap-8">
                ...
                <div className="lg:w-3/4">
                        ...
                        <div className="prose prose-lg max-w-none text-gray-700">
                            ...
                            <div className="bg-red-50 p-4 rounded-lg border border-red-100 mb-6">
                                <p className="font-medium text-red-800">
                                    La rápida aplicación del BLS puede duplicar o incluso triplicar las probabilidades de supervivencia en un paro cardíaco.
                                </p>
                            </div>
                            <motion.div
                    ...
                    >
                        ...
                        <div className="prose prose-lg max-w-none text-gray-700">
                            <div className="bg-gradient-to-r from-red-50 to-red-100 p-6 rounded-lg shadow-inner mb-6">
                                ...
                                <ul className="space-y-2">
                                    ...
                                    <li className="flex items-start">
                                        <span className="text-red-500 font-bold mr-2">•</span>
                                        La mayoría de los paros cardíacos ocurren fuera del hospital, donde la intervención inmediata es crucial.
                                    </li>
                                    <li className="flex items-start">
                                        <span className="text-red-500 font-bold mr-2">•</span>
                                        La RCP de alta calidad por testigos puede duplicar o triplicar las tasas de supervivencia.
                                    </li>
                                </ul>
                            </div>
                            <p className="leading-relaxed mb-4">
                    ...
                    <section id="components" className="mb-10">
                            ...
                            <div className="prose prose-lg max-w-none text-gray-700">
                                ...
                                <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 my-4">
                                    <p className="text-yellow-800">
                                        <strong>¡Recuerda!</strong> Tu seguridad es la prioridad número uno. No puedes ayudar si también te conviertes en víctima.
                                    </p>
                                </div>
                                <h4 className="text-lg font-semibold text-gray-800 mt-4">Puntos clave para evaluar la seguridad:</h4>
                            ...
                            <div className="prose prose-lg max-w-none text-gray-700">
                                ...
                                <div className="flex flex-col md:flex-row gap-6 mb-4">
                                    <div className="flex-1 bg-gray-50 p-4 rounded-lg shadow-inner">
                                        <h4 className="text-lg font-semibold text-red-700 mb-2">Evaluación de la respuesta</h4>
                                        <ul className="list-disc ml-6 space-y-1">
                                    ...
                                    <div className="flex-1 bg-gray-50 p-4 rounded-lg shadow-inner">
                                        <h4 className="text-lg font-semibold text-red-700 mb-2">Evaluación de la respiración</h4>
                                        <ul className="list-disc ml-6 space-y-1">
                                ...
                                <div className="bg-red-50 border-l-4 border-red-500 p-4 my-4">
                                    <p className="text-red-800">
                                        <strong>Importante:</strong> Los jadeos o respiraciones agónicas NO son respiraciones normales y son un signo de paro cardíaco.
                                    </p>
                                </div>
                            </div>
                        </AccordionSection>
                            ...
                            <div className="prose prose-lg max-w-none text-gray-700">
                                ...
                                <div className="flex flex-col md:flex-row gap-6 mb-4">
                                    <div className="flex-1 bg-gray-50 p-4 rounded-lg shadow-inner">
                                        ...
                                        <ul className="list-disc ml-6 space-y-1">
                                            ...
                                            <li>Si hay más personas: asigna tareas (llamar, buscar DEA, iniciar RCP)</li>
                                        </ul>
                                    </div>
                                    <div className="flex-1 bg-gray-50 p-4 rounded-lg shadow-inner">
                                        <h4 className="text-lg font-semibold text-red-700 mb-2">Para niños y bebés</h4>
                                        <ul className="list-disc ml-6 space-y-1">
                                ...
                                <div className="bg-blue-50 border-l-4 border-blue-500 p-4 my-4">
                                    <p className="text-blue-800">
                                        <strong>Recuerda:</strong> Al llamar a emergencias, indica claramente la ubicación, qué ocurrió, el estado de la víctima y sigue las instrucciones del operador.
                                    </p>
                                </div>
                            </div>
                        </AccordionSection>
                        ...
                        >
                            <div className="prose prose-lg max-w-none text-gray-700">
                                ...
                                <div className="bg-red-50 p-4 rounded-lg border border-red-100 mb-6">
                                    <h4 className="text-lg font-semibold text-red-800 mb-2">Principios clave de la RCP de alta calidad:</h4>
                                ...
                                <h4 className="text-xl font-semibold text-gray-800 mb-3">Compresiones Torácicas:</h4>
                                ...
                                <h4 className="text-xl font-semibold text-gray-800 mb-3">Ventilaciones de Rescate (si estás entrenado):</h4>
                                <ul className="list-disc ml-6 leading-relaxed space-y-2">
                                ...
                                <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 my-4">
                                    <p className="text-yellow-800">
                                        <strong>Nota:</strong> Las profundidades y técnicas de compresión/ventilación varían para niños e infantes. Se requiere formación específica.
                                    </p>
                                </div>
                            </div>
                        </AccordionSection>
                        ...
                        >
                            <div className="prose prose-lg max-w-none text-gray-700">
                                ...
                                <div className="bg-blue-50 p-4 rounded-lg border border-blue-100 mb-6">
                                    <h4 className="text-lg font-semibold text-blue-800 mb-2">Secuencia del DEA - "ABCD"</h4>
                                ...
                                <h4 className="text-xl font-semibold text-gray-800 mb-3">Pasos para usar el DEA:</h4>
                                ...
                                <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 my-4">
                                    <p className="text-yellow-800">
                                        <strong>Importante:</strong> Los DEA modernos son muy fáciles de usar y guían al usuario con instrucciones de voz y visuales claras. No tengas miedo de usarlo; no puede hacer daño a alguien que no lo necesita.
                                    </p>
                                </div>
                            </div>
                        </AccordionSection>
                            ...
                            <div className="prose prose-lg max-w-none text-gray-700">
                                ...
                                <div className="flex flex-col md:flex-row gap-6 mb-6">
                                    <div className="flex-1 bg-red-50 p-4 rounded-lg shadow-inner">
                                        <h4 className="text-lg font-semibold text-red-700 mb-2">Signos de atragantamiento:</h4>
                                        <ul className="list-disc ml-6 space-y-1">
                                            <li>Incapacidad para hablar o respirar</li>
                                            <li>Sonidos de asfixia o jadeos</li>
                                            <li>Agarre de la garganta con las manos (señal universal de atragantamiento)</li>
                                    ...
                                    <div className="flex-1 bg-green-50 p-4 rounded-lg shadow-inner">
                                        <h4 className="text-lg font-semibold text-green-700 mb-2">Acciones inmediatas:</h4>
                                        <ul className="list-disc ml-6 space-y-1">
                                            <li>Pregunta: "¿Te estás atragantando?"</li>
                                            <li>Si puede hablar, toser o respirar: anima a toser</li>
                                            <li>Si no puede hablar, toser o respirar: aplica la Maniobra de Heimlich</li>
                                            <li>Si pierde la consciencia: inicia RCP</li>
                                        </ul>
                                    </div>
                                </div>
                                <h4 className="text-xl font-semibold text-gray-800 mb-3">Adultos y Niños (mayores de 1 año) conscientes:</h4>
                                <ul className="list-disc ml-6 leading-relaxed space-y-2">
                                ...
                                <h4 className="text-xl font-semibold text-gray-800 mb-3">Si la persona queda inconsciente:</h4>
                                <ul className="list-disc ml-6 leading-relaxed space-y-2">
                                ...
                                <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 my-4">
                                    <p className="text-yellow-800">
                                        <strong>Nota:</strong> Las técnicas para infantes (menores de 1 año) son diferentes (golpes en la espalda y compresiones torácicas). Se requiere formación específica.
                                    </p>
                                </div>
                            </div>
                        </AccordionSection>
                    ...
                    >
                        ...
                        <div className="prose prose-lg max-w-none text-gray-700">
                            ...
                            <div className="bg-gradient-to-r from-blue-50 to-blue-100 p-6 rounded-lg shadow-inner mb-6">
                                <h3 className="text-xl font-semibold text-blue-700 mb-3">Beneficios del entrenamiento formal</h3>
                                <ul className="space-y-2">
                                    <li className="flex items-start">
                            ...
                            <ul className="space-y-4 mb-6">
                                <li className="flex items-start bg-white p-3 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-600 mt-1">Principios fundamentales del BLS y comprensión de la anatomía básica.</p>
                                    </div>
                                </li>
                                <li className="flex items-start bg-white p-3 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-600 mt-1">Entrenamiento con maniquíes para compresiones, ventilaciones y uso del DEA.</p>
                                    </div>
                                </li>
                                <li className="flex items-start bg-white p-3 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-600 mt-1">Práctica en situaciones de emergencia realistas para desarrollar confianza.</p>
                                    </div>
                                </li>
                                <li className="flex items-start bg-white p-3 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-600 mt-1">Verificación de conocimientos y habilidades para obtener la certificación.</p>
                                    </div>
                                </li>
                            </ul>
                            <p className="leading-relaxed font-medium">
                                La certificación en BLS generalmente es válida por dos años, después de los cuales se requiere un curso de actualización para mantenerse al día con los últimos protocolos.
                            </p>
                        </div>
                    </motion.section>
                        ...
                        <div className="prose prose-lg max-w-none text-gray-700">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                                ...
                                >
                                    ...
                                    <div>
                                        <span className="font-medium text-red-700">American Heart Association (AHA)</span>
                                        <p className="text-sm text-gray-600 mt-1">Cursos, materiales de formación y recursos de BLS</p>
                                    </div>
                                </motion.a>
                                <motion.a
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-600 mt-1">Formación en RCP, primeros auxilios y DEA</p>
                                    </div>
                                </motion.a>
                                <motion.a
                                ...
                                >
                                    <FaExternalLinkAlt className="text-red-500 mr-3 flex-shrink-0 h-5 w-5" />
                                    <div>
                                        <span className="font-medium text-red-700">Mayo Clinic - Primeros Auxilios</span>
                                        <p className="text-sm text-gray-600 mt-1">Guías de primeros auxilios y soporte vital</p>
                                    </div>
                                </motion.a>
                                <motion.a
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-600 mt-1">Formación especializada en soporte vital pediátrico</p>
                                    </div>
                                </motion.a>
                            </div>
