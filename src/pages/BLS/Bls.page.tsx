        ...
        <div className="bg-gray-100 dark:bg-gray-900 dark:text-white min-h-screen">
            ...
            <main className="container mx-auto p-6 md:p-8">
                ...
                <section className="mb-10 mt-4 bg-white dark:bg-gray-900 p-6 rounded-lg shadow">
                    <h2 className="text-2xl font-semibold text-gray-800 dark:text-white mb-4 border-b pb-2">¿Qué es el Soporte Vital Básico (BLS)?</h2>
                ...
                <section className="mb-10 bg-white dark:bg-gray-900 p-6 rounded-lg shadow">
                    <h2 className="text-2xl font-semibold text-gray-800 dark:text-white mb-4 border-b pb-2">Importancia del BLS</h2>
                    <p className="text-gray-700 dark:text-white leading-relaxed mb-4">
                ...
                <section className="mb-10 bg-white dark:bg-gray-900 p-6 rounded-lg shadow">
                    <h2 className="text-2xl font-semibold text-gray-800 dark:text-white mb-4 border-b pb-2">Componentes Clave del BLS</h2>
                    ...
                    <div className="mb-6">
                        ...
                        <h4 className="text-lg font-semibold text-gray-700 dark:text-white mb-2">Compresiones Torácicas:</h4>
                        ...
                        />
                        <h4 className="text-lg font-semibold text-gray-700 dark:text-white mt-4 mb-2">Ventilaciones de Rescate (si estás entrenado):</h4>
                        <ul className="list-disc ml-6 text-gray-700 dark:text-white leading-relaxed space-y-1">
                    ...
                    <div className="mb-6">
                        ...
                        <h4 className="text-lg font-semibold text-gray-700 dark:text-white mt-4 mb-2">Si la persona queda inconsciente:</h4>
                        <ul className="list-disc ml-6 text-gray-700 dark:text-white leading-relaxed space-y-1">
                        ...
                        <p className="mt-3 text-sm text-gray-600 dark:text-white italic">
                ...
                <section className="mb-10 bg-white dark:bg-gray-900 p-6 rounded-lg shadow">
                    <h2 className="text-2xl font-semibold text-gray-800 dark:text-white mb-4 border-b pb-2">Entrenamiento y Certificación</h2>
                    <p className="text-gray-700  dark:text-white leading-relaxed mb-4">
