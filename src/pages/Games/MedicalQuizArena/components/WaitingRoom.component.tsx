...
import { FaCopy, FaUsers, FaPlay, FaSignOutAlt, FaCheck } from 'react-icons/fa';
                    ...
                    <div className="bg-white bg-opacity-10 backdrop-blur-lg rounded-3xl p-6 border-4 border-yellow-400 flex flex-col max-h-[600px]">
                        ...
                        <form onSubmit={handleSendMessage} className="flex gap-2">
                            <input
                                ...
                                className="flex-1 px-3 py-2 rounded-lg bg-white bg-opacity-20  placeholder-gray-300 border-2 border-gray-300 border-opacity-30 focus:border-yellow-400 focus:outline-none"
                                maxLength={200}
                            />
                            <button
                                type="submit"
