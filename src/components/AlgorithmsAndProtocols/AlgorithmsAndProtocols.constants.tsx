...
export const patientEvaluationProtocol: Protocol = {
    ...
    edges: [
        ...
        },
        {
            id: 'eval-e3b-4b',
            source: 'tipoPaciente',
            target: 'clinicoDecision',
            label: 'Clínico',
            markerEnd: {type: MarkerType.ArrowClosed}
        },
        {
            id: 'eval-e4a-5a',
            source: 'traumatizadoDecision',
            target: 'traumaSig',
            label: 'Significativo',
            markerEnd: {type: MarkerType.ArrowClosed}
        },
...
export const blsProtocol: Protocol = {
    ...
    edges: [
        ...
        {
            id: 'bls-e2-3',
            source: 'evaluacionInicial',
            target: 'verificarRespiracion',
            markerEnd: {type: MarkerType.ArrowClosed}
        },
        {
            id: 'bls-e3-4',
            source: 'verificarRespiracion',
            target: 'decisionRCP',
            markerEnd: {type: MarkerType.ArrowClosed}
        },
...
export const aclsProtocol: Protocol = {
    ...
    edges: [
        ...
        {
            id: 'acls-e4-6',
            source: 'asistolia_aesp',
            target: 'rcpContinuado2',
            markerEnd: {type: MarkerType.ArrowClosed}
        },
...
export const phtlsProtocol: Protocol = {
    ...
    edges: [
        ...
        },
        {
            id: 'phtls-e2-4',
            source: 'prioridad',
            target: 'evaluacionSecundaria',
            label: 'No crítico',
            markerEnd: {type: MarkerType.ArrowClosed}
        },
        {
            id: 'phtls-e4-5',
            source: 'evaluacionSecundaria',
            target: 'traumaSpecific',
            markerEnd: {type: MarkerType.ArrowClosed}
        },
        {
            id: 'phtls-e3-6',
            source: 'transporteInmediato',
            target: 'reevaluacion',
            type: 'smoothstep',
            markerEnd: {type: MarkerType.ArrowClosed}
        },
