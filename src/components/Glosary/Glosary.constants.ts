...
export const CLAVES: Clave[] = [
    {numero: '1', descripcion: 'RELEVO CAMBIO'},
    {numero: '2', descripcion: 'AMBULANCIA'},
    {numero: '3', descripcion: 'BOMBEROS'},
    {numero: '4A', descripcion: 'GRUA'},
    {numero: '4C', descripcion: 'CHICA'},
    {numero: '4G', descripcion: 'GRANDE'},
    {numero: '4P', descripcion: 'PARTICULAR'},
    {numero: '4S', descripcion: 'SEG.PUBLICA'},
    {numero: '5', descripcion: 'CAMIONETA'},
    {numero: '6', descripcion: 'CAMION'},
    {numero: '7', descripcion: 'AUTOBUS'},
    {numero: '8', descripcion: 'TELEFONO'},
    {numero: '8C', descripcion: 'CELULAR'},
    {numero: '9', descripcion: 'NEGATIVO'},
    {numero: '9A', descripcion: 'IGNORO'},
    {numero: '11', descripcion: 'AUTOMOVIL'},
    {numero: '12', descripcion: 'MEDICO'},
    {numero: '13', descripcion: 'MOTOCICLETA'},
    {numero: '13B', descripcion: 'BICICLETA'},
    {numero: '14', descripcion: 'COMPAÑERO'},
    {numero: '15', descripcion: 'MINISTERIO PUB.'},
    {numero: '16', descripcion: 'DEFICIENCIA MENTAL'},
    {numero: '17', descripcion: 'EBRIO'},
    {numero: '18', descripcion: 'PENDIENTE'},
    {numero: '19', descripcion: 'CONTACTO'},
    {numero: '19V', descripcion: 'VISUAL'},
    {numero: '20', descripcion: 'DOMICILIO'},
    {numero: '21', descripcion: 'SERVICIO'},
    {numero: '21F', descripcion: 'SERVICIOS NO SE TRASLADO'},
    {numero: '21T', descripcion: 'SERVICIOS EFECTIVOS'},
    {numero: '22', descripcion: 'PELIGROSO'},
    {numero: '25', descripcion: 'DESCOMPUESTO/ENFERMO'},
    {numero: '26', descripcion: 'ABANDONO'},
    {numero: '26P', descripcion: 'PERSONA'},
    {numero: '26E', descripcion: 'ESPOSO(A)-NOVIO(A)'},
    {numero: '26F', descripcion: 'FEMENINO'},
    {numero: '26H', descripcion: 'HIJO(A)'},
    {numero: '26M', descripcion: 'MASCULINO'},
    {numero: '26PA', descripcion: 'PADRES'},
    {numero: '26R', descripcion: 'RESPONSABLE'},
    {numero: '27', descripcion: 'INVESTIGAR'},
    {numero: '28', descripcion: 'BLOQUEADO/CERRADO'},
    {numero: '29', descripcion: 'LESIONADO'},
    {numero: '29A', descripcion: 'APUÑALADO/CORTADO'},
    {numero: '29B', descripcion: 'BALADEADO'},
    {numero: '29C', descripcion: 'CAIDO'},
    {numero: '29E', descripcion: 'ELECTROCUTADO'},
    {numero: '29F', descripcion: 'FRACTURADO'},
    {numero: '29G', descripcion: 'GRAVE'},
    {numero: '29H', descripcion: 'HEMORRAGIA'},
    {numero: '29L', descripcion: 'LEVE'},
    {numero: '29GOL', descripcion: 'GOLPEADO'},
    {numero: '29Q', descripcion: 'QUEMADO'},
    {numero: '29V', descripcion: 'PROB.VENTILATORIO'},
    {numero: '29Z', descripcion: 'VIOLACION'},
    {numero: '29CPC', descripcion: 'PARO CARDIACO'},
    {numero: '30', descripcion: 'ORDEN'},
    {numero: '31', descripcion: 'RELACIONES PUBLICAS'},
    {numero: '31A', descripcion: 'NOTIFICAR A:'},
    {numero: '32', descripcion: 'RIÑA/PELEA'},
    {numero: '33', descripcion: 'NOVEDADES'},
    {numero: '34', descripcion: 'ABSTENERSE'},
    {numero: '35', descripcion: 'CADAVER'},
    {numero: '36', descripcion: 'ARMA'},
    {numero: '36B', descripcion: 'BLANCA'},
    {numero: '36F', descripcion: 'FUEGO'},
    {numero: '37', descripcion: 'ENTERADO'},
    {numero: '38', descripcion: 'AFIRMATIVO'},
    {numero: '39', descripcion: 'FALSA ALARMA'},
    {numero: '40', descripcion: 'TRASLADO'},
    {numero: '40E', descripcion: 'ESPECIAL'},
    {numero: '40F', descripcion: 'FORANEO'},
    {numero: '40L', descripcion: 'LOCAL'},
    {numero: '41', descripcion: 'UBICACIÓN'},
    {numero: '42', descripcion: 'SE RECIBE BIEN'},
    {numero: '42E', descripcion: 'SE RECIBE MAL'},
    {numero: '43', descripcion: 'MISION CUMPLIDA'},
    {numero: '44', descripcion: 'RADIO'},
    {numero: '44CB', descripcion: 'BANDA CIVIL'},
    {numero: '44B', descripcion: 'DE BASE'},
    {numero: '44P', descripcion: 'PORTATIL'},
    {numero: '44R', descripcion: 'CAMBIO DE CANAL'},
    {numero: '45', descripcion: 'DETENIDO'},
    {numero: '46', descripcion: 'REPETIR MENSAJE'},
    {numero: '46A', descripcion: 'ADEMAS/ASI MISMO'},
    {numero: '47', descripcion: 'ESCUCHO'},
    {numero: '47O', descripcion: 'PERSONAS AJENAS ESCUCHAN'},
    {numero: '48', descripcion: 'AUXILIO - PERSONAL EN PELIGRO'},
    {numero: '49', descripcion: 'AYUDA'},
    {numero: '50', descripcion: 'COMBUSTIBLE'},
    {numero: '50D', descripcion: 'DINERO'},
    {numero: '50G', descripcion: 'GASOLINERA'},
    {numero: '51', descripcion: 'PERSONA DROGADA'},
    {numero: '52', descripcion: 'ACCIDENTE'},
    {numero: '52A', descripcion: 'ATROPELLADO'},
    {numero: '52F', descripcion: 'CONTRA OBJETO FIJO'},
    {numero: '52O', descripcion: 'OTROS'},
    {numero: '52S', descripcion: 'SALIDA DE CAMINO'},
    {numero: '52V', descripcion: 'VOLCADURA'},
    {numero: '53', descripcion: 'COMISION ESP.'},
    {numero: '54', descripcion: 'MENSAJE'},
    {numero: '55', descripcion: 'EXTREME PRECAUCIONES'},
    {numero: '57', descripcion: 'UNIDAD A CENTRAL / CENTRAL'},
    {numero: '58', descripcion: 'MEDIOS DE COMUNICACIÓN'},
    {numero: '59', descripcion: 'RAPIDO'},
    {numero: '60A', descripcion: 'SIENA, CON'},
    {numero: '60-1', descripcion: 'URGENCIA CODIGO 1 / VERDE'},
    {numero: '60-2', descripcion: 'URGENCIA CODIGO 2 / AMARILLO'},
    {numero: '60-3', descripcion: 'URGENCIA CODIGO 3 / ROJO'},
    {numero: '61', descripcion: 'ANIMAL PELIGROSO'},
    {numero: '62', descripcion: 'COMIDA'},
    {numero: '63', descripcion: 'ACUDO AL LUGAR'},
    {numero: '64', descripcion: 'LLAMADA GENERAL'},
    {numero: '68', descripcion: 'HORA ACTUAL'},
    {numero: '71', descripcion: 'INCENDIO'},
    {numero: 'CLAVE 0', descripcion: 'BAÑO'},
    {numero: 'OSCAR', descripcion: 'ODOMETRO DE UNIDAD'},
    {numero: 'QTR', descripcion: 'HORA ACTUAL'},
];