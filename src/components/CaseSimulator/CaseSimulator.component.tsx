...
import {FaBrain, FaCheckCircle, FaClock, FaExclamationTriangle, FaHeart, FaRedo, FaTimesCircle} from 'react-icons/fa';
        ...
        return (
            ...
            >
                <div className="text-center mb-8">
                    ...
                    >
                        Completa la evaluación indicando la Escala de Glasgow del paciente
                    </motion.p>
                </div>
                    ...
                    {[
                        {
                            ...
                            color: getScoreColor(results.finalScore),
                        ...
                        <motion.div
                            ...
                            className={`bg-gradient-to-br ${stat.gradient} p-6 rounded-lg text-center`}
                        >
                            <motion.div
                                initial={{scale: 0}}
                                animate={{scale: 1}}
                ...
                {results.glasgowEvaluation && (
                    <div className={`border-l-4 p-6 mb-8 ${
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                <span
                                    className="font-medium">Tu respuesta:</span> {results.glasgowEvaluation.userAnswer}/15
                            </div>
                            <div>
                                <span
                                    className="font-medium">Respuesta correcta:</span> {results.glasgowEvaluation.correctAnswer}/15
                            </div>
                        </div>
                ...
                <div className="bg-gray-50 p-6 rounded-lg mb-8">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="flex items-center">
                            ...
                            <span className="text-gray-700">Errores totales: <span
                                className="font-semibold">{results.mistakes}</span></span>
                        </div>
                        <div className="flex items-center">
                            <FaExclamationTriangle className="w-5 h-5 text-orange-500 mr-3"/>
                            <span className="text-gray-700">Errores críticos: <span
                                className="font-semibold text-red-600">{results.criticalErrors}</span></span>
                        </div>
                    </div>
                </div>
                    ...
                    <ul className="space-y-2">
                        {results.recommendations.map((recommendation, index) => (
                            <li key={index} className="flex items-start">
                                <span
                                    className="inline-block w-2 h-2 bg-yellow-500 rounded-full mt-2 mr-3 flex-shrink-0"></span>
    ...
    if (!currentStep) {
        return (
            <motion.div
                initial={{opacity: 0}}
                animate={{opacity: 1}}
                className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-lg text-center"
            >
                <motion.div
                    animate={{rotate: 360}}
    ...
    return (
        ...
        >
            ...
            <motion.div
                ...
                className="bg-gradient-to-r from-blue-600 to-blue-800 text-white p-6 rounded-lg mb-6"
            >
            ...
            <span
                className={`inline-block px-3 py-1 rounded-full text-sm font-medium ${getDifficultyColor(simulatorCase.difficulty)}`}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                ...
                >
                    ...
                    <div className="space-y-2">
                        ...
                        <p><span
                            className="font-medium">Motivo de consulta:</span> {simulatorCase.patientInfo.chiefComplaint}
                        </p>
          ...
          <span className="text-sm font-medium text-gray-700">
            ...
            <FaClock className="inline w-4 h-4 mr-1"/>
                ...
                <div className="w-full bg-gray-200 rounded-full h-2">
                    <motion.div
                        initial={{width: 0}}
                        animate={{width: `${((progress.currentStep + 1) / simulatorCase.steps.length) * 100}%`}}
            ...
            <AnimatePresence mode="wait">
                <motion.div
                    ...
                    transition={{duration: 0.3}}
                    className="bg-white border-2 border-gray-200 rounded-lg p-6 mb-6"
                >
                    <motion.h2
            ...
            >
                <div className="flex items-center text-blue-800">
                    <motion.div
                        animate={currentStep.criticalStep ? {rotate: [0, -10, 10, -10, 0]} : {}}
                        transition={currentStep.criticalStep ? {repeat: Infinity, duration: 2, repeatDelay: 3} : {}}
                    >
