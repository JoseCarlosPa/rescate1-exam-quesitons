...
import { collection, addDoc, query, where, orderBy, onSnapshot, Timestamp, doc, updateDoc, increment } from 'firebase/firestore';
import { db } from '../firebase/firebaseConfig';
import { ForumMessage, ForumFormData, ForumThread } from '../types/forum.types';
